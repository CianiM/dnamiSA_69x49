...
d1_rhs_u_dx_0_1m2p0p01m2p0k = -4.0_wp/3.0_wp*(1.0_wp)*(1.0_wp+&
                    ...
                    param_float(13 + 5)**3.0_wp))*(q(1-2+0+0,1-2+0,indvars(5))/1.0_wp*q(1-2+0+0,1-2+0,indvars(1))))*param_float(1 + 5)*(d2_rhs_u_dxdx_0_0_1m2p0p01m2p0k)*qst(1-2+0+0,1-2+0,indvarsst(10))
...
d1_rhs_u_dx_0_1m2p0p11m2p0k = -4.0_wp/3.0_wp*(1.0_wp)*(1.0_wp+&
                    ...
                    param_float(13 + 5)**3.0_wp))*(q(1-2+0+1,1-2+0,indvars(5))/1.0_wp*q(1-2+0+1,1-2+0,indvars(1))))*param_float(1 + 5)*(d2_rhs_u_dxdx_0_0_1m2p0p11m2p0k)*qst(1-2+0+1,1-2+0,indvarsst(10))
...
d1_rhs_u_dx_0_1m2p0p21m2p0k = -4.0_wp/3.0_wp*(1.0_wp)*(1.0_wp+&
                    ...
                    param_float(13 + 5)**3.0_wp))*(q(1-2+0+2,1-2+0,indvars(5))/1.0_wp*q(1-2+0+2,1-2+0,indvars(1))))*param_float(1 + 5)*(d2_rhs_u_dxdx_0_0_1m2p0p21m2p0k)*qst(1-2+0+2,1-2+0,indvarsst(10))
...
d1_rhs_v_dx_0_1m2p0p01m2p0k = -(1.0_wp)*(1.0_wp+&
                    ((q(1-2+0+0,1-2+0,indvars(5))/1.0_wp*q(1-2+0+0,1-2+0,indvars(1)))**3.0_wp/((q(1-2+0+0,1-2+0,indvars(5))/1.0_wp*q(1-2+0+0,1-2+0,indvars(1)))**3.0_wp+&
                    param_float(13 + 5)**3.0_wp))*(q(1-2+0+0,1-2+0,indvars(5))/1.0_wp*q(1-2+0+0,1-2+0,indvars(1))))*param_float(1 + 5)*(d2_rhs_v_dxdx_0_0_1m2p0p01m2p0k)*qst(1-2+0+0,1-2+0,indvarsst(10))

d1_rhs_v_dx_0_1m2p0p11m2p0k = -(1.0_wp)*(1.0_wp+&
                    ((q(1-2+0+1,1-2+0,indvars(5))/1.0_wp*q(1-2+0+1,1-2+0,indvars(1)))**3.0_wp/((q(1-2+0+1,1-2+0,indvars(5))/1.0_wp*q(1-2+0+1,1-2+0,indvars(1)))**3.0_wp+&
                    param_float(13 + 5)**3.0_wp))*(q(1-2+0+1,1-2+0,indvars(5))/1.0_wp*q(1-2+0+1,1-2+0,indvars(1))))*param_float(1 + 5)*(d2_rhs_v_dxdx_0_0_1m2p0p11m2p0k)*qst(1-2+0+1,1-2+0,indvarsst(10))

d1_rhs_v_dx_0_1m2p0p21m2p0k = -(1.0_wp)*(1.0_wp+&
                    ((q(1-2+0+2,1-2+0,indvars(5))/1.0_wp*q(1-2+0+2,1-2+0,indvars(1)))**3.0_wp/((q(1-2+0+2,1-2+0,indvars(5))/1.0_wp*q(1-2+0+2,1-2+0,indvars(1)))**3.0_wp+&
                    param_float(13 + 5)**3.0_wp))*(q(1-2+0+2,1-2+0,indvars(5))/1.0_wp*q(1-2+0+2,1-2+0,indvars(1))))*param_float(1 + 5)*(d2_rhs_v_dxdx_0_0_1m2p0p21m2p0k)*qst(1-2+0+2,1-2+0,indvarsst(10))
...
d1_rhs_et_dx_0_1m2p0p01m2p0k = -4.0_wp/3.0_wp*(1.0_wp)*(1.0_wp+&
                    ((q(1-2+0+0,1-2+0,indvars(5))/1.0_wp*q(1-2+0+0,1-2+0,indvars(1)))**3.0_wp/((q(1-2+0+0,1-2+0,indvars(5))/1.0_wp*q(1-2+0+0,1-2+0,indvars(1)))**3.0_wp+&
                    param_float(13 + 5)**3.0_wp))*(q(1-2+0+0,1-2+0,indvars(5))/1.0_wp*q(1-2+0+0,1-2+0,indvars(1))))*param_float(1 + 5)*(d2_rhs_u_dxdx_0_0_1m2p0p01m2p0k)*qst(1-2+0+0,1-2+0,indvarsst(10))*q(1-2+0+0,1-2+0,indvars(2))-&
                    (1.0_wp)*(1.0_wp+&
                    ((q(1-2+0+0,1-2+0,indvars(5))/1.0_wp*q(1-2+0+0,1-2+0,indvars(1)))**3.0_wp/((q(1-2+0+0,1-2+0,indvars(5))/1.0_wp*q(1-2+0+0,1-2+0,indvars(1)))**3.0_wp+&
                    param_float(13 + 5)**3.0_wp))*(q(1-2+0+0,1-2+0,indvars(5))/1.0_wp*q(1-2+0+0,1-2+0,indvars(1))))*param_float(1 + 5)*(d2_rhs_v_dxdx_0_0_1m2p0p01m2p0k)*qst(1-2+0+0,1-2+0,indvarsst(10))*q(1-2+0+0,1-2+0,indvars(3))-&
...
d1_rhs_et_dx_0_1m2p0p11m2p0k = -4.0_wp/3.0_wp*(1.0_wp)*(1.0_wp+&
                    ((q(1-2+0+1,1-2+0,indvars(5))/1.0_wp*q(1-2+0+1,1-2+0,indvars(1)))**3.0_wp/((q(1-2+0+1,1-2+0,indvars(5))/1.0_wp*q(1-2+0+1,1-2+0,indvars(1)))**3.0_wp+&
                    param_float(13 + 5)**3.0_wp))*(q(1-2+0+1,1-2+0,indvars(5))/1.0_wp*q(1-2+0+1,1-2+0,indvars(1))))*param_float(1 + 5)*(d2_rhs_u_dxdx_0_0_1m2p0p11m2p0k)*qst(1-2+0+1,1-2+0,indvarsst(10))*q(1-2+0+1,1-2+0,indvars(2))-&
                    (1.0_wp)*(1.0_wp+&
                    ((q(1-2+0+1,1-2+0,indvars(5))/1.0_wp*q(1-2+0+1,1-2+0,indvars(1)))**3.0_wp/((q(1-2+0+1,1-2+0,indvars(5))/1.0_wp*q(1-2+0+1,1-2+0,indvars(1)))**3.0_wp+&
                    param_float(13 + 5)**3.0_wp))*(q(1-2+0+1,1-2+0,indvars(5))/1.0_wp*q(1-2+0+1,1-2+0,indvars(1))))*param_float(1 + 5)*(d2_rhs_v_dxdx_0_0_1m2p0p11m2p0k)*qst(1-2+0+1,1-2+0,indvarsst(10))*q(1-2+0+1,1-2+0,indvars(3))-&
...
d1_rhs_et_dx_0_1m2p0p21m2p0k = -4.0_wp/3.0_wp*(1.0_wp)*(1.0_wp+&
                    ((q(1-2+0+2,1-2+0,indvars(5))/1.0_wp*q(1-2+0+2,1-2+0,indvars(1)))**3.0_wp/((q(1-2+0+2,1-2+0,indvars(5))/1.0_wp*q(1-2+0+2,1-2+0,indvars(1)))**3.0_wp+&
                    param_float(13 + 5)**3.0_wp))*(q(1-2+0+2,1-2+0,indvars(5))/1.0_wp*q(1-2+0+2,1-2+0,indvars(1))))*param_float(1 + 5)*(d2_rhs_u_dxdx_0_0_1m2p0p21m2p0k)*qst(1-2+0+2,1-2+0,indvarsst(10))*q(1-2+0+2,1-2+0,indvars(2))-&
                    (1.0_wp)*(1.0_wp+&
                    ((q(1-2+0+2,1-2+0,indvars(5))/1.0_wp*q(1-2+0+2,1-2+0,indvars(1)))**3.0_wp/((q(1-2+0+2,1-2+0,indvars(5))/1.0_wp*q(1-2+0+2,1-2+0,indvars(1)))**3.0_wp+&
                    param_float(13 + 5)**3.0_wp))*(q(1-2+0+2,1-2+0,indvars(5))/1.0_wp*q(1-2+0+2,1-2+0,indvars(1))))*param_float(1 + 5)*(d2_rhs_v_dxdx_0_0_1m2p0p21m2p0k)*qst(1-2+0+2,1-2+0,indvarsst(10))*q(1-2+0+2,1-2+0,indvars(3))-&
...
rhs(1-2+0,1-2+0,indvars(4)) =   -  ( (qst(1-2+0,1-2+0,indvarsst(10))*(d1_rhs_et_dx_0_1m2p01m2p0k)+&
                    ...
                    (-&
                    (1.0_wp)*(1.0_wp+&
                    ((q(1-2+0,1-2+0,indvars(5))/1.0_wp*q(1-2+0,1-2+0,indvars(1)))**3.0_wp/((q(1-2+0,1-2+0,indvars(5))/1.0_wp*q(1-2+0,1-2+0,indvars(1)))**3.0_wp+&
                    param_float(13 + 5)**3.0_wp))*(q(1-2+0,1-2+0,indvars(5))/1.0_wp*q(1-2+0,1-2+0,indvars(1))))*param_float(1 + 5)*(d1_rhs_et_dy_0_1m2p01m2p0k)*(d1_rhs_et_dy_0_1m2p01m2p0k)*qst(1-2+0,1-2+0,indvarsst(11))**2-&
                    4.0_wp/3.0_wp*(1.0_wp)*(1.0_wp+&
                    ((q(1-2+0,1-2+0,indvars(5))/1.0_wp*q(1-2+0,1-2+0,indvars(1)))**3.0_wp/((q(1-2+0,1-2+0,indvars(5))/1.0_wp*q(1-2+0,1-2+0,indvars(1)))**3.0_wp+&
                    param_float(13 + 5)**3.0_wp))*(q(1-2+0,1-2+0,indvars(5))/1.0_wp*q(1-2+0,1-2+0,indvars(1))))*param_float(1 + 5)*(d1_rhs_rho_dy_0_1m2p01m2p0k)*(d1_rhs_rho_dy_0_1m2p01m2p0k)*qst(1-2+0,1-2+0,indvarsst(11))**2-&
...
d1_rhs_nut_dx_2_1m2p0p01m2p0k = q(1-2+0+0,1-2+0,indvars(1))*q(1-2+0+0,1-2+0,indvars(2))*q(1-2+0+0,1-2+0,indvars(5))-&
                    ...
                    (q(1-2+0+0,1-2+0,indvars(5))/1.0_wp*q(1-2+0+0,1-2+0,indvars(1))))*param_float(18 + 5)*qst(1-2+0+0,1-2+0,indvarsst(10))*(d2_rhs_nut_dxdx_2_0_1m2p0p01m2p0k)

d1_rhs_nut_dx_2_1m2p0p11m2p0k = q(1-2+0+1,1-2+0,indvars(1))*q(1-2+0+1,1-2+0,indvars(2))*q(1-2+0+1,1-2+0,indvars(5))-&
                    param_float(1 + 5)*(1.0_wp+&
                    (q(1-2+0+1,1-2+0,indvars(5))/1.0_wp*q(1-2+0+1,1-2+0,indvars(1))))*param_float(18 + 5)*qst(1-2+0+1,1-2+0,indvarsst(10))*(d2_rhs_nut_dxdx_2_0_1m2p0p11m2p0k)

d1_rhs_nut_dx_2_1m2p0p21m2p0k = q(1-2+0+2,1-2+0,indvars(1))*q(1-2+0+2,1-2+0,indvars(2))*q(1-2+0+2,1-2+0,indvars(5))-&
                    param_float(1 + 5)*(1.0_wp+&
                    (q(1-2+0+2,1-2+0,indvars(5))/1.0_wp*q(1-2+0+2,1-2+0,indvars(1))))*param_float(18 + 5)*qst(1-2+0+2,1-2+0,indvarsst(10))*(d2_rhs_nut_dxdx_2_0_1m2p0p21m2p0k)
...
rhs(1-2+0,1-2+0,indvars(5)) =   -  ( (-&
                    ...
                    param_float(17 + 5)*(q(1-2+0,1-2+0,indvars(5))/1.0_wp*q(1-2+0,1-2+0,indvars(1)))**2.0_wp)))*q(1-2+0,1-2+0,indvars(1))*(q(1-2+0,1-2+0,indvars(5))/qst(1-2+0,1-2+0,indvarsst(2)))**2+&
