...
d1_dif_nut_dx_0_1m2p0p0nyp2m1k = -(param_float(1 + 5)*(1.0_wp+&
                    (q(1-2+0+0,ny+2-1,indvars(5))/1.0_wp))*param_float(18 + 5)*qst(1-2+0+0,ny+2-1,indvarsst(10))*(d2_dif_nut_dxdx_0_0_1m2p0p0nyp2m1k))

d1_dif_nut_dx_0_1m2p0p1nyp2m1k = -(param_float(1 + 5)*(1.0_wp+&
                    (q(1-2+0+1,ny+2-1,indvars(5))/1.0_wp))*param_float(18 + 5)*qst(1-2+0+1,ny+2-1,indvarsst(10))*(d2_dif_nut_dxdx_0_0_1m2p0p1nyp2m1k))

d1_dif_nut_dx_0_1m2p0p2nyp2m1k = -(param_float(1 + 5)*(1.0_wp+&
                    (q(1-2+0+2,ny+2-1,indvars(5))/1.0_wp))*param_float(18 + 5)*qst(1-2+0+2,ny+2-1,indvarsst(10))*(d2_dif_nut_dxdx_0_0_1m2p0p2nyp2m1k))
...
d1_dif_nut_dy_0_1m2p0nyp2m1m1k = -(param_float(1 + 5)*(1.0_wp+&
                    (q(1-2+0,ny+2-1-1,indvars(5))/1.0_wp))*param_float(18 + 5)*qst(1-2+0,ny+2-1-1,indvarsst(11))*(d2_dif_nut_dydy_0_0_1m2p0nyp2m1m1k))

d1_dif_nut_dy_0_1m2p0nyp2m1p1k = -(param_float(1 + 5)*(1.0_wp+&
                    (q(1-2+0,ny+2-1+1,indvars(5))/1.0_wp))*param_float(18 + 5)*qst(1-2+0,ny+2-1+1,indvarsst(11))*(d2_dif_nut_dydy_0_0_1m2p0nyp2m1p1k))
