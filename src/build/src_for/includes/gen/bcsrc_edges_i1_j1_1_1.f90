...
! LOCAL VARIABLES
 ...
 real(wp) ::  d2_dif_rhou_dxdx_0_0_1m2p1m11m2p1k_1m2p1m1p01m2p1k,d2_dif_rhou_dxdx_0_0_1m2p1m11m2p1k_1m2p1m1p11m2p1k,d2_dif_rhou_dxdx_0_0_1m2p1m11m2p1k_1m2p1m1p21m2p1k &
            ...
            ,d2_dif_nut_dxdx_0_0_1m2p1m11m2p1k_1m2p1m1p01m2p1k,d2_dif_nut_dxdx_0_0_1m2p1m11m2p1k_1m2p1m1p11m2p1k,d2_dif_nut_dxdx_0_0_1m2p1m11m2p1k_1m2p1m1p21m2p1k &
            ,d2_dif_nut_dxdx_0_0_1m2p1m11m2p1k &
            ,d2_dif_nut_dxdx_0_0_1m2p1p11m2p1k_1m2p1p1m11m2p1k,d2_dif_nut_dxdx_0_0_1m2p1p11m2p1k_1m2p1p1p01m2p1k,d2_dif_nut_dxdx_0_0_1m2p1p11m2p1k_1m2p1p1p11m2p1k &
            ,d2_dif_nut_dxdx_0_0_1m2p1p11m2p1k &
            ,d1_dif_nut_dx_1_1m2p1m11m2p1k,d1_dif_nut_dx_1_1m2p1p01m2p1k,d1_dif_nut_dx_1_1m2p1p11m2p1k &
            ,d1_dif_nut_dx_1_1m2p11m2p1k &
            ,d1_dif_nut_dx_2_1m2p1m11m2p1k,d1_dif_nut_dx_2_1m2p1p01m2p1k,d1_dif_nut_dx_2_1m2p1p11m2p1k &
            ,d1_dif_nut_dx_2_1m2p11m2p1k &
            ,d1_dif_nut_dx_0_1m2p1m11m2p1k,d1_dif_nut_dx_0_1m2p1p01m2p1k,d1_dif_nut_dx_0_1m2p1p11m2p1k &
            ,d1_dif_nut_dx_0_1m2p11m2p1k &
            ,d2_dif_nut_dydy_0_0_1m2p11m2p1m1k_1m2p11m2p1m1p0k,d2_dif_nut_dydy_0_0_1m2p11m2p1m1k_1m2p11m2p1m1p1k,d2_dif_nut_dydy_0_0_1m2p11m2p1m1k_1m2p11m2p1m1p2k &
            ,d2_dif_nut_dydy_0_0_1m2p11m2p1m1k &
            ,d2_dif_nut_dydy_0_0_1m2p11m2p1p1k_1m2p11m2p1p1m1k,d2_dif_nut_dydy_0_0_1m2p11m2p1p1k_1m2p11m2p1p1p0k,d2_dif_nut_dydy_0_0_1m2p11m2p1p1k_1m2p11m2p1p1p1k &
            ,d2_dif_nut_dydy_0_0_1m2p11m2p1p1k &
            ,d1_dif_nut_dy_1_1m2p11m2p1m1k,d1_dif_nut_dy_1_1m2p11m2p1p0k,d1_dif_nut_dy_1_1m2p11m2p1p1k &
            ,d1_dif_nut_dy_1_1m2p11m2p1k &
            ,d1_dif_nut_dy_2_1m2p11m2p1m1k,d1_dif_nut_dy_2_1m2p11m2p1p0k,d1_dif_nut_dy_2_1m2p11m2p1p1k &
            ,d1_dif_nut_dy_2_1m2p11m2p1k &
...
d1_dif_rhou_dx_0_1m2p1m11m2p1k = -(1.0_wp)*(1.0_wp+&
                    ((q(1-2+1-1,1-2+1,indvars(5))/1.0_wp*q(1-2+1-1,1-2+1,indvars(1)))**3.0_wp/((q(1-2+1-1,1-2+1,indvars(5))/1.0_wp*q(1-2+1-1,1-2+1,indvars(1)))**3.0_wp+&
                    param_float(13 + 5)**3.0_wp))*(q(1-2+1-1,1-2+1,indvars(5))/1.0_wp*q(1-2+1-1,1-2+1,indvars(1))))*param_float(1 + 5)*(2.0_wp*qst(1-2+1-1,1-2+1,indvarsst(10))*(d2_dif_rhou_dxdx_0_0_1m2p1m11m2p1k)-&
...
d1_dif_rhou_dx_0_1m2p1p11m2p1k = -(1.0_wp)*(1.0_wp+&
                    ((q(1-2+1+1,1-2+1,indvars(5))/1.0_wp*q(1-2+1+1,1-2+1,indvars(1)))**3.0_wp/((q(1-2+1+1,1-2+1,indvars(5))/1.0_wp*q(1-2+1+1,1-2+1,indvars(1)))**3.0_wp+&
                    param_float(13 + 5)**3.0_wp))*(q(1-2+1+1,1-2+1,indvars(5))/1.0_wp*q(1-2+1+1,1-2+1,indvars(1))))*param_float(1 + 5)*(2.0_wp*qst(1-2+1+1,1-2+1,indvarsst(10))*(d2_dif_rhou_dxdx_0_0_1m2p1p11m2p1k)-&
...
d1_dif_rhou_dy_0_1m2p11m2p1m1k = -(1.0_wp)*(1.0_wp+&
                    ((q(1-2+1,1-2+1-1,indvars(5))/1.0_wp*q(1-2+1,1-2+1-1,indvars(1)))**3.0_wp/((q(1-2+1,1-2+1-1,indvars(5))/1.0_wp*q(1-2+1,1-2+1-1,indvars(1)))**3.0_wp+&
                    param_float(13 + 5)**3.0_wp))*(q(1-2+1,1-2+1-1,indvars(5))/1.0_wp*q(1-2+1,1-2+1-1,indvars(1))))*param_float(1 + 5)*(qst(1-2+1,1-2+1-1,indvarsst(11))*(d2_dif_rhou_dydy_0_0_1m2p11m2p1m1k)+&
                    qst(1-2+1,1-2+1-1,indvarsst(10))*(d2_dif_rhou_dydx_0_0_1m2p11m2p1m1k))

d1_dif_rhou_dy_0_1m2p11m2p1p1k = -(1.0_wp)*(1.0_wp+&
                    ((q(1-2+1,1-2+1+1,indvars(5))/1.0_wp*q(1-2+1,1-2+1+1,indvars(1)))**3.0_wp/((q(1-2+1,1-2+1+1,indvars(5))/1.0_wp*q(1-2+1,1-2+1+1,indvars(1)))**3.0_wp+&
                    param_float(13 + 5)**3.0_wp))*(q(1-2+1,1-2+1+1,indvars(5))/1.0_wp*q(1-2+1,1-2+1+1,indvars(1))))*param_float(1 + 5)*(qst(1-2+1,1-2+1+1,indvarsst(11))*(d2_dif_rhou_dydy_0_0_1m2p11m2p1p1k)+&
...
d1_dif_rhov_dx_0_1m2p1m11m2p1k = -(1.0_wp)*(1.0_wp+&
                    ((q(1-2+1-1,1-2+1,indvars(5))/1.0_wp*q(1-2+1-1,1-2+1,indvars(1)))**3.0_wp/((q(1-2+1-1,1-2+1,indvars(5))/1.0_wp*q(1-2+1-1,1-2+1,indvars(1)))**3.0_wp+&
                    param_float(13 + 5)**3.0_wp))*(q(1-2+1-1,1-2+1,indvars(5))/1.0_wp*q(1-2+1-1,1-2+1,indvars(1))))*param_float(1 + 5)*(qst(1-2+1-1,1-2+1,indvarsst(11))*(d2_dif_rhov_dxdy_0_0_1m2p1m11m2p1k)+&
                    qst(1-2+1-1,1-2+1,indvarsst(10))*(d2_dif_rhov_dxdx_0_0_1m2p1m11m2p1k))

d1_dif_rhov_dx_0_1m2p1p11m2p1k = -(1.0_wp)*(1.0_wp+&
                    ((q(1-2+1+1,1-2+1,indvars(5))/1.0_wp*q(1-2+1+1,1-2+1,indvars(1)))**3.0_wp/((q(1-2+1+1,1-2+1,indvars(5))/1.0_wp*q(1-2+1+1,1-2+1,indvars(1)))**3.0_wp+&
                    param_float(13 + 5)**3.0_wp))*(q(1-2+1+1,1-2+1,indvars(5))/1.0_wp*q(1-2+1+1,1-2+1,indvars(1))))*param_float(1 + 5)*(qst(1-2+1+1,1-2+1,indvarsst(11))*(d2_dif_rhov_dxdy_0_0_1m2p1p11m2p1k)+&
...
d1_dif_rhov_dy_0_1m2p11m2p1m1k = -(1.0_wp)*(1.0_wp+&
                    ((q(1-2+1,1-2+1-1,indvars(5))/1.0_wp*q(1-2+1,1-2+1-1,indvars(1)))**3.0_wp/((q(1-2+1,1-2+1-1,indvars(5))/1.0_wp*q(1-2+1,1-2+1-1,indvars(1)))**3.0_wp+&
                    param_float(13 + 5)**3.0_wp))*(q(1-2+1,1-2+1-1,indvars(5))/1.0_wp*q(1-2+1,1-2+1-1,indvars(1))))*param_float(1 + 5)*(2.0_wp*qst(1-2+1,1-2+1-1,indvarsst(11))*(d2_dif_rhov_dydy_0_0_1m2p11m2p1m1k)-&
...
d1_dif_rhov_dy_0_1m2p11m2p1p1k = -(1.0_wp)*(1.0_wp+&
                    ((q(1-2+1,1-2+1+1,indvars(5))/1.0_wp*q(1-2+1,1-2+1+1,indvars(1)))**3.0_wp/((q(1-2+1,1-2+1+1,indvars(5))/1.0_wp*q(1-2+1,1-2+1+1,indvars(1)))**3.0_wp+&
                    param_float(13 + 5)**3.0_wp))*(q(1-2+1,1-2+1+1,indvars(5))/1.0_wp*q(1-2+1,1-2+1+1,indvars(1))))*param_float(1 + 5)*(2.0_wp*qst(1-2+1,1-2+1+1,indvarsst(11))*(d2_dif_rhov_dydy_0_0_1m2p11m2p1p1k)-&
...
d2_dif_nut_dxdx_0_0_1m2p1m11m2p1k_1m2p1m1p01m2p1k = q(1-2+1-1+0,1-2+1,indvars(5))

d2_dif_nut_dxdx_0_0_1m2p1m11m2p1k_1m2p1m1p11m2p1k = q(1-2+1-1+1,1-2+1,indvars(5))

d2_dif_nut_dxdx_0_0_1m2p1m11m2p1k_1m2p1m1p21m2p1k = q(1-2+1-1+2,1-2+1,indvars(5))

d2_dif_nut_dxdx_0_0_1m2p1m11m2p1k = -&
          1.5_wp*d2_dif_nut_dxdx_0_0_1m2p1m11m2p1k_1m2p1m1p01m2p1k+&
          2.0_wp*d2_dif_nut_dxdx_0_0_1m2p1m11m2p1k_1m2p1m1p11m2p1k-&
          0.5_wp*d2_dif_nut_dxdx_0_0_1m2p1m11m2p1k_1m2p1m1p21m2p1k

d2_dif_nut_dxdx_0_0_1m2p1m11m2p1k = d2_dif_nut_dxdx_0_0_1m2p1m11m2p1k*param_float(1)

d2_dif_nut_dxdx_0_0_1m2p1p11m2p1k_1m2p1p1m11m2p1k = q(1-2+1+1-1,1-2+1,indvars(5))

d2_dif_nut_dxdx_0_0_1m2p1p11m2p1k_1m2p1p1p11m2p1k = q(1-2+1+1+1,1-2+1,indvars(5))

d2_dif_nut_dxdx_0_0_1m2p1p11m2p1k = -&
          0.5_wp*d2_dif_nut_dxdx_0_0_1m2p1p11m2p1k_1m2p1p1m11m2p1k+&
          0.5_wp*d2_dif_nut_dxdx_0_0_1m2p1p11m2p1k_1m2p1p1p11m2p1k

d2_dif_nut_dxdx_0_0_1m2p1p11m2p1k = d2_dif_nut_dxdx_0_0_1m2p1p11m2p1k*param_float(1)

d1_dif_nut_dx_1_1m2p1m11m2p1k = q(1-2+1-1,1-2+1,indvars(1))*q(1-2+1-1,1-2+1,indvars(5))

d1_dif_nut_dx_1_1m2p1p11m2p1k = q(1-2+1+1,1-2+1,indvars(1))*q(1-2+1+1,1-2+1,indvars(5))
...
d1_dif_nut_dx_2_1m2p1m11m2p1k = q(1-2+1-1,1-2+1,indvars(5))

d1_dif_nut_dx_2_1m2p1p11m2p1k = q(1-2+1+1,1-2+1,indvars(5))

d1_dif_nut_dx_2_1m2p11m2p1k = -&
          0.5_wp*d1_dif_nut_dx_2_1m2p1m11m2p1k+&
          0.5_wp*d1_dif_nut_dx_2_1m2p1p11m2p1k

d1_dif_nut_dx_2_1m2p11m2p1k = d1_dif_nut_dx_2_1m2p11m2p1k*param_float(1)

d1_dif_nut_dx_0_1m2p1m11m2p1k = -param_float(1 + 5)*(1.0_wp+&
                    (q(1-2+1-1,1-2+1,indvars(5))/1.0_wp*q(1-2+1-1,1-2+1,indvars(1))))*param_float(18 + 5)*qst(1-2+1-1,1-2+1,indvarsst(10))*(d2_dif_nut_dxdx_0_0_1m2p1m11m2p1k)

d1_dif_nut_dx_0_1m2p1p11m2p1k = -param_float(1 + 5)*(1.0_wp+&
                    (q(1-2+1+1,1-2+1,indvars(5))/1.0_wp*q(1-2+1+1,1-2+1,indvars(1))))*param_float(18 + 5)*qst(1-2+1+1,1-2+1,indvarsst(10))*(d2_dif_nut_dxdx_0_0_1m2p1p11m2p1k)
...
d2_dif_nut_dydy_0_0_1m2p11m2p1m1k_1m2p11m2p1m1p0k = q(1-2+1,1-2+1-1+0,indvars(5))

d2_dif_nut_dydy_0_0_1m2p11m2p1m1k_1m2p11m2p1m1p1k = q(1-2+1,1-2+1-1+1,indvars(5))

d2_dif_nut_dydy_0_0_1m2p11m2p1m1k_1m2p11m2p1m1p2k = q(1-2+1,1-2+1-1+2,indvars(5))

d2_dif_nut_dydy_0_0_1m2p11m2p1m1k = -&
          1.5_wp*d2_dif_nut_dydy_0_0_1m2p11m2p1m1k_1m2p11m2p1m1p0k+&
          2.0_wp*d2_dif_nut_dydy_0_0_1m2p11m2p1m1k_1m2p11m2p1m1p1k-&
          0.5_wp*d2_dif_nut_dydy_0_0_1m2p11m2p1m1k_1m2p11m2p1m1p2k

d2_dif_nut_dydy_0_0_1m2p11m2p1m1k = d2_dif_nut_dydy_0_0_1m2p11m2p1m1k*param_float(2)

d2_dif_nut_dydy_0_0_1m2p11m2p1p1k_1m2p11m2p1p1m1k = q(1-2+1,1-2+1+1-1,indvars(5))

d2_dif_nut_dydy_0_0_1m2p11m2p1p1k_1m2p11m2p1p1p1k = q(1-2+1,1-2+1+1+1,indvars(5))

d2_dif_nut_dydy_0_0_1m2p11m2p1p1k = -&
          0.5_wp*d2_dif_nut_dydy_0_0_1m2p11m2p1p1k_1m2p11m2p1p1m1k+&
          0.5_wp*d2_dif_nut_dydy_0_0_1m2p11m2p1p1k_1m2p11m2p1p1p1k

d2_dif_nut_dydy_0_0_1m2p11m2p1p1k = d2_dif_nut_dydy_0_0_1m2p11m2p1p1k*param_float(2)

d1_dif_nut_dy_1_1m2p11m2p1m1k = q(1-2+1,1-2+1-1,indvars(1))*q(1-2+1,1-2+1-1,indvars(5))

d1_dif_nut_dy_1_1m2p11m2p1p1k = q(1-2+1,1-2+1+1,indvars(1))*q(1-2+1,1-2+1+1,indvars(5))
...
d1_dif_nut_dy_2_1m2p11m2p1m1k = q(1-2+1,1-2+1-1,indvars(5))

d1_dif_nut_dy_2_1m2p11m2p1p1k = q(1-2+1,1-2+1+1,indvars(5))

d1_dif_nut_dy_2_1m2p11m2p1k = -&
          0.5_wp*d1_dif_nut_dy_2_1m2p11m2p1m1k+&
          0.5_wp*d1_dif_nut_dy_2_1m2p11m2p1p1k

d1_dif_nut_dy_2_1m2p11m2p1k = d1_dif_nut_dy_2_1m2p11m2p1k*param_float(2)

d1_dif_nut_dy_0_1m2p11m2p1m1k = -param_float(1 + 5)*(1.0_wp+&
                    (q(1-2+1,1-2+1-1,indvars(5))/1.0_wp*q(1-2+1,1-2+1-1,indvars(1))))*param_float(18 + 5)*qst(1-2+1,1-2+1-1,indvarsst(11))*(d2_dif_nut_dydy_0_0_1m2p11m2p1m1k)

d1_dif_nut_dy_0_1m2p11m2p1p1k = -param_float(1 + 5)*(1.0_wp+&
                    (q(1-2+1,1-2+1+1,indvars(5))/1.0_wp*q(1-2+1,1-2+1+1,indvars(1))))*param_float(18 + 5)*qst(1-2+1,1-2+1+1,indvarsst(11))*(d2_dif_nut_dydy_0_0_1m2p11m2p1p1k)
...
rhs(1-2+1,1-2+1,indvars(5)) = rhs(1-2+1,1-2+1,indvars(5))  -  ( qst(1-2+1,1-2+1,indvarsst(10))*(d1_dif_nut_dx_0_1m2p11m2p1k)+&
                    qst(1-2+1,1-2+1,indvarsst(11))*(d1_dif_nut_dy_0_1m2p11m2p1k)+&
                    -&
                    param_float(1 + 5)*param_float(7 + 5)*param_float(18 + 5)*((qst(1-2+1,1-2+1,indvarsst(10)))**2*(d1_dif_nut_dx_1_1m2p11m2p1k)*(d1_dif_nut_dx_2_1m2p11m2p1k)+&
                    (qst(1-2+1,1-2+1,indvarsst(11)))**2*(d1_dif_nut_dy_1_1m2p11m2p1k)*(d1_dif_nut_dy_2_1m2p11m2p1k))-&
                    param_float(6 + 5)*(1.0_wp-&
                    (param_float(16 + 5)*exp(-&
                    param_float(17 + 5)*(q(1-2+1,1-2+1,indvars(5))/1.0_wp*q(1-2+1,1-2+1,indvars(1)))**2.0_wp)))*qst(1-2+1,1-2+1,indvarsst(12))*q(1-2+1,1-2+1,indvars(1))*q(1-2+1,1-2+1,indvars(5))+&
                    param_float(1 + 5)*(param_float(10 + 5)*(((min(param_float(1 + 5)*(q(1-2+1,1-2+1,indvars(5))/(qst(1-2+1,1-2+1,indvarsst(12))*param_float(9 + 5)**2.0_wp*qst(1-2+1,1-2+1,indvarsst(2))**2.0_wp)),10.0_wp))+&
                    param_float(11 + 5)*((min(param_float(1 + 5)*(q(1-2+1,1-2+1,indvars(5))/(qst(1-2+1,1-2+1,indvarsst(12))*param_float(9 + 5)**2.0_wp*qst(1-2+1,1-2+1,indvarsst(2))**2.0_wp)),10.0_wp))**6.0_wp-&
                    (min(param_float(1 + 5)*(q(1-2+1,1-2+1,indvars(5))/(qst(1-2+1,1-2+1,indvarsst(12))*param_float(9 + 5)**2.0_wp*qst(1-2+1,1-2+1,indvarsst(2))**2.0_wp)),10.0_wp))))*((1.0_wp+&
                    param_float(12 + 5)**6.0_wp)/(((min(param_float(1 + 5)*(q(1-2+1,1-2+1,indvars(5))/(qst(1-2+1,1-2+1,indvarsst(12))*param_float(9 + 5)**2.0_wp*qst(1-2+1,1-2+1,indvarsst(2))**2.0_wp)),10.0_wp))+&
                    param_float(11 + 5)*((min(param_float(1 + 5)*(q(1-2+1,1-2+1,indvars(5))/(qst(1-2+1,1-2+1,indvarsst(12))*param_float(9 + 5)**2.0_wp*qst(1-2+1,1-2+1,indvarsst(2))**2.0_wp)),10.0_wp))**6.0_wp-&
                    (min(param_float(1 + 5)*(q(1-2+1,1-2+1,indvars(5))/(qst(1-2+1,1-2+1,indvarsst(12))*param_float(9 + 5)**2.0_wp*qst(1-2+1,1-2+1,indvarsst(2))**2.0_wp)),10.0_wp))))**6.0_wp+&
                    param_float(12 + 5)**6.0_wp))**(1.0_wp/6.0_wp))-&
                    param_float(6 + 5)/param_float(9 + 5)**2.0_wp*(param_float(16 + 5)*exp(-&
                    param_float(17 + 5)*(q(1-2+1,1-2+1,indvars(5))/1.0_wp*q(1-2+1,1-2+1,indvars(1)))**2.0_wp)))*q(1-2+1,1-2+1,indvars(1))*(q(1-2+1,1-2+1,indvars(5))/qst(1-2+1,1-2+1,indvarsst(2)))**2.0_wp ) 
