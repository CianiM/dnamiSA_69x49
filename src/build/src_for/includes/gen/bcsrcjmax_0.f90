...
! LOCAL VARIABLES
 ...
 real(wp) ::  d2_dif_rhou_dxdx_0_0_im1nyp2p0k_im1m1nyp2p0k,d2_dif_rhou_dxdx_0_0_im1nyp2p0k_im1p0nyp2p0k,d2_dif_rhou_dxdx_0_0_im1nyp2p0k_im1p1nyp2p0k &
            ...
            ,d2_dif_nut_dxdx_0_0_im1nyp2p0k_im1m1nyp2p0k,d2_dif_nut_dxdx_0_0_im1nyp2p0k_im1p0nyp2p0k,d2_dif_nut_dxdx_0_0_im1nyp2p0k_im1p1nyp2p0k &
            ,d2_dif_nut_dxdx_0_0_im1nyp2p0k &
            ,d2_dif_nut_dxdx_0_0_ip1nyp2p0k_ip1m1nyp2p0k,d2_dif_nut_dxdx_0_0_ip1nyp2p0k_ip1p0nyp2p0k,d2_dif_nut_dxdx_0_0_ip1nyp2p0k_ip1p1nyp2p0k &
            ,d2_dif_nut_dxdx_0_0_ip1nyp2p0k &
            ,d1_dif_nut_dx_1_im1nyp2p0k,d1_dif_nut_dx_1_ip0nyp2p0k,d1_dif_nut_dx_1_ip1nyp2p0k &
            ,d1_dif_nut_dx_1_inyp2p0k &
            ,d1_dif_nut_dx_2_im1nyp2p0k,d1_dif_nut_dx_2_ip0nyp2p0k,d1_dif_nut_dx_2_ip1nyp2p0k &
            ,d1_dif_nut_dx_2_inyp2p0k &
            ,d1_dif_nut_dx_0_im1nyp2p0k,d1_dif_nut_dx_0_ip0nyp2p0k,d1_dif_nut_dx_0_ip1nyp2p0k &
            ,d1_dif_nut_dx_0_inyp2p0k &
            ,d2_dif_nut_dydy_0_0_inyp2p0p0k_inyp2p0p0p0k,d2_dif_nut_dydy_0_0_inyp2p0p0k_inyp2p0p0m1k,d2_dif_nut_dydy_0_0_inyp2p0p0k_inyp2p0p0m2k &
            ,d2_dif_nut_dydy_0_0_inyp2p0p0k &
            ,d2_dif_nut_dydy_0_0_inyp2p0m1k_inyp2p0m1m1k,d2_dif_nut_dydy_0_0_inyp2p0m1k_inyp2p0m1p0k,d2_dif_nut_dydy_0_0_inyp2p0m1k_inyp2p0m1p1k &
            ,d2_dif_nut_dydy_0_0_inyp2p0m1k &
            ,d2_dif_nut_dydy_0_0_inyp2p0m2k_inyp2p0m2m1k,d2_dif_nut_dydy_0_0_inyp2p0m2k_inyp2p0m2p0k,d2_dif_nut_dydy_0_0_inyp2p0m2k_inyp2p0m2p1k &
            ,d2_dif_nut_dydy_0_0_inyp2p0m2k &
            ,d1_dif_nut_dy_1_inyp2p0p0k,d1_dif_nut_dy_1_inyp2p0m1k,d1_dif_nut_dy_1_inyp2p0m2k &
            ,d1_dif_nut_dy_1_inyp2p0k &
            ,d1_dif_nut_dy_2_inyp2p0p0k,d1_dif_nut_dy_2_inyp2p0m1k,d1_dif_nut_dy_2_inyp2p0m2k &
            ,d1_dif_nut_dy_2_inyp2p0k &
...
d1_dif_rhou_dx_0_im1nyp2p0k = -(1.0_wp)*(1.0_wp+&
                    ...
                    param_float(13 + 5)**3.0_wp))*(q(i-1,ny+2+0,indvars(5))/1.0_wp*q(i-1,ny+2+0,indvars(1))))*param_float(1 + 5)*(2.0_wp*qst(i-1,ny+2+0,indvarsst(10))*(d2_dif_rhou_dxdx_0_0_im1nyp2p0k)-&
...
d1_dif_rhou_dx_0_ip1nyp2p0k = -(1.0_wp)*(1.0_wp+&
                    ((q(i+1,ny+2+0,indvars(5))/1.0_wp*q(i+1,ny+2+0,indvars(1)))**3.0_wp/((q(i+1,ny+2+0,indvars(5))/1.0_wp*q(i+1,ny+2+0,indvars(1)))**3.0_wp+&
                    param_float(13 + 5)**3.0_wp))*(q(i+1,ny+2+0,indvars(5))/1.0_wp*q(i+1,ny+2+0,indvars(1))))*param_float(1 + 5)*(2.0_wp*qst(i+1,ny+2+0,indvarsst(10))*(d2_dif_rhou_dxdx_0_0_ip1nyp2p0k)-&
...
d1_dif_rhou_dy_0_inyp2p0p0k = -(1.0_wp)*(1.0_wp+&
                    ...
                    param_float(13 + 5)**3.0_wp))*(q(i,ny+2+0+0,indvars(5))/1.0_wp*q(i,ny+2+0+0,indvars(1))))*param_float(1 + 5)*(qst(i,ny+2+0+0,indvarsst(11))*(d2_dif_rhou_dydy_0_0_inyp2p0p0k)+&
...
d1_dif_rhou_dy_0_inyp2p0m1k = -(1.0_wp)*(1.0_wp+&
                    ...
                    param_float(13 + 5)**3.0_wp))*(q(i,ny+2+0-1,indvars(5))/1.0_wp*q(i,ny+2+0-1,indvars(1))))*param_float(1 + 5)*(qst(i,ny+2+0-1,indvarsst(11))*(d2_dif_rhou_dydy_0_0_inyp2p0m1k)+&
...
d1_dif_rhou_dy_0_inyp2p0m2k = -(1.0_wp)*(1.0_wp+&
                    ...
                    param_float(13 + 5)**3.0_wp))*(q(i,ny+2+0-2,indvars(5))/1.0_wp*q(i,ny+2+0-2,indvars(1))))*param_float(1 + 5)*(qst(i,ny+2+0-2,indvarsst(11))*(d2_dif_rhou_dydy_0_0_inyp2p0m2k)+&
...
d1_dif_rhov_dx_0_im1nyp2p0k = -(1.0_wp)*(1.0_wp+&
                    ((q(i-1,ny+2+0,indvars(5))/1.0_wp*q(i-1,ny+2+0,indvars(1)))**3.0_wp/((q(i-1,ny+2+0,indvars(5))/1.0_wp*q(i-1,ny+2+0,indvars(1)))**3.0_wp+&
                    param_float(13 + 5)**3.0_wp))*(q(i-1,ny+2+0,indvars(5))/1.0_wp*q(i-1,ny+2+0,indvars(1))))*param_float(1 + 5)*(qst(i-1,ny+2+0,indvarsst(11))*(d2_dif_rhov_dxdy_0_0_im1nyp2p0k)+&
                    qst(i-1,ny+2+0,indvarsst(10))*(d2_dif_rhov_dxdx_0_0_im1nyp2p0k))

d1_dif_rhov_dx_0_ip1nyp2p0k = -(1.0_wp)*(1.0_wp+&
                    ((q(i+1,ny+2+0,indvars(5))/1.0_wp*q(i+1,ny+2+0,indvars(1)))**3.0_wp/((q(i+1,ny+2+0,indvars(5))/1.0_wp*q(i+1,ny+2+0,indvars(1)))**3.0_wp+&
                    param_float(13 + 5)**3.0_wp))*(q(i+1,ny+2+0,indvars(5))/1.0_wp*q(i+1,ny+2+0,indvars(1))))*param_float(1 + 5)*(qst(i+1,ny+2+0,indvarsst(11))*(d2_dif_rhov_dxdy_0_0_ip1nyp2p0k)+&
...
d1_dif_rhov_dy_0_inyp2p0p0k = -(1.0_wp)*(1.0_wp+&
                    ((q(i,ny+2+0+0,indvars(5))/1.0_wp*q(i,ny+2+0+0,indvars(1)))**3.0_wp/((q(i,ny+2+0+0,indvars(5))/1.0_wp*q(i,ny+2+0+0,indvars(1)))**3.0_wp+&
                    param_float(13 + 5)**3.0_wp))*(q(i,ny+2+0+0,indvars(5))/1.0_wp*q(i,ny+2+0+0,indvars(1))))*param_float(1 + 5)*(2.0_wp*qst(i,ny+2+0+0,indvarsst(11))*(d2_dif_rhov_dydy_0_0_inyp2p0p0k)-&
...
d1_dif_rhov_dy_0_inyp2p0m1k = -(1.0_wp)*(1.0_wp+&
                    ((q(i,ny+2+0-1,indvars(5))/1.0_wp*q(i,ny+2+0-1,indvars(1)))**3.0_wp/((q(i,ny+2+0-1,indvars(5))/1.0_wp*q(i,ny+2+0-1,indvars(1)))**3.0_wp+&
                    param_float(13 + 5)**3.0_wp))*(q(i,ny+2+0-1,indvars(5))/1.0_wp*q(i,ny+2+0-1,indvars(1))))*param_float(1 + 5)*(2.0_wp*qst(i,ny+2+0-1,indvarsst(11))*(d2_dif_rhov_dydy_0_0_inyp2p0m1k)-&
...
d1_dif_rhov_dy_0_inyp2p0m2k = -(1.0_wp)*(1.0_wp+&
                    ((q(i,ny+2+0-2,indvars(5))/1.0_wp*q(i,ny+2+0-2,indvars(1)))**3.0_wp/((q(i,ny+2+0-2,indvars(5))/1.0_wp*q(i,ny+2+0-2,indvars(1)))**3.0_wp+&
                    param_float(13 + 5)**3.0_wp))*(q(i,ny+2+0-2,indvars(5))/1.0_wp*q(i,ny+2+0-2,indvars(1))))*param_float(1 + 5)*(2.0_wp*qst(i,ny+2+0-2,indvarsst(11))*(d2_dif_rhov_dydy_0_0_inyp2p0m2k)-&
...
d2_dif_nut_dxdx_0_0_im1nyp2p0k_im1m1nyp2p0k = q(i-1-1,ny+2+0,indvars(5))

d2_dif_nut_dxdx_0_0_im1nyp2p0k_im1p1nyp2p0k = q(i-1+1,ny+2+0,indvars(5))

d2_dif_nut_dxdx_0_0_im1nyp2p0k = -&
          0.5_wp*d2_dif_nut_dxdx_0_0_im1nyp2p0k_im1m1nyp2p0k+&
          0.5_wp*d2_dif_nut_dxdx_0_0_im1nyp2p0k_im1p1nyp2p0k

d2_dif_nut_dxdx_0_0_im1nyp2p0k = d2_dif_nut_dxdx_0_0_im1nyp2p0k*param_float(1)

d2_dif_nut_dxdx_0_0_ip1nyp2p0k_ip1m1nyp2p0k = q(i+1-1,ny+2+0,indvars(5))

d2_dif_nut_dxdx_0_0_ip1nyp2p0k_ip1p1nyp2p0k = q(i+1+1,ny+2+0,indvars(5))

d2_dif_nut_dxdx_0_0_ip1nyp2p0k = -&
          0.5_wp*d2_dif_nut_dxdx_0_0_ip1nyp2p0k_ip1m1nyp2p0k+&
          0.5_wp*d2_dif_nut_dxdx_0_0_ip1nyp2p0k_ip1p1nyp2p0k

d2_dif_nut_dxdx_0_0_ip1nyp2p0k = d2_dif_nut_dxdx_0_0_ip1nyp2p0k*param_float(1)

d1_dif_nut_dx_1_im1nyp2p0k = q(i-1,ny+2+0,indvars(1))*q(i-1,ny+2+0,indvars(5))

d1_dif_nut_dx_1_ip1nyp2p0k = q(i+1,ny+2+0,indvars(1))*q(i+1,ny+2+0,indvars(5))
...
d1_dif_nut_dx_2_im1nyp2p0k = q(i-1,ny+2+0,indvars(5))

d1_dif_nut_dx_2_ip1nyp2p0k = q(i+1,ny+2+0,indvars(5))

d1_dif_nut_dx_2_inyp2p0k = -&
          0.5_wp*d1_dif_nut_dx_2_im1nyp2p0k+&
          0.5_wp*d1_dif_nut_dx_2_ip1nyp2p0k

d1_dif_nut_dx_2_inyp2p0k = d1_dif_nut_dx_2_inyp2p0k*param_float(1)

d1_dif_nut_dx_0_im1nyp2p0k = -param_float(1 + 5)*(1.0_wp+&
                    (q(i-1,ny+2+0,indvars(5))/1.0_wp*q(i-1,ny+2+0,indvars(1))))*param_float(18 + 5)*qst(i-1,ny+2+0,indvarsst(10))*(d2_dif_nut_dxdx_0_0_im1nyp2p0k)

d1_dif_nut_dx_0_ip1nyp2p0k = -param_float(1 + 5)*(1.0_wp+&
                    (q(i+1,ny+2+0,indvars(5))/1.0_wp*q(i+1,ny+2+0,indvars(1))))*param_float(18 + 5)*qst(i+1,ny+2+0,indvarsst(10))*(d2_dif_nut_dxdx_0_0_ip1nyp2p0k)
...
d2_dif_nut_dydy_0_0_inyp2p0p0k_inyp2p0p0p0k = q(i,ny+2+0+0+0,indvars(5))

d2_dif_nut_dydy_0_0_inyp2p0p0k_inyp2p0p0m1k = q(i,ny+2+0+0-1,indvars(5))

d2_dif_nut_dydy_0_0_inyp2p0p0k_inyp2p0p0m2k = q(i,ny+2+0+0-2,indvars(5))

d2_dif_nut_dydy_0_0_inyp2p0p0k = 1.5_wp*d2_dif_nut_dydy_0_0_inyp2p0p0k_inyp2p0p0p0k-&
          2.0_wp*d2_dif_nut_dydy_0_0_inyp2p0p0k_inyp2p0p0m1k+&
          0.5_wp*d2_dif_nut_dydy_0_0_inyp2p0p0k_inyp2p0p0m2k

d2_dif_nut_dydy_0_0_inyp2p0p0k = d2_dif_nut_dydy_0_0_inyp2p0p0k*param_float(2)

d2_dif_nut_dydy_0_0_inyp2p0m1k_inyp2p0m1m1k = q(i,ny+2+0-1-1,indvars(5))

d2_dif_nut_dydy_0_0_inyp2p0m1k_inyp2p0m1p1k = q(i,ny+2+0-1+1,indvars(5))

d2_dif_nut_dydy_0_0_inyp2p0m1k = -&
          0.5_wp*d2_dif_nut_dydy_0_0_inyp2p0m1k_inyp2p0m1m1k+&
          0.5_wp*d2_dif_nut_dydy_0_0_inyp2p0m1k_inyp2p0m1p1k

d2_dif_nut_dydy_0_0_inyp2p0m1k = d2_dif_nut_dydy_0_0_inyp2p0m1k*param_float(2)

d2_dif_nut_dydy_0_0_inyp2p0m2k_inyp2p0m2m1k = q(i,ny+2+0-2-1,indvars(5))

d2_dif_nut_dydy_0_0_inyp2p0m2k_inyp2p0m2p1k = q(i,ny+2+0-2+1,indvars(5))

d2_dif_nut_dydy_0_0_inyp2p0m2k = -&
          0.5_wp*d2_dif_nut_dydy_0_0_inyp2p0m2k_inyp2p0m2m1k+&
          0.5_wp*d2_dif_nut_dydy_0_0_inyp2p0m2k_inyp2p0m2p1k

d2_dif_nut_dydy_0_0_inyp2p0m2k = d2_dif_nut_dydy_0_0_inyp2p0m2k*param_float(2)

d1_dif_nut_dy_1_inyp2p0p0k = q(i,ny+2+0+0,indvars(1))*q(i,ny+2+0+0,indvars(5))

d1_dif_nut_dy_1_inyp2p0m1k = q(i,ny+2+0-1,indvars(1))*q(i,ny+2+0-1,indvars(5))

d1_dif_nut_dy_1_inyp2p0m2k = q(i,ny+2+0-2,indvars(1))*q(i,ny+2+0-2,indvars(5))
...
d1_dif_nut_dy_2_inyp2p0p0k = q(i,ny+2+0+0,indvars(5))

d1_dif_nut_dy_2_inyp2p0m1k = q(i,ny+2+0-1,indvars(5))

d1_dif_nut_dy_2_inyp2p0m2k = q(i,ny+2+0-2,indvars(5))

d1_dif_nut_dy_2_inyp2p0k = 1.5_wp*d1_dif_nut_dy_2_inyp2p0p0k-&
          2.0_wp*d1_dif_nut_dy_2_inyp2p0m1k+&
          0.5_wp*d1_dif_nut_dy_2_inyp2p0m2k

d1_dif_nut_dy_2_inyp2p0k = d1_dif_nut_dy_2_inyp2p0k*param_float(2)

d1_dif_nut_dy_0_inyp2p0p0k = -param_float(1 + 5)*(1.0_wp+&
                    (q(i,ny+2+0+0,indvars(5))/1.0_wp*q(i,ny+2+0+0,indvars(1))))*param_float(18 + 5)*qst(i,ny+2+0+0,indvarsst(11))*(d2_dif_nut_dydy_0_0_inyp2p0p0k)

d1_dif_nut_dy_0_inyp2p0m1k = -param_float(1 + 5)*(1.0_wp+&
                    (q(i,ny+2+0-1,indvars(5))/1.0_wp*q(i,ny+2+0-1,indvars(1))))*param_float(18 + 5)*qst(i,ny+2+0-1,indvarsst(11))*(d2_dif_nut_dydy_0_0_inyp2p0m1k)

d1_dif_nut_dy_0_inyp2p0m2k = -param_float(1 + 5)*(1.0_wp+&
                    (q(i,ny+2+0-2,indvars(5))/1.0_wp*q(i,ny+2+0-2,indvars(1))))*param_float(18 + 5)*qst(i,ny+2+0-2,indvarsst(11))*(d2_dif_nut_dydy_0_0_inyp2p0m2k)
...
rhs(i,ny+2+0,indvars(5)) = rhs(i,ny+2+0,indvars(5))  -  ( qst(i,ny+2+0,indvarsst(10))*(d1_dif_nut_dx_0_inyp2p0k)+&
                    qst(i,ny+2+0,indvarsst(11))*(d1_dif_nut_dy_0_inyp2p0k)+&
                    -&
                    param_float(1 + 5)*param_float(7 + 5)*param_float(18 + 5)*((qst(i,ny+2+0,indvarsst(10)))**2*(d1_dif_nut_dx_1_inyp2p0k)*(d1_dif_nut_dx_2_inyp2p0k)+&
                    (qst(i,ny+2+0,indvarsst(11)))**2*(d1_dif_nut_dy_1_inyp2p0k)*(d1_dif_nut_dy_2_inyp2p0k))-&
