...
d2_rhs_nut_dxdx_1_0_im1nyp2p0k_im1m1nyp2p0k = q(i-1-1,ny+2+0,indvars(5))

d2_rhs_nut_dxdx_1_0_im1nyp2p0k_im1p1nyp2p0k = q(i-1+1,ny+2+0,indvars(5))

d2_rhs_nut_dxdx_1_0_im1nyp2p0k = -&
          0.5_wp*d2_rhs_nut_dxdx_1_0_im1nyp2p0k_im1m1nyp2p0k+&
          0.5_wp*d2_rhs_nut_dxdx_1_0_im1nyp2p0k_im1p1nyp2p0k

d2_rhs_nut_dxdx_1_0_im1nyp2p0k = d2_rhs_nut_dxdx_1_0_im1nyp2p0k*param_float(1)

d2_rhs_nut_dxdx_1_0_ip1nyp2p0k_ip1m1nyp2p0k = q(i+1-1,ny+2+0,indvars(5))

d2_rhs_nut_dxdx_1_0_ip1nyp2p0k_ip1p1nyp2p0k = q(i+1+1,ny+2+0,indvars(5))

d2_rhs_nut_dxdx_1_0_ip1nyp2p0k = -&
          0.5_wp*d2_rhs_nut_dxdx_1_0_ip1nyp2p0k_ip1m1nyp2p0k+&
          0.5_wp*d2_rhs_nut_dxdx_1_0_ip1nyp2p0k_ip1p1nyp2p0k

d2_rhs_nut_dxdx_1_0_ip1nyp2p0k = d2_rhs_nut_dxdx_1_0_ip1nyp2p0k*param_float(1)

d1_rhs_nut_dx_2_im1nyp2p0k = q(i-1,ny+2+0,indvars(1))*q(i-1,ny+2+0,indvars(5))

d1_rhs_nut_dx_2_ip1nyp2p0k = q(i+1,ny+2+0,indvars(1))*q(i+1,ny+2+0,indvars(5))
...
d1_rhs_nut_dx_3_im1nyp2p0k = q(i-1,ny+2+0,indvars(5))

d1_rhs_nut_dx_3_ip1nyp2p0k = q(i+1,ny+2+0,indvars(5))

d1_rhs_nut_dx_3_inyp2p0k = -&
          0.5_wp*d1_rhs_nut_dx_3_im1nyp2p0k+&
          0.5_wp*d1_rhs_nut_dx_3_ip1nyp2p0k

d1_rhs_nut_dx_3_inyp2p0k = d1_rhs_nut_dx_3_inyp2p0k*param_float(1)

d1_rhs_nut_dx_1_im1nyp2p0k = (param_float(1 + 5)*(1.0_wp+&
                    (q(i-1,ny+2+0,indvars(5))/1.0_wp))*param_float(18 + 5)*qst(i-1,ny+2+0,indvarsst(10))*(d2_rhs_nut_dxdx_1_0_im1nyp2p0k))

d1_rhs_nut_dx_1_ip1nyp2p0k = (param_float(1 + 5)*(1.0_wp+&
                    (q(i+1,ny+2+0,indvars(5))/1.0_wp))*param_float(18 + 5)*qst(i+1,ny+2+0,indvarsst(10))*(d2_rhs_nut_dxdx_1_0_ip1nyp2p0k))
...
rhs(i,ny+2+0,indvars(5)) =   -  ( qst(i,ny+2+0,indvarsst(10))*(d1_rhs_nut_dx_0_inyp2p0k)+&
                    -&
                    qst(i,ny+2+0,indvarsst(10))*(d1_rhs_nut_dx_1_inyp2p0k)-&
                    param_float(1 + 5)*param_float(7 + 5)*param_float(18 + 5)*((qst(i,ny+2+0,indvarsst(10)))**2*(d1_rhs_nut_dx_2_inyp2p0k)*(d1_rhs_nut_dx_3_inyp2p0k))-&
                    param_float(6 + 5)*(1-&
