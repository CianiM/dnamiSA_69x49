...
d1_rhs_nut_dx_3_nxp2p0p01m2p0k = (q(nx+2+0+0,1-2+0,indvars(1))*q(nx+2+0+0,1-2+0,indvars(5)))*q(nx+2+0+0,1-2+0,indvars(2))

d1_rhs_nut_dx_3_nxp2p0m11m2p0k = (q(nx+2+0-1,1-2+0,indvars(1))*q(nx+2+0-1,1-2+0,indvars(5)))*q(nx+2+0-1,1-2+0,indvars(2))

d1_rhs_nut_dx_3_nxp2p0m21m2p0k = (q(nx+2+0-2,1-2+0,indvars(1))*q(nx+2+0-2,1-2+0,indvars(5)))*q(nx+2+0-2,1-2+0,indvars(2))
