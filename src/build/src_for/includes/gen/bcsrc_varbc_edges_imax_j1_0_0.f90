...
subroutine boundarySchemevarbc_edges_imax_j1_0_0(param_float,hlo,ind,idarray,neq,neqst,nx,ny,nz,sizeblck,q,qst,rhs,nvar_f,nvar_e,qface_i,qface_j,qface_k,qedge_ij,qedge_jk,qedge_ik)
...
qface_i(1-2+0,2) =  (q(nx+2+0,1-2+0,indvars(2))/(param_float(23 + 5)*(param_float(3 + 5))*q(nx+2+0,1-2+0,indvars(1))*((q(nx+2+0,1-2+0,indvars(4))-&
...
!$OMP END DO
 ...
 end subroutine boundarySchemevarbc_edges_imax_j1_0_0
