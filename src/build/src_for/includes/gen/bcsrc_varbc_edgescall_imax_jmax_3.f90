...
subroutine boundarySchemevarbc_edges_imax_jmax_3(param_float,hlo,ind,idarray,neq,neqst,nx,ny,nz,sizeblck,q,qst,rhs,nvar_f,nvar_e,qface_i,qface_j,qface_k,qedge_ij,qedge_jk,qedge_ik)
...
!f2py intent(inout) :: q,rhs
      ...
      call  boundarySchemevarbc_edges_imax_jmax_3_0(param_float,hlo,ind,idarray,neq,neqst,nx,ny,nz,sizeblck,q,qst,rhs,nvar_f,nvar_e,qface_i,qface_j,qface_k,qedge_ij,qedge_jk,qedge_ik)



 end subroutine boundarySchemevarbc_edges_imax_jmax_3
