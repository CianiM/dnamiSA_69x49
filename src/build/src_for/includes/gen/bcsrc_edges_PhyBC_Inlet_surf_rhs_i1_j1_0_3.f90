...
subroutine boundaryScheme_edges_PhyBC_Inlet_surf_rhs_i1_j1_0_3(param_float,hlo,ind,idarray,neq,neqst,nx,ny,nz,sizeblck,q,qst,rhs,nvar_f,nvar_e,qface_i,qface_j,qface_k,qedge_ij,qedge_jk,qedge_ik)
...
! LOCAL VARIABLES
 ...
 real(wp) ::  d1_rhs_rho_dx_0_1m4p0p01m4p3k,d1_rhs_rho_dx_0_1m4p0p11m4p3k,d1_rhs_rho_dx_0_1m4p0p21m4p3k &
            ,d1_rhs_rho_dx_0_1m4p01m4p3k &
            ,d1_rhs_rho_dx_1_1m4p0p01m4p3k,d1_rhs_rho_dx_1_1m4p0p11m4p3k,d1_rhs_rho_dx_1_1m4p0p21m4p3k &
            ,d1_rhs_rho_dx_1_1m4p01m4p3k &
            ,d1_rhs_rho_dy_0_1m4p01m4p3m1k,d1_rhs_rho_dy_0_1m4p01m4p3p0k,d1_rhs_rho_dy_0_1m4p01m4p3p1k &
...
rhs(1-4+0,1-4+3,indvars(1)) =   -  ( (1.0_wp/(param_float(23 + 5)*(param_float(3 + 5))*q(1-4+0,1-4+3,indvars(1))*((q(1-4+0,1-4+3,indvars(4))-&
                    ...
                    q(1-4+0,1-4+3,indvars(3))*q(1-4+0,1-4+3,indvars(3)))))/q(1-4+0,1-4+3,indvars(1)))**0.5**2*(((((param_float(23 + 5)*(param_float(3 + 5))*q(1-4+0,1-4+3,indvars(1))*((q(1-4+0,1-4+3,indvars(4))-&
                    0.5_wp*(q(1-4+0,1-4+3,indvars(2))*q(1-4+0,1-4+3,indvars(2))+&
                    q(1-4+0,1-4+3,indvars(3))*q(1-4+0,1-4+3,indvars(3)))))/q(1-4+0,1-4+3,indvars(1)))**0.5+&
                    q(1-4+0,1-4+3,indvars(2)))*((param_float(23 + 5)*(param_float(3 + 5))*q(1-4+0,1-4+3,indvars(1))*((q(1-4+0,1-4+3,indvars(4))-&
                    0.5_wp*(q(1-4+0,1-4+3,indvars(2))*q(1-4+0,1-4+3,indvars(2))+&
                    q(1-4+0,1-4+3,indvars(3))*q(1-4+0,1-4+3,indvars(3)))))/q(1-4+0,1-4+3,indvars(1)))**0.5*q(1-4+0,1-4+3,indvars(1))*d1_rhs_rho_dx_0_1m4p01m4p3k+&
...
!$OMP END DO
 ...
 end subroutine boundaryScheme_edges_PhyBC_Inlet_surf_rhs_i1_j1_0_3
