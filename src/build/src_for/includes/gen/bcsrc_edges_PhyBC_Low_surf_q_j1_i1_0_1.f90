...
q(1-4+1,1-4+0,indvars(2)) =  qst(1-4+1,1-4+0,indvarsst(5))*q(1-4+1,1-4+0,indvars(2))
...
q(1-4+1,1-4+0,indvars(3)) =  0.0_wp
...
q(1-4+1,1-4+0,indvars(5)) =  qst(1-4+1,1-4+0,indvarsst(5))*q(1-4+1,1-4+0,indvars(5))
