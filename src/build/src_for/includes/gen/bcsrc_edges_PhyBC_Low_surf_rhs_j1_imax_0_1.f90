...
! LOCAL VARIABLES
 ...
 real(wp) ::  d1_rhs_rho_dx_0_nxp2m1m11m2p0k,d1_rhs_rho_dx_0_nxp2m1p01m2p0k,d1_rhs_rho_dx_0_nxp2m1p11m2p0k &
            ...
            ,d2_rhs_nut_dxdx_0_0_nxp2m1m11m2p0k_nxp2m1m1m11m2p0k,d2_rhs_nut_dxdx_0_0_nxp2m1m11m2p0k_nxp2m1m1p01m2p0k,d2_rhs_nut_dxdx_0_0_nxp2m1m11m2p0k_nxp2m1m1p11m2p0k &
            ,d2_rhs_nut_dxdx_0_0_nxp2m1m11m2p0k &
            ,d2_rhs_nut_dxdx_0_0_nxp2m1p11m2p0k_nxp2m1p1p01m2p0k,d2_rhs_nut_dxdx_0_0_nxp2m1p11m2p0k_nxp2m1p1m11m2p0k,d2_rhs_nut_dxdx_0_0_nxp2m1p11m2p0k_nxp2m1p1m21m2p0k &
            ,d2_rhs_nut_dxdx_0_0_nxp2m1p11m2p0k &
            ...
            ,d1_rhs_nut_dx_3_nxp2m1m11m2p0k,d1_rhs_nut_dx_3_nxp2m1p01m2p0k,d1_rhs_nut_dx_3_nxp2m1p11m2p0k &
...
rhs(nx+2-1,1-2+0,indvars(1)) =   -  ( (qst(nx+2-1,1-2+0,indvarsst(10))*(d1_rhs_rho_dx_0_nxp2m11m2p0k))*qst(nx+2-1,1-2+0,indvarsst(5))+&
                    (q(nx+2-1,1-2+0,indvars(1))*(d1_rhs_rho_dy_0_nxp2m11m2p0k)*qst(nx+2-1,1-2+0,indvarsst(11)))*dabs(1.0_wp-&
...
d1_rhs_u_dx_0_nxp2m1m11m2p0k = -4.0_wp/3.0_wp*(1.0_wp)*(1.0_wp+&
                    ((q(nx+2-1-1,1-2+0,indvars(5))/1.0_wp)**3.0_wp/((q(nx+2-1-1,1-2+0,indvars(5))/1.0_wp)**3.0_wp+&
                    param_float(13 + 5)**3.0_wp))*(q(nx+2-1-1,1-2+0,indvars(5))/1.0_wp))*param_float(1 + 5)*(d2_rhs_u_dxdx_0_0_nxp2m1m11m2p0k)*qst(nx+2-1-1,1-2+0,indvarsst(10))

d1_rhs_u_dx_0_nxp2m1p11m2p0k = -4.0_wp/3.0_wp*(1.0_wp)*(1.0_wp+&
                    ((q(nx+2-1+1,1-2+0,indvars(5))/1.0_wp)**3.0_wp/((q(nx+2-1+1,1-2+0,indvars(5))/1.0_wp)**3.0_wp+&
                    param_float(13 + 5)**3.0_wp))*(q(nx+2-1+1,1-2+0,indvars(5))/1.0_wp))*param_float(1 + 5)*(d2_rhs_u_dxdx_0_0_nxp2m1p11m2p0k)*qst(nx+2-1+1,1-2+0,indvarsst(10))
...
d1_rhs_v_dx_0_nxp2m1m11m2p0k = -(1.0_wp)*(1.0_wp+&
                    ((q(nx+2-1-1,1-2+0,indvars(5))/1.0_wp)**3.0_wp/((q(nx+2-1-1,1-2+0,indvars(5))/1.0_wp)**3.0_wp+&
                    param_float(13 + 5)**3.0_wp))*(q(nx+2-1-1,1-2+0,indvars(5))/1.0_wp))*param_float(1 + 5)*(d2_rhs_v_dxdx_0_0_nxp2m1m11m2p0k)*qst(nx+2-1-1,1-2+0,indvarsst(10))

d1_rhs_v_dx_0_nxp2m1p11m2p0k = -(1.0_wp)*(1.0_wp+&
                    ((q(nx+2-1+1,1-2+0,indvars(5))/1.0_wp)**3.0_wp/((q(nx+2-1+1,1-2+0,indvars(5))/1.0_wp)**3.0_wp+&
                    param_float(13 + 5)**3.0_wp))*(q(nx+2-1+1,1-2+0,indvars(5))/1.0_wp))*param_float(1 + 5)*(d2_rhs_v_dxdx_0_0_nxp2m1p11m2p0k)*qst(nx+2-1+1,1-2+0,indvarsst(10))
...
d1_rhs_et_dx_0_nxp2m1m11m2p0k = -4.0_wp/3.0_wp*(1.0_wp)*(1.0_wp+&
                    ((q(nx+2-1-1,1-2+0,indvars(5))/1.0_wp)**3.0_wp/((q(nx+2-1-1,1-2+0,indvars(5))/1.0_wp)**3.0_wp+&
                    param_float(13 + 5)**3.0_wp))*(q(nx+2-1-1,1-2+0,indvars(5))/1.0_wp))*param_float(1 + 5)*(d2_rhs_u_dxdx_0_0_nxp2m1m11m2p0k)*qst(nx+2-1-1,1-2+0,indvarsst(10))*q(nx+2-1-1,1-2+0,indvars(2))-&
                    (1.0_wp)*(1.0_wp+&
                    ((q(nx+2-1-1,1-2+0,indvars(5))/1.0_wp)**3.0_wp/((q(nx+2-1-1,1-2+0,indvars(5))/1.0_wp)**3.0_wp+&
                    param_float(13 + 5)**3.0_wp))*(q(nx+2-1-1,1-2+0,indvars(5))/1.0_wp))*param_float(1 + 5)*(d2_rhs_v_dxdx_0_0_nxp2m1m11m2p0k)*qst(nx+2-1-1,1-2+0,indvarsst(10))*q(nx+2-1-1,1-2+0,indvars(3))-&
                    param_float(2 + 5)*(d2_rhs_et_dxdx_0_2_nxp2m1m11m2p0k)*qst(nx+2-1-1,1-2+0,indvarsst(10))

d1_rhs_et_dx_0_nxp2m1p11m2p0k = -4.0_wp/3.0_wp*(1.0_wp)*(1.0_wp+&
                    ((q(nx+2-1+1,1-2+0,indvars(5))/1.0_wp)**3.0_wp/((q(nx+2-1+1,1-2+0,indvars(5))/1.0_wp)**3.0_wp+&
                    param_float(13 + 5)**3.0_wp))*(q(nx+2-1+1,1-2+0,indvars(5))/1.0_wp))*param_float(1 + 5)*(d2_rhs_u_dxdx_0_0_nxp2m1p11m2p0k)*qst(nx+2-1+1,1-2+0,indvarsst(10))*q(nx+2-1+1,1-2+0,indvars(2))-&
                    (1.0_wp)*(1.0_wp+&
                    ((q(nx+2-1+1,1-2+0,indvars(5))/1.0_wp)**3.0_wp/((q(nx+2-1+1,1-2+0,indvars(5))/1.0_wp)**3.0_wp+&
                    param_float(13 + 5)**3.0_wp))*(q(nx+2-1+1,1-2+0,indvars(5))/1.0_wp))*param_float(1 + 5)*(d2_rhs_v_dxdx_0_0_nxp2m1p11m2p0k)*qst(nx+2-1+1,1-2+0,indvarsst(10))*q(nx+2-1+1,1-2+0,indvars(3))-&
...
rhs(nx+2-1,1-2+0,indvars(4)) =   -  ( (qst(nx+2-1,1-2+0,indvarsst(10))*(d1_rhs_et_dx_0_nxp2m11m2p0k)+&
                    ...
                    (-&
                    (1.0_wp)*(1.0_wp+&
                    ((q(nx+2-1,1-2+0,indvars(5))/1.0_wp)**3.0_wp/((q(nx+2-1,1-2+0,indvars(5))/1.0_wp)**3.0_wp+&
                    param_float(13 + 5)**3.0_wp))*(q(nx+2-1,1-2+0,indvars(5))/1.0_wp))*param_float(1 + 5)*(d1_rhs_et_dy_0_nxp2m11m2p0k)*(d1_rhs_et_dy_0_nxp2m11m2p0k)*qst(nx+2-1,1-2+0,indvarsst(11))**2-&
                    4.0_wp/3.0_wp*(1.0_wp)*(1.0_wp+&
                    ((q(nx+2-1,1-2+0,indvars(5))/1.0_wp)**3.0_wp/((q(nx+2-1,1-2+0,indvars(5))/1.0_wp)**3.0_wp+&
                    param_float(13 + 5)**3.0_wp))*(q(nx+2-1,1-2+0,indvars(5))/1.0_wp))*param_float(1 + 5)*(d1_rhs_rho_dy_0_nxp2m11m2p0k)*(d1_rhs_rho_dy_0_nxp2m11m2p0k)*qst(nx+2-1,1-2+0,indvarsst(11))**2-&
                    ...
                    q(nx+2-1,1-2+0,indvars(3))*q(nx+2-1,1-2+0,indvars(3))))))*(d1_rhs_rho_dy_0_nxp2m11m2p0k)*qst(nx+2-1,1-2+0,indvarsst(11)))*dabs(1.0_wp-&
                    qst(nx+2-1,1-2+0,indvarsst(5))) ) 
...
d2_rhs_nut_dxdx_0_0_nxp2m1m11m2p0k_nxp2m1m1m11m2p0k = q(nx+2-1-1-1,1-2+0,indvars(5))

d2_rhs_nut_dxdx_0_0_nxp2m1m11m2p0k_nxp2m1m1p11m2p0k = q(nx+2-1-1+1,1-2+0,indvars(5))

d2_rhs_nut_dxdx_0_0_nxp2m1m11m2p0k = -&
          0.5_wp*d2_rhs_nut_dxdx_0_0_nxp2m1m11m2p0k_nxp2m1m1m11m2p0k+&
          0.5_wp*d2_rhs_nut_dxdx_0_0_nxp2m1m11m2p0k_nxp2m1m1p11m2p0k

d2_rhs_nut_dxdx_0_0_nxp2m1m11m2p0k = d2_rhs_nut_dxdx_0_0_nxp2m1m11m2p0k*param_float(1)

d2_rhs_nut_dxdx_0_0_nxp2m1p11m2p0k_nxp2m1p1p01m2p0k = q(nx+2-1+1+0,1-2+0,indvars(5))

d2_rhs_nut_dxdx_0_0_nxp2m1p11m2p0k_nxp2m1p1m11m2p0k = q(nx+2-1+1-1,1-2+0,indvars(5))

d2_rhs_nut_dxdx_0_0_nxp2m1p11m2p0k_nxp2m1p1m21m2p0k = q(nx+2-1+1-2,1-2+0,indvars(5))

d2_rhs_nut_dxdx_0_0_nxp2m1p11m2p0k = 1.5_wp*d2_rhs_nut_dxdx_0_0_nxp2m1p11m2p0k_nxp2m1p1p01m2p0k-&
          2.0_wp*d2_rhs_nut_dxdx_0_0_nxp2m1p11m2p0k_nxp2m1p1m11m2p0k+&
          0.5_wp*d2_rhs_nut_dxdx_0_0_nxp2m1p11m2p0k_nxp2m1p1m21m2p0k

d2_rhs_nut_dxdx_0_0_nxp2m1p11m2p0k = d2_rhs_nut_dxdx_0_0_nxp2m1p11m2p0k*param_float(1)

d1_rhs_nut_dx_1_nxp2m1m11m2p0k = q(nx+2-1-1,1-2+0,indvars(1))*q(nx+2-1-1,1-2+0,indvars(5))

d1_rhs_nut_dx_1_nxp2m1p11m2p0k = q(nx+2-1+1,1-2+0,indvars(1))*q(nx+2-1+1,1-2+0,indvars(5))
...
d1_rhs_nut_dx_2_nxp2m1m11m2p0k = q(nx+2-1-1,1-2+0,indvars(5))

d1_rhs_nut_dx_2_nxp2m1p11m2p0k = q(nx+2-1+1,1-2+0,indvars(5))
...
d1_rhs_nut_dx_3_nxp2m11m2p0k = -&
          ...
          0.5_wp*d1_rhs_nut_dx_3_nxp2m1p11m2p0k

d1_rhs_nut_dx_3_nxp2m11m2p0k = d1_rhs_nut_dx_3_nxp2m11m2p0k*param_float(1)

d1_rhs_nut_dx_0_nxp2m1m11m2p0k = -param_float(1 + 5)*(1.0_wp+&
                    (q(nx+2-1-1,1-2+0,indvars(5))/1.0_wp))*param_float(18 + 5)*qst(nx+2-1-1,1-2+0,indvarsst(10))*(d2_rhs_nut_dxdx_0_0_nxp2m1m11m2p0k)

d1_rhs_nut_dx_0_nxp2m1p11m2p0k = -param_float(1 + 5)*(1.0_wp+&
                    (q(nx+2-1+1,1-2+0,indvars(5))/1.0_wp))*param_float(18 + 5)*qst(nx+2-1+1,1-2+0,indvarsst(10))*(d2_rhs_nut_dxdx_0_0_nxp2m1p11m2p0k)
...
rhs(nx+2-1,1-2+0,indvars(5)) =   -  ( (qst(nx+2-1,1-2+0,indvarsst(10))*(d1_rhs_nut_dx_0_nxp2m11m2p0k)-&
                    param_float(1 + 5)*param_float(7 + 5)*param_float(18 + 5)*((qst(nx+2-1,1-2+0,indvarsst(10)))**2*(d1_rhs_nut_dx_1_nxp2m11m2p0k)*(d1_rhs_nut_dx_2_nxp2m11m2p0k))-&
                    param_float(6 + 5)*(1-&
                    ...
                    param_float(17 + 5)*(q(nx+2-1,1-2+0,indvars(5))/1.0_wp)**2.0_wp)))*q(nx+2-1,1-2+0,indvars(1))*(q(nx+2-1,1-2+0,indvars(5))/qst(nx+2-1,1-2+0,indvarsst(2)))**2+&
                    qst(nx+2-1,1-2+0,indvarsst(10))*(d1_rhs_nut_dx_3_nxp2m11m2p0k))*qst(nx+2-1,1-2+0,indvarsst(5)) ) 
