...
subroutine boundarySchemevarbc_edges_imax_jmax_0_3(param_float,hlo,ind,idarray,neq,neqst,nx,ny,nz,sizeblck,q,qst,rhs,nvar_f,nvar_e,qface_i,qface_j,qface_k,qedge_ij,qedge_jk,qedge_ik)
...
qface_i(ny+4-3,2) =  (q(nx+4+0,ny+4-3,indvars(2))/(param_float(23 + 5)*(param_float(3 + 5))*q(nx+4+0,ny+4-3,indvars(1))*((q(nx+4+0,ny+4-3,indvars(4))-&
...
!$OMP END DO
 ...
 end subroutine boundarySchemevarbc_edges_imax_jmax_0_3
