...
d1_rhs_rho_dx_0_1m4p0p01m4p0k = q(1-4+0+0,1-4+0,indvars(2))

d1_rhs_rho_dx_0_1m4p0p11m4p0k = q(1-4+0+1,1-4+0,indvars(2))

d1_rhs_rho_dx_0_1m4p0p21m4p0k = q(1-4+0+2,1-4+0,indvars(2))
...
d1_rhs_rho_dx_1_1m4p0p01m4p0k = (param_float(3 + 5))*q(1-4+0+0,1-4+0,indvars(1))*((q(1-4+0+0,1-4+0,indvars(4))-&
                    0.5_wp*(q(1-4+0+0,1-4+0,indvars(2))*q(1-4+0+0,1-4+0,indvars(2))+&
                    q(1-4+0+0,1-4+0,indvars(3))*q(1-4+0+0,1-4+0,indvars(3)))))

d1_rhs_rho_dx_1_1m4p0p11m4p0k = (param_float(3 + 5))*q(1-4+0+1,1-4+0,indvars(1))*((q(1-4+0+1,1-4+0,indvars(4))-&
                    0.5_wp*(q(1-4+0+1,1-4+0,indvars(2))*q(1-4+0+1,1-4+0,indvars(2))+&
                    q(1-4+0+1,1-4+0,indvars(3))*q(1-4+0+1,1-4+0,indvars(3)))))

d1_rhs_rho_dx_1_1m4p0p21m4p0k = (param_float(3 + 5))*q(1-4+0+2,1-4+0,indvars(1))*((q(1-4+0+2,1-4+0,indvars(4))-&
                    0.5_wp*(q(1-4+0+2,1-4+0,indvars(2))*q(1-4+0+2,1-4+0,indvars(2))+&
                    q(1-4+0+2,1-4+0,indvars(3))*q(1-4+0+2,1-4+0,indvars(3)))))

d1_rhs_rho_dx_1_1m4p01m4p0k = -&
          1.5_wp*d1_rhs_rho_dx_1_1m4p0p01m4p0k+&
          2.0_wp*d1_rhs_rho_dx_1_1m4p0p11m4p0k-&
          0.5_wp*d1_rhs_rho_dx_1_1m4p0p21m4p0k

d1_rhs_rho_dx_1_1m4p01m4p0k = d1_rhs_rho_dx_1_1m4p01m4p0k*param_float(1)

d1_rhs_rho_dy_0_1m4p01m4p0p0k = q(1-4+0,1-4+0+0,indvars(1))*q(1-4+0,1-4+0+0,indvars(3))

d1_rhs_rho_dy_0_1m4p01m4p0p1k = q(1-4+0,1-4+0+1,indvars(1))*q(1-4+0,1-4+0+1,indvars(3))

d1_rhs_rho_dy_0_1m4p01m4p0p2k = q(1-4+0,1-4+0+2,indvars(1))*q(1-4+0,1-4+0+2,indvars(3))
...
rhs(1-4+0,1-4+0,indvars(1)) =   -  ( (1.0_wp/(param_float(23 + 5)*(param_float(3 + 5))*q(1-4+0,1-4+0,indvars(1))*((q(1-4+0,1-4+0,indvars(4))-&
                    0.5_wp*(q(1-4+0,1-4+0,indvars(2))*q(1-4+0,1-4+0,indvars(2))+&
                    q(1-4+0,1-4+0,indvars(3))*q(1-4+0,1-4+0,indvars(3)))))/q(1-4+0,1-4+0,indvars(1)))**0.5**2*(((((param_float(23 + 5)*(param_float(3 + 5))*q(1-4+0,1-4+0,indvars(1))*((q(1-4+0,1-4+0,indvars(4))-&
                    0.5_wp*(q(1-4+0,1-4+0,indvars(2))*q(1-4+0,1-4+0,indvars(2))+&
                    q(1-4+0,1-4+0,indvars(3))*q(1-4+0,1-4+0,indvars(3)))))/q(1-4+0,1-4+0,indvars(1)))**0.5+&
                    q(1-4+0,1-4+0,indvars(2)))*((param_float(23 + 5)*(param_float(3 + 5))*q(1-4+0,1-4+0,indvars(1))*((q(1-4+0,1-4+0,indvars(4))-&
                    0.5_wp*(q(1-4+0,1-4+0,indvars(2))*q(1-4+0,1-4+0,indvars(2))+&
                    q(1-4+0,1-4+0,indvars(3))*q(1-4+0,1-4+0,indvars(3)))))/q(1-4+0,1-4+0,indvars(1)))**0.5*q(1-4+0,1-4+0,indvars(1))*d1_rhs_rho_dx_0_1m4p01m4p0k+&
                    1.0_wp*d1_rhs_rho_dx_1_1m4p01m4p0k))*qst(1-4+0,1-4+0,indvarsst(10)))*(param_float(3 + 5))+&
                    0.5_wp*((((param_float(23 + 5)*(param_float(3 + 5))*q(1-4+0,1-4+0,indvars(1))*((q(1-4+0,1-4+0,indvars(4))-&
                    0.5_wp*(q(1-4+0,1-4+0,indvars(2))*q(1-4+0,1-4+0,indvars(2))+&
                    q(1-4+0,1-4+0,indvars(3))*q(1-4+0,1-4+0,indvars(3)))))/q(1-4+0,1-4+0,indvars(1)))**0.5+&
                    q(1-4+0,1-4+0,indvars(2)))*((param_float(23 + 5)*(param_float(3 + 5))*q(1-4+0,1-4+0,indvars(1))*((q(1-4+0,1-4+0,indvars(4))-&
                    0.5_wp*(q(1-4+0,1-4+0,indvars(2))*q(1-4+0,1-4+0,indvars(2))+&
                    q(1-4+0,1-4+0,indvars(3))*q(1-4+0,1-4+0,indvars(3)))))/q(1-4+0,1-4+0,indvars(1)))**0.5*q(1-4+0,1-4+0,indvars(1))*d1_rhs_rho_dx_0_1m4p01m4p0k+&
                    1.0_wp*d1_rhs_rho_dx_1_1m4p01m4p0k))*qst(1-4+0,1-4+0,indvarsst(10))+&
                    (((param_float(23 + 5)*(param_float(3 + 5))*q(1-4+0,1-4+0,indvars(1))*((q(1-4+0,1-4+0,indvars(4))-&
                    0.5_wp*(q(1-4+0,1-4+0,indvars(2))*q(1-4+0,1-4+0,indvars(2))+&
                    q(1-4+0,1-4+0,indvars(3))*q(1-4+0,1-4+0,indvars(3)))))/q(1-4+0,1-4+0,indvars(1)))**0.5+&
                    q(1-4+0,1-4+0,indvars(2)))*((param_float(23 + 5)*(param_float(3 + 5))*q(1-4+0,1-4+0,indvars(1))*((q(1-4+0,1-4+0,indvars(4))-&
                    0.5_wp*(q(1-4+0,1-4+0,indvars(2))*q(1-4+0,1-4+0,indvars(2))+&
                    q(1-4+0,1-4+0,indvars(3))*q(1-4+0,1-4+0,indvars(3)))))/q(1-4+0,1-4+0,indvars(1)))**0.5*q(1-4+0,1-4+0,indvars(1))*d1_rhs_rho_dx_0_1m4p01m4p0k+&
                    1.0_wp*d1_rhs_rho_dx_1_1m4p01m4p0k))*qst(1-4+0,1-4+0,indvarsst(10)))))+d1_rhs_rho_dy_0_1m4p01m4p0k ) 
