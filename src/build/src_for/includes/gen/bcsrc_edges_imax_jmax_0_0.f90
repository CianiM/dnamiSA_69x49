...
d1_conv_nut_dx_0_nxp4p0p0nyp4p0k = q(nx+4+0+0,ny+4+0,indvars(1))*q(nx+4+0+0,ny+4+0,indvars(2))*q(nx+4+0+0,ny+4+0,indvars(5))-&
                    ...
                    param_float(13 + 5)**3.0_wp))*(q(nx+4+0+0,ny+4+0,indvars(5))/1.0_wp*q(nx+4+0+0,ny+4+0,indvars(1))))*param_float(1 + 5)*param_float(18 + 5)*qst(nx+4+0+0,ny+4+0,indvarsst(10))*(d2_conv_nut_dxdx_0_0_nxp4p0p0nyp4p0k)
...
d1_conv_nut_dx_0_nxp4p0m1nyp4p0k = q(nx+4+0-1,ny+4+0,indvars(1))*q(nx+4+0-1,ny+4+0,indvars(2))*q(nx+4+0-1,ny+4+0,indvars(5))-&
                    ...
                    param_float(13 + 5)**3.0_wp))*(q(nx+4+0-1,ny+4+0,indvars(5))/1.0_wp*q(nx+4+0-1,ny+4+0,indvars(1))))*param_float(1 + 5)*param_float(18 + 5)*qst(nx+4+0-1,ny+4+0,indvarsst(10))*(d2_conv_nut_dxdx_0_0_nxp4p0m1nyp4p0k)
...
d1_conv_nut_dx_0_nxp4p0m2nyp4p0k = q(nx+4+0-2,ny+4+0,indvars(1))*q(nx+4+0-2,ny+4+0,indvars(2))*q(nx+4+0-2,ny+4+0,indvars(5))-&
                    ...
                    param_float(13 + 5)**3.0_wp))*(q(nx+4+0-2,ny+4+0,indvars(5))/1.0_wp*q(nx+4+0-2,ny+4+0,indvars(1))))*param_float(1 + 5)*param_float(18 + 5)*qst(nx+4+0-2,ny+4+0,indvarsst(10))*(d2_conv_nut_dxdx_0_0_nxp4p0m2nyp4p0k)
...
d1_conv_nut_dy_0_nxp4p0nyp4p0p0k = q(nx+4+0,ny+4+0+0,indvars(1))*q(nx+4+0,ny+4+0+0,indvars(3))*q(nx+4+0,ny+4+0+0,indvars(5))-&
                    ...
                    param_float(13 + 5)**3.0_wp))*(q(nx+4+0,ny+4+0+0,indvars(5))/1.0_wp*q(nx+4+0,ny+4+0+0,indvars(1))))*param_float(1 + 5)*param_float(18 + 5)*qst(nx+4+0,ny+4+0+0,indvarsst(11))*(d2_conv_nut_dydy_0_0_nxp4p0nyp4p0p0k)
...
d1_conv_nut_dy_0_nxp4p0nyp4p0m1k = q(nx+4+0,ny+4+0-1,indvars(1))*q(nx+4+0,ny+4+0-1,indvars(3))*q(nx+4+0,ny+4+0-1,indvars(5))-&
                    ...
                    param_float(13 + 5)**3.0_wp))*(q(nx+4+0,ny+4+0-1,indvars(5))/1.0_wp*q(nx+4+0,ny+4+0-1,indvars(1))))*param_float(1 + 5)*param_float(18 + 5)*qst(nx+4+0,ny+4+0-1,indvarsst(11))*(d2_conv_nut_dydy_0_0_nxp4p0nyp4p0m1k)
...
d1_conv_nut_dy_0_nxp4p0nyp4p0m2k = q(nx+4+0,ny+4+0-2,indvars(1))*q(nx+4+0,ny+4+0-2,indvars(3))*q(nx+4+0,ny+4+0-2,indvars(5))-&
                    ...
                    param_float(13 + 5)**3.0_wp))*(q(nx+4+0,ny+4+0-2,indvars(5))/1.0_wp*q(nx+4+0,ny+4+0-2,indvars(1))))*param_float(1 + 5)*param_float(18 + 5)*qst(nx+4+0,ny+4+0-2,indvarsst(11))*(d2_conv_nut_dydy_0_0_nxp4p0nyp4p0m2k)
...
d1_dif_rhou_dx_0_nxp4p0p0nyp4p0k = -(1.0_wp)*(1.0_wp+&
                    ((q(nx+4+0+0,ny+4+0,indvars(5))/1.0_wp*q(nx+4+0+0,ny+4+0,indvars(1)))**3.0_wp/((q(nx+4+0+0,ny+4+0,indvars(5))/1.0_wp*q(nx+4+0+0,ny+4+0,indvars(1)))**3.0_wp+&
                    param_float(13 + 5)**3.0_wp))*(q(nx+4+0+0,ny+4+0,indvars(5))/1.0_wp*q(nx+4+0+0,ny+4+0,indvars(1))))*param_float(1 + 5)*(2.0_wp*qst(nx+4+0+0,ny+4+0,indvarsst(10))*(d2_dif_rhou_dxdx_0_0_nxp4p0p0nyp4p0k)-&
...
d1_dif_rhou_dx_0_nxp4p0m1nyp4p0k = -(1.0_wp)*(1.0_wp+&
                    ((q(nx+4+0-1,ny+4+0,indvars(5))/1.0_wp*q(nx+4+0-1,ny+4+0,indvars(1)))**3.0_wp/((q(nx+4+0-1,ny+4+0,indvars(5))/1.0_wp*q(nx+4+0-1,ny+4+0,indvars(1)))**3.0_wp+&
                    param_float(13 + 5)**3.0_wp))*(q(nx+4+0-1,ny+4+0,indvars(5))/1.0_wp*q(nx+4+0-1,ny+4+0,indvars(1))))*param_float(1 + 5)*(2.0_wp*qst(nx+4+0-1,ny+4+0,indvarsst(10))*(d2_dif_rhou_dxdx_0_0_nxp4p0m1nyp4p0k)-&
...
d1_dif_rhou_dx_0_nxp4p0m2nyp4p0k = -(1.0_wp)*(1.0_wp+&
                    ((q(nx+4+0-2,ny+4+0,indvars(5))/1.0_wp*q(nx+4+0-2,ny+4+0,indvars(1)))**3.0_wp/((q(nx+4+0-2,ny+4+0,indvars(5))/1.0_wp*q(nx+4+0-2,ny+4+0,indvars(1)))**3.0_wp+&
                    param_float(13 + 5)**3.0_wp))*(q(nx+4+0-2,ny+4+0,indvars(5))/1.0_wp*q(nx+4+0-2,ny+4+0,indvars(1))))*param_float(1 + 5)*(2.0_wp*qst(nx+4+0-2,ny+4+0,indvarsst(10))*(d2_dif_rhou_dxdx_0_0_nxp4p0m2nyp4p0k)-&
...
d1_dif_rhou_dy_0_nxp4p0nyp4p0p0k = -(1.0_wp)*(1.0_wp+&
                    ((q(nx+4+0,ny+4+0+0,indvars(5))/1.0_wp*q(nx+4+0,ny+4+0+0,indvars(1)))**3.0_wp/((q(nx+4+0,ny+4+0+0,indvars(5))/1.0_wp*q(nx+4+0,ny+4+0+0,indvars(1)))**3.0_wp+&
                    param_float(13 + 5)**3.0_wp))*(q(nx+4+0,ny+4+0+0,indvars(5))/1.0_wp*q(nx+4+0,ny+4+0+0,indvars(1))))*param_float(1 + 5)*(qst(nx+4+0,ny+4+0+0,indvarsst(11))*(d2_dif_rhou_dydy_0_0_nxp4p0nyp4p0p0k)+&
                    qst(nx+4+0,ny+4+0+0,indvarsst(10))*(d2_dif_rhou_dydx_0_0_nxp4p0nyp4p0p0k))

d1_dif_rhou_dy_0_nxp4p0nyp4p0m1k = -(1.0_wp)*(1.0_wp+&
                    ((q(nx+4+0,ny+4+0-1,indvars(5))/1.0_wp*q(nx+4+0,ny+4+0-1,indvars(1)))**3.0_wp/((q(nx+4+0,ny+4+0-1,indvars(5))/1.0_wp*q(nx+4+0,ny+4+0-1,indvars(1)))**3.0_wp+&
                    param_float(13 + 5)**3.0_wp))*(q(nx+4+0,ny+4+0-1,indvars(5))/1.0_wp*q(nx+4+0,ny+4+0-1,indvars(1))))*param_float(1 + 5)*(qst(nx+4+0,ny+4+0-1,indvarsst(11))*(d2_dif_rhou_dydy_0_0_nxp4p0nyp4p0m1k)+&
                    qst(nx+4+0,ny+4+0-1,indvarsst(10))*(d2_dif_rhou_dydx_0_0_nxp4p0nyp4p0m1k))

d1_dif_rhou_dy_0_nxp4p0nyp4p0m2k = -(1.0_wp)*(1.0_wp+&
                    ((q(nx+4+0,ny+4+0-2,indvars(5))/1.0_wp*q(nx+4+0,ny+4+0-2,indvars(1)))**3.0_wp/((q(nx+4+0,ny+4+0-2,indvars(5))/1.0_wp*q(nx+4+0,ny+4+0-2,indvars(1)))**3.0_wp+&
                    param_float(13 + 5)**3.0_wp))*(q(nx+4+0,ny+4+0-2,indvars(5))/1.0_wp*q(nx+4+0,ny+4+0-2,indvars(1))))*param_float(1 + 5)*(qst(nx+4+0,ny+4+0-2,indvarsst(11))*(d2_dif_rhou_dydy_0_0_nxp4p0nyp4p0m2k)+&
...
d1_dif_rhov_dx_0_nxp4p0p0nyp4p0k = -(1.0_wp)*(1.0_wp+&
                    ((q(nx+4+0+0,ny+4+0,indvars(5))/1.0_wp*q(nx+4+0+0,ny+4+0,indvars(1)))**3.0_wp/((q(nx+4+0+0,ny+4+0,indvars(5))/1.0_wp*q(nx+4+0+0,ny+4+0,indvars(1)))**3.0_wp+&
                    param_float(13 + 5)**3.0_wp))*(q(nx+4+0+0,ny+4+0,indvars(5))/1.0_wp*q(nx+4+0+0,ny+4+0,indvars(1))))*param_float(1 + 5)*(qst(nx+4+0+0,ny+4+0,indvarsst(11))*(d2_dif_rhov_dxdy_0_0_nxp4p0p0nyp4p0k)+&
                    qst(nx+4+0+0,ny+4+0,indvarsst(10))*(d2_dif_rhov_dxdx_0_0_nxp4p0p0nyp4p0k))

d1_dif_rhov_dx_0_nxp4p0m1nyp4p0k = -(1.0_wp)*(1.0_wp+&
                    ((q(nx+4+0-1,ny+4+0,indvars(5))/1.0_wp*q(nx+4+0-1,ny+4+0,indvars(1)))**3.0_wp/((q(nx+4+0-1,ny+4+0,indvars(5))/1.0_wp*q(nx+4+0-1,ny+4+0,indvars(1)))**3.0_wp+&
                    param_float(13 + 5)**3.0_wp))*(q(nx+4+0-1,ny+4+0,indvars(5))/1.0_wp*q(nx+4+0-1,ny+4+0,indvars(1))))*param_float(1 + 5)*(qst(nx+4+0-1,ny+4+0,indvarsst(11))*(d2_dif_rhov_dxdy_0_0_nxp4p0m1nyp4p0k)+&
                    qst(nx+4+0-1,ny+4+0,indvarsst(10))*(d2_dif_rhov_dxdx_0_0_nxp4p0m1nyp4p0k))

d1_dif_rhov_dx_0_nxp4p0m2nyp4p0k = -(1.0_wp)*(1.0_wp+&
                    ((q(nx+4+0-2,ny+4+0,indvars(5))/1.0_wp*q(nx+4+0-2,ny+4+0,indvars(1)))**3.0_wp/((q(nx+4+0-2,ny+4+0,indvars(5))/1.0_wp*q(nx+4+0-2,ny+4+0,indvars(1)))**3.0_wp+&
                    param_float(13 + 5)**3.0_wp))*(q(nx+4+0-2,ny+4+0,indvars(5))/1.0_wp*q(nx+4+0-2,ny+4+0,indvars(1))))*param_float(1 + 5)*(qst(nx+4+0-2,ny+4+0,indvarsst(11))*(d2_dif_rhov_dxdy_0_0_nxp4p0m2nyp4p0k)+&
...
d1_dif_rhov_dy_0_nxp4p0nyp4p0p0k = -(1.0_wp)*(1.0_wp+&
                    ((q(nx+4+0,ny+4+0+0,indvars(5))/1.0_wp*q(nx+4+0,ny+4+0+0,indvars(1)))**3.0_wp/((q(nx+4+0,ny+4+0+0,indvars(5))/1.0_wp*q(nx+4+0,ny+4+0+0,indvars(1)))**3.0_wp+&
                    param_float(13 + 5)**3.0_wp))*(q(nx+4+0,ny+4+0+0,indvars(5))/1.0_wp*q(nx+4+0,ny+4+0+0,indvars(1))))*param_float(1 + 5)*(2.0_wp*qst(nx+4+0,ny+4+0+0,indvarsst(11))*(d2_dif_rhov_dydy_0_0_nxp4p0nyp4p0p0k)-&
...
d1_dif_rhov_dy_0_nxp4p0nyp4p0m1k = -(1.0_wp)*(1.0_wp+&
                    ((q(nx+4+0,ny+4+0-1,indvars(5))/1.0_wp*q(nx+4+0,ny+4+0-1,indvars(1)))**3.0_wp/((q(nx+4+0,ny+4+0-1,indvars(5))/1.0_wp*q(nx+4+0,ny+4+0-1,indvars(1)))**3.0_wp+&
                    param_float(13 + 5)**3.0_wp))*(q(nx+4+0,ny+4+0-1,indvars(5))/1.0_wp*q(nx+4+0,ny+4+0-1,indvars(1))))*param_float(1 + 5)*(2.0_wp*qst(nx+4+0,ny+4+0-1,indvarsst(11))*(d2_dif_rhov_dydy_0_0_nxp4p0nyp4p0m1k)-&
...
d1_dif_rhov_dy_0_nxp4p0nyp4p0m2k = -(1.0_wp)*(1.0_wp+&
                    ((q(nx+4+0,ny+4+0-2,indvars(5))/1.0_wp*q(nx+4+0,ny+4+0-2,indvars(1)))**3.0_wp/((q(nx+4+0,ny+4+0-2,indvars(5))/1.0_wp*q(nx+4+0,ny+4+0-2,indvars(1)))**3.0_wp+&
                    param_float(13 + 5)**3.0_wp))*(q(nx+4+0,ny+4+0-2,indvars(5))/1.0_wp*q(nx+4+0,ny+4+0-2,indvars(1))))*param_float(1 + 5)*(2.0_wp*qst(nx+4+0,ny+4+0-2,indvarsst(11))*(d2_dif_rhov_dydy_0_0_nxp4p0nyp4p0m2k)-&
...
rhs(nx+4+0,ny+4+0,indvars(5)) = rhs(nx+4+0,ny+4+0,indvars(5))  -  ( -param_float(1 + 5)*param_float(7 + 5)*param_float(18 + 5)*((qst(nx+4+0,ny+4+0,indvarsst(10)))**2*(d1_dif_nut_dx_0_nxp4p0nyp4p0k)*(d1_dif_nut_dx_1_nxp4p0nyp4p0k)+&
                    ...
                    param_float(17 + 5)*(q(nx+4+0,ny+4+0,indvars(5))/1.0_wp*q(nx+4+0,ny+4+0,indvars(1)))**2.0_wp)))*q(nx+4+0,ny+4+0,indvars(1))*q(nx+4+0,ny+4+0,indvars(5))**2.0_wp/qst(nx+4+0,ny+4+0,indvarsst(2))**2.0_wp ) 
