...
! LOCAL VARIABLES
 ...
 real(wp) ::  d1_stemp_dx_0_1m4p0p0nyp4m2k,d1_stemp_dx_0_1m4p0p1nyp4m2k,d1_stemp_dx_0_1m4p0p2nyp4m2k &
            ,d1_stemp_dx_0_1m4p0nyp4m2k &
            ,d1_stemp_dy_0_1m4p0nyp4m2m1k,d1_stemp_dy_0_1m4p0nyp4m2p0k,d1_stemp_dy_0_1m4p0nyp4m2p1k &
...
qst(1-4+0,ny+4-2,indvarsst(4)) =  (2.0_wp*(dabs(0.5_wp*(qst(1-4+0,ny+4-2,indvarsst(11))*(d1_stemp_dy_0_1m4p0nyp4m2k)-&
                    qst(1-4+0,ny+4-2,indvarsst(10))*(d1_stemp_dx_0_1m4p0nyp4m2k)))))
...
qst(1-4+0,ny+4-2,indvarsst(12)) =  (qst(1-4+0,ny+4-2,indvarsst(4))+&
                    (1.0_wp-&
                    (q(1-4+0,ny+4-2,indvars(5))/1.0_wp*q(1-4+0,ny+4-2,indvars(1)))/(1.0_wp+&
                    (q(1-4+0,ny+4-2,indvars(5))/1.0_wp*q(1-4+0,ny+4-2,indvars(1)))*((q(1-4+0,ny+4-2,indvars(5))/1.0_wp*q(1-4+0,ny+4-2,indvars(1)))**3.0_wp/((q(1-4+0,ny+4-2,indvars(5))/1.0_wp*q(1-4+0,ny+4-2,indvars(1)))**3.0_wp+&
                    param_float(13 + 5)**3.0_wp))))*param_float(1 + 5)*q(1-4+0,ny+4-2,indvars(5))/(param_float(9 + 5)**2.0_wp*qst(1-4+0,ny+4-2,indvarsst(2))**2.0_wp))
...
qst(1-4+0,ny+4-2,indvarsst(13)) =  ((1.0_wp)*(1.0_wp+&
                    ((q(1-4+0,ny+4-2,indvars(5))/1.0_wp*q(1-4+0,ny+4-2,indvars(1)))**3.0_wp/((q(1-4+0,ny+4-2,indvars(5))/1.0_wp*q(1-4+0,ny+4-2,indvars(1)))**3.0_wp+&
                    param_float(13 + 5)**3.0_wp))*(q(1-4+0,ny+4-2,indvars(5))/1.0_wp*q(1-4+0,ny+4-2,indvars(1))))*param_float(1 + 5)*(d1_stemp_dy_0_1m4p0nyp4m2k)*qst(1-4+0,ny+4-2,indvarsst(11)))
...
qst(1-4+0,ny+4-2,indvarsst(14)) =  q(1-4+0,ny+4-2,indvars(5))*q(1-4+0,ny+4-2,indvars(1))
...
qst(1-4+0,ny+4-2,indvarsst(15)) =  q(1-4+0,ny+4-2,indvars(5))*q(1-4+0,ny+4-2,indvars(1))*((q(1-4+0,ny+4-2,indvars(5))/1.0_wp*q(1-4+0,ny+4-2,indvars(1)))**3.0_wp/((q(1-4+0,ny+4-2,indvars(5))/1.0_wp*q(1-4+0,ny+4-2,indvars(1)))**3.0_wp+&
...
qst(1-4+0,ny+4-2,indvarsst(16)) =  (param_float(3 + 5))*q(1-4+0,ny+4-2,indvars(1))*((q(1-4+0,ny+4-2,indvars(4))-&
                    0.5_wp*(q(1-4+0,ny+4-2,indvars(2))*q(1-4+0,ny+4-2,indvars(2))+&
                    q(1-4+0,ny+4-2,indvars(3))*q(1-4+0,ny+4-2,indvars(3)))))
