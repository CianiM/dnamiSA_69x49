...
d1_conv_nut_dx_0_1m4p2m1jk = q(1-4+2-1,j,indvars(1))*q(1-4+2-1,j,indvars(2))*q(1-4+2-1,j,indvars(5))-&
                    ((1+&
                    param_float(21 + 5))/(((q(1-4+2-1,j,indvars(4))-&
                    0.5_wp*(q(1-4+2-1,j,indvars(2))*q(1-4+2-1,j,indvars(2))+&
                    q(1-4+2-1,j,indvars(3))*q(1-4+2-1,j,indvars(3)))))/param_float(4 + 5)+&
                    param_float(21 + 5))*((q(1-4+2-1,j,indvars(4))-&
                    0.5_wp*(q(1-4+2-1,j,indvars(2))*q(1-4+2-1,j,indvars(2))+&
                    q(1-4+2-1,j,indvars(3))*q(1-4+2-1,j,indvars(3)))))/param_float(4 + 5)**1.5)*(1+&
                    ((q(1-4+2-1,j,indvars(5))/(1+&
                    param_float(21 + 5))/(((q(1-4+2-1,j,indvars(4))-&
                    0.5_wp*(q(1-4+2-1,j,indvars(2))*q(1-4+2-1,j,indvars(2))+&
                    q(1-4+2-1,j,indvars(3))*q(1-4+2-1,j,indvars(3)))))/param_float(4 + 5)+&
                    param_float(21 + 5))*((q(1-4+2-1,j,indvars(4))-&
                    0.5_wp*(q(1-4+2-1,j,indvars(2))*q(1-4+2-1,j,indvars(2))+&
                    q(1-4+2-1,j,indvars(3))*q(1-4+2-1,j,indvars(3)))))/param_float(4 + 5)**1.5*q(1-4+2-1,j,indvars(1)))**3/((q(1-4+2-1,j,indvars(5))/(1+&
                    param_float(21 + 5))/(((q(1-4+2-1,j,indvars(4))-&
                    0.5_wp*(q(1-4+2-1,j,indvars(2))*q(1-4+2-1,j,indvars(2))+&
                    q(1-4+2-1,j,indvars(3))*q(1-4+2-1,j,indvars(3)))))/param_float(4 + 5)+&
                    param_float(21 + 5))*((q(1-4+2-1,j,indvars(4))-&
                    0.5_wp*(q(1-4+2-1,j,indvars(2))*q(1-4+2-1,j,indvars(2))+&
                    q(1-4+2-1,j,indvars(3))*q(1-4+2-1,j,indvars(3)))))/param_float(4 + 5)**1.5*q(1-4+2-1,j,indvars(1)))**3+&
                    param_float(13 + 5)**3))*(q(1-4+2-1,j,indvars(5))/(1+&
                    param_float(21 + 5))/(((q(1-4+2-1,j,indvars(4))-&
                    0.5_wp*(q(1-4+2-1,j,indvars(2))*q(1-4+2-1,j,indvars(2))+&
                    q(1-4+2-1,j,indvars(3))*q(1-4+2-1,j,indvars(3)))))/param_float(4 + 5)+&
                    param_float(21 + 5))*((q(1-4+2-1,j,indvars(4))-&
                    0.5_wp*(q(1-4+2-1,j,indvars(2))*q(1-4+2-1,j,indvars(2))+&
                    q(1-4+2-1,j,indvars(3))*q(1-4+2-1,j,indvars(3)))))/param_float(4 + 5)**1.5*q(1-4+2-1,j,indvars(1))))*param_float(1 + 5)*param_float(18 + 5)*qst(1-4+2-1,j,indvarsst(10))*(d2_conv_nut_dxdx_0_0_1m4p2m1jk)
...
d1_conv_nut_dx_0_1m4p2p1jk = q(1-4+2+1,j,indvars(1))*q(1-4+2+1,j,indvars(2))*q(1-4+2+1,j,indvars(5))-&
                    ...
                    param_float(21 + 5))*((q(1-4+2+1,j,indvars(4))-&
                    0.5_wp*(q(1-4+2+1,j,indvars(2))*q(1-4+2+1,j,indvars(2))+&
                    q(1-4+2+1,j,indvars(3))*q(1-4+2+1,j,indvars(3)))))/param_float(4 + 5)**1.5*q(1-4+2+1,j,indvars(1))))*param_float(1 + 5)*param_float(18 + 5)*qst(1-4+2+1,j,indvarsst(10))*(d2_conv_nut_dxdx_0_0_1m4p2p1jk)
...
d1_conv_nut_dy_0_1m4p2jm1k = q(1-4+2,j-1,indvars(1))*q(1-4+2,j-1,indvars(3))*q(1-4+2,j-1,indvars(5))-&
                    ((1+&
                    param_float(21 + 5))/(((q(1-4+2,j-1,indvars(4))-&
                    0.5_wp*(q(1-4+2,j-1,indvars(2))*q(1-4+2,j-1,indvars(2))+&
                    q(1-4+2,j-1,indvars(3))*q(1-4+2,j-1,indvars(3)))))/param_float(4 + 5)+&
                    param_float(21 + 5))*((q(1-4+2,j-1,indvars(4))-&
                    0.5_wp*(q(1-4+2,j-1,indvars(2))*q(1-4+2,j-1,indvars(2))+&
                    q(1-4+2,j-1,indvars(3))*q(1-4+2,j-1,indvars(3)))))/param_float(4 + 5)**1.5)*(1+&
                    ((q(1-4+2,j-1,indvars(5))/(1+&
                    param_float(21 + 5))/(((q(1-4+2,j-1,indvars(4))-&
                    0.5_wp*(q(1-4+2,j-1,indvars(2))*q(1-4+2,j-1,indvars(2))+&
                    q(1-4+2,j-1,indvars(3))*q(1-4+2,j-1,indvars(3)))))/param_float(4 + 5)+&
                    param_float(21 + 5))*((q(1-4+2,j-1,indvars(4))-&
                    0.5_wp*(q(1-4+2,j-1,indvars(2))*q(1-4+2,j-1,indvars(2))+&
                    q(1-4+2,j-1,indvars(3))*q(1-4+2,j-1,indvars(3)))))/param_float(4 + 5)**1.5*q(1-4+2,j-1,indvars(1)))**3/((q(1-4+2,j-1,indvars(5))/(1+&
                    param_float(21 + 5))/(((q(1-4+2,j-1,indvars(4))-&
                    0.5_wp*(q(1-4+2,j-1,indvars(2))*q(1-4+2,j-1,indvars(2))+&
                    q(1-4+2,j-1,indvars(3))*q(1-4+2,j-1,indvars(3)))))/param_float(4 + 5)+&
                    param_float(21 + 5))*((q(1-4+2,j-1,indvars(4))-&
                    0.5_wp*(q(1-4+2,j-1,indvars(2))*q(1-4+2,j-1,indvars(2))+&
                    q(1-4+2,j-1,indvars(3))*q(1-4+2,j-1,indvars(3)))))/param_float(4 + 5)**1.5*q(1-4+2,j-1,indvars(1)))**3+&
                    param_float(13 + 5)**3))*(q(1-4+2,j-1,indvars(5))/(1+&
                    param_float(21 + 5))/(((q(1-4+2,j-1,indvars(4))-&
                    0.5_wp*(q(1-4+2,j-1,indvars(2))*q(1-4+2,j-1,indvars(2))+&
                    q(1-4+2,j-1,indvars(3))*q(1-4+2,j-1,indvars(3)))))/param_float(4 + 5)+&
                    param_float(21 + 5))*((q(1-4+2,j-1,indvars(4))-&
                    0.5_wp*(q(1-4+2,j-1,indvars(2))*q(1-4+2,j-1,indvars(2))+&
                    q(1-4+2,j-1,indvars(3))*q(1-4+2,j-1,indvars(3)))))/param_float(4 + 5)**1.5*q(1-4+2,j-1,indvars(1))))*param_float(1 + 5)*param_float(18 + 5)*qst(1-4+2,j-1,indvarsst(11))*(d2_conv_nut_dydy_0_0_1m4p2jm1k)
...
d1_conv_nut_dy_0_1m4p2jp1k = q(1-4+2,j+1,indvars(1))*q(1-4+2,j+1,indvars(3))*q(1-4+2,j+1,indvars(5))-&
                    ...
                    param_float(21 + 5))*((q(1-4+2,j+1,indvars(4))-&
                    0.5_wp*(q(1-4+2,j+1,indvars(2))*q(1-4+2,j+1,indvars(2))+&
                    q(1-4+2,j+1,indvars(3))*q(1-4+2,j+1,indvars(3)))))/param_float(4 + 5)**1.5*q(1-4+2,j+1,indvars(1))))*param_float(1 + 5)*param_float(18 + 5)*qst(1-4+2,j+1,indvarsst(11))*(d2_conv_nut_dydy_0_0_1m4p2jp1k)
...
d1_dif_rhou_dx_0_1m4p2m1jk = -((1+&
                    ...
                    param_float(21 + 5))*((q(1-4+2-1,j,indvars(4))-&
                    0.5_wp*(q(1-4+2-1,j,indvars(2))*q(1-4+2-1,j,indvars(2))+&
                    q(1-4+2-1,j,indvars(3))*q(1-4+2-1,j,indvars(3)))))/param_float(4 + 5)**1.5*q(1-4+2-1,j,indvars(1))))*param_float(1 + 5)*(2.0_wp*qst(1-4+2-1,j,indvarsst(10))*(d2_dif_rhou_dxdx_0_0_1m4p2m1jk)-&
...
d1_dif_rhou_dx_0_1m4p2p1jk = -((1+&
                    ...
                    param_float(21 + 5))*((q(1-4+2+1,j,indvars(4))-&
                    0.5_wp*(q(1-4+2+1,j,indvars(2))*q(1-4+2+1,j,indvars(2))+&
                    q(1-4+2+1,j,indvars(3))*q(1-4+2+1,j,indvars(3)))))/param_float(4 + 5)**1.5*q(1-4+2+1,j,indvars(1))))*param_float(1 + 5)*(2.0_wp*qst(1-4+2+1,j,indvarsst(10))*(d2_dif_rhou_dxdx_0_0_1m4p2p1jk)-&
...
d1_dif_rhou_dy_0_1m4p2jm1k = -((1+&
                    ...
                    param_float(21 + 5))*((q(1-4+2,j-1,indvars(4))-&
                    0.5_wp*(q(1-4+2,j-1,indvars(2))*q(1-4+2,j-1,indvars(2))+&
                    q(1-4+2,j-1,indvars(3))*q(1-4+2,j-1,indvars(3)))))/param_float(4 + 5)**1.5*q(1-4+2,j-1,indvars(1))))*param_float(1 + 5)*(qst(1-4+2,j-1,indvarsst(11))*(d2_dif_rhou_dydy_0_0_1m4p2jm1k)+&
                    qst(1-4+2,j-1,indvarsst(10))*(d2_dif_rhou_dydx_0_0_1m4p2jm1k))

d1_dif_rhou_dy_0_1m4p2jp1k = -((1+&
                    param_float(21 + 5))/(((q(1-4+2,j+1,indvars(4))-&
                    0.5_wp*(q(1-4+2,j+1,indvars(2))*q(1-4+2,j+1,indvars(2))+&
                    q(1-4+2,j+1,indvars(3))*q(1-4+2,j+1,indvars(3)))))/param_float(4 + 5)+&
                    param_float(21 + 5))*((q(1-4+2,j+1,indvars(4))-&
                    ...
                    param_float(21 + 5))*((q(1-4+2,j+1,indvars(4))-&
                    0.5_wp*(q(1-4+2,j+1,indvars(2))*q(1-4+2,j+1,indvars(2))+&
                    q(1-4+2,j+1,indvars(3))*q(1-4+2,j+1,indvars(3)))))/param_float(4 + 5)**1.5*q(1-4+2,j+1,indvars(1))))*param_float(1 + 5)*(qst(1-4+2,j+1,indvarsst(11))*(d2_dif_rhou_dydy_0_0_1m4p2jp1k)+&
...
d1_dif_rhov_dx_0_1m4p2m1jk = -((1+&
                    ...
                    param_float(21 + 5))*((q(1-4+2-1,j,indvars(4))-&
                    0.5_wp*(q(1-4+2-1,j,indvars(2))*q(1-4+2-1,j,indvars(2))+&
                    q(1-4+2-1,j,indvars(3))*q(1-4+2-1,j,indvars(3)))))/param_float(4 + 5)**1.5*q(1-4+2-1,j,indvars(1))))*param_float(1 + 5)*(qst(1-4+2-1,j,indvarsst(11))*(d2_dif_rhov_dxdy_0_0_1m4p2m1jk)+&
                    qst(1-4+2-1,j,indvarsst(10))*(d2_dif_rhov_dxdx_0_0_1m4p2m1jk))

d1_dif_rhov_dx_0_1m4p2p1jk = -((1+&
                    param_float(21 + 5))/(((q(1-4+2+1,j,indvars(4))-&
                    0.5_wp*(q(1-4+2+1,j,indvars(2))*q(1-4+2+1,j,indvars(2))+&
                    q(1-4+2+1,j,indvars(3))*q(1-4+2+1,j,indvars(3)))))/param_float(4 + 5)+&
                    param_float(21 + 5))*((q(1-4+2+1,j,indvars(4))-&
                    ...
                    param_float(21 + 5))*((q(1-4+2+1,j,indvars(4))-&
                    0.5_wp*(q(1-4+2+1,j,indvars(2))*q(1-4+2+1,j,indvars(2))+&
                    q(1-4+2+1,j,indvars(3))*q(1-4+2+1,j,indvars(3)))))/param_float(4 + 5)**1.5*q(1-4+2+1,j,indvars(1))))*param_float(1 + 5)*(qst(1-4+2+1,j,indvarsst(11))*(d2_dif_rhov_dxdy_0_0_1m4p2p1jk)+&
...
d1_dif_rhov_dy_0_1m4p2jm1k = -((1+&
                    ...
                    param_float(21 + 5))*((q(1-4+2,j-1,indvars(4))-&
                    0.5_wp*(q(1-4+2,j-1,indvars(2))*q(1-4+2,j-1,indvars(2))+&
                    q(1-4+2,j-1,indvars(3))*q(1-4+2,j-1,indvars(3)))))/param_float(4 + 5)**1.5*q(1-4+2,j-1,indvars(1))))*param_float(1 + 5)*(2.0_wp*qst(1-4+2,j-1,indvarsst(11))*(d2_dif_rhov_dydy_0_0_1m4p2jm1k)-&
...
d1_dif_rhov_dy_0_1m4p2jp1k = -((1+&
                    ...
                    param_float(21 + 5))*((q(1-4+2,j+1,indvars(4))-&
                    0.5_wp*(q(1-4+2,j+1,indvars(2))*q(1-4+2,j+1,indvars(2))+&
                    q(1-4+2,j+1,indvars(3))*q(1-4+2,j+1,indvars(3)))))/param_float(4 + 5)**1.5*q(1-4+2,j+1,indvars(1))))*param_float(1 + 5)*(2.0_wp*qst(1-4+2,j+1,indvarsst(11))*(d2_dif_rhov_dydy_0_0_1m4p2jp1k)-&
...
rhs(1-4+2,j,indvars(5)) = rhs(1-4+2,j,indvars(5))  -  ( -param_float(1 + 5)*param_float(7 + 5)*param_float(18 + 5)*((qst(1-4+2,j,indvarsst(10)))**2*(d1_dif_nut_dx_0_1m4p2jk)*(d1_dif_nut_dx_1_1m4p2jk)+&
                    ...
                    param_float(17 + 5)*(q(1-4+2,j,indvars(5))/(1+&
                    ...
                    param_float(21 + 5))*((q(1-4+2,j,indvars(4))-&
                    0.5_wp*(q(1-4+2,j,indvars(2))*q(1-4+2,j,indvars(2))+&
                    q(1-4+2,j,indvars(3))*q(1-4+2,j,indvars(3)))))/param_float(4 + 5)**1.5*q(1-4+2,j,indvars(1)))**2)))*qst(1-4+2,j,indvarsst(12))*q(1-4+2,j,indvars(1))*q(1-4+2,j,indvars(5))+&
                    param_float(1 + 5)*(param_float(10 + 5)*(((q(1-4+2,j,indvars(5))/(qst(1-4+2,j,indvarsst(12))*param_float(9 + 5)**2*qst(1-4+2,j,indvarsst(2))**2))+&
                    param_float(11 + 5)*((q(1-4+2,j,indvars(5))/(qst(1-4+2,j,indvarsst(12))*param_float(9 + 5)**2*qst(1-4+2,j,indvarsst(2))**2))**6-&
                    (q(1-4+2,j,indvars(5))/(qst(1-4+2,j,indvarsst(12))*param_float(9 + 5)**2*qst(1-4+2,j,indvarsst(2))**2))))*(1+&
                    param_float(12 + 5)**6)/(((q(1-4+2,j,indvars(5))/(qst(1-4+2,j,indvarsst(12))*param_float(9 + 5)**2*qst(1-4+2,j,indvarsst(2))**2))+&
                    param_float(11 + 5)*((q(1-4+2,j,indvars(5))/(qst(1-4+2,j,indvarsst(12))*param_float(9 + 5)**2*qst(1-4+2,j,indvarsst(2))**2))**6-&
                    (q(1-4+2,j,indvars(5))/(qst(1-4+2,j,indvarsst(12))*param_float(9 + 5)**2*qst(1-4+2,j,indvarsst(2))**2))))**6+&
                    param_float(12 + 5)**6))-&
                    ...
                    param_float(21 + 5))*((q(1-4+2,j,indvars(4))-&
                    0.5_wp*(q(1-4+2,j,indvars(2))*q(1-4+2,j,indvars(2))+&
                    q(1-4+2,j,indvars(3))*q(1-4+2,j,indvars(3)))))/param_float(4 + 5)**1.5*q(1-4+2,j,indvars(1)))**2)))*q(1-4+2,j,indvars(1))*q(1-4+2,j,indvars(5))**2/qst(1-4+2,j,indvarsst(2))**2 ) 
