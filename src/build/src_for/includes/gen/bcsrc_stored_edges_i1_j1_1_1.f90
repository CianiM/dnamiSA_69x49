...
qst(1-2+1,1-2+1,indvarsst(4)) =  ((dabs(0.5_wp*(qst(1-2+1,1-2+1,indvarsst(11))*(d1_stemp_dy_0_1m2p11m2p1k)-&
...
qst(1-2+1,1-2+1,indvarsst(12)) =  (qst(1-2+1,1-2+1,indvarsst(4))+&
                    (1.0_wp-&
                    (q(1-2+1,1-2+1,indvars(5))/1.0_wp)/(1.0_wp+&
                    (q(1-2+1,1-2+1,indvars(5))/1.0_wp)*((q(1-2+1,1-2+1,indvars(5))/1.0_wp)**3.0_wp/((q(1-2+1,1-2+1,indvars(5))/1.0_wp)**3.0_wp+&
...
qst(1-2+1,1-2+1,indvarsst(13)) =  (max(qst(1-2+1,1-2+1,indvarsst(12)),0.3*qst(1-2+1,1-2+1,indvarsst(4))))
...
qst(1-2+1,1-2+1,indvarsst(14)) =  (min(param_float(1 + 5)*(q(1-2+1,1-2+1,indvars(5))/(qst(1-2+1,1-2+1,indvarsst(13))*param_float(9 + 5)**2.0_wp*qst(1-2+1,1-2+1,indvarsst(2))**2.0_wp)),10.0_wp))
...
qst(1-2+1,1-2+1,indvarsst(15)) =  (qst(1-2+1,1-2+1,indvarsst(14))+&
                    param_float(11 + 5)*(qst(1-2+1,1-2+1,indvarsst(14))**6.0_wp-&
                    qst(1-2+1,1-2+1,indvarsst(14))))
...
qst(1-2+1,1-2+1,indvarsst(16)) =  (qst(1-2+1,1-2+1,indvarsst(15))*((1.0_wp+&
                    param_float(12 + 5)**6.0_wp)/(qst(1-2+1,1-2+1,indvarsst(15))**6.0_wp+&
...
qst(1-2+1,1-2+1,indvarsst(17)) =  ((1.0_wp)*(1.0_wp+&
                    ((q(1-2+1,1-2+1,indvars(5))/1.0_wp)**3.0_wp/((q(1-2+1,1-2+1,indvars(5))/1.0_wp)**3.0_wp+&
                    param_float(13 + 5)**3.0_wp))*(q(1-2+1,1-2+1,indvars(5))/1.0_wp))*param_float(1 + 5)*(d1_stemp_dy_0_1m2p11m2p1k)*qst(1-2+1,1-2+1,indvarsst(11)))
...
qst(1-2+1,1-2+1,indvarsst(18)) =  q(1-2+1,1-2+1,indvars(5))*q(1-2+1,1-2+1,indvars(1))
...
qst(1-2+1,1-2+1,indvarsst(19)) =  q(1-2+1,1-2+1,indvars(5))*q(1-2+1,1-2+1,indvars(1))*((q(1-2+1,1-2+1,indvars(5))/1.0_wp)**3.0_wp/((q(1-2+1,1-2+1,indvars(5))/1.0_wp)**3.0_wp+&
...
qst(1-2+1,1-2+1,indvarsst(20)) =  (param_float(3 + 5))*q(1-2+1,1-2+1,indvars(1))*((q(1-2+1,1-2+1,indvars(4))-&
...
qst(1-2+1,1-2+1,indvarsst(21)) =  q(1-2+1,1-2+1,indvars(5))/1.0_wp*q(1-2+1,1-2+1,indvars(1))
...
qst(1-2+1,1-2+1,indvarsst(22)) =  param_float(6 + 5)*(1.0_wp-&
