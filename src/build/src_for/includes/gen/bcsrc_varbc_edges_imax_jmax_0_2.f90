...
subroutine boundarySchemevarbc_edges_imax_jmax_0_2(param_float,hlo,ind,idarray,neq,neqst,nx,ny,nz,sizeblck,q,qst,rhs,nvar_f,nvar_e,qface_i,qface_j,qface_k,qedge_ij,qedge_jk,qedge_ik)
...
!***********************************************************
!                                                           
! building source terms in RHS for layer 0 2 None M_imax ***
!                                                           
!***********************************************************
...
!***********************************************************
!                                                           
! Update BC terms for layer 0 2 None M_imax ****************
!                                                           
!***********************************************************


qface_i(ny+4-2,2) =  (q(nx+4+0,ny+4-2,indvars(2))/(param_float(23 + 5)*(param_float(3 + 5))*q(nx+4+0,ny+4-2,indvars(1))*((q(nx+4+0,ny+4-2,indvars(4))-&
...
!$OMP END DO
 ...
 end subroutine boundarySchemevarbc_edges_imax_jmax_0_2
