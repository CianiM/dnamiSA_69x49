...
subroutine boundaryScheme_edges_PhyBC_Low_surf_q_j1_imax_0_2(param_float,hlo,ind,idarray,neq,neqst,nx,ny,nz,sizeblck,q,qst,rhs,nvar_f,nvar_e,qface_i,qface_j,qface_k,qedge_ij,qedge_jk,qedge_ik)
...
q(nx+4-2,1-4+0,indvars(2)) =  qst(nx+4-2,1-4+0,indvarsst(5))*q(nx+4-2,1-4+0,indvars(2))
...
q(nx+4-2,1-4+0,indvars(3)) =  0.0_wp
...
q(nx+4-2,1-4+0,indvars(5)) =  qst(nx+4-2,1-4+0,indvarsst(5))*q(nx+4-2,1-4+0,indvars(5))
...
!$OMP END DO
 ...
 end subroutine boundaryScheme_edges_PhyBC_Low_surf_q_j1_imax_0_2
