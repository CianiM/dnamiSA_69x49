...
d1_dif_nut_dx_0_1m2p1m1jk = -(param_float(1 + 5)*(1.0_wp+&
                    (q(1-2+1-1,j,indvars(5))/1.0_wp))*param_float(18 + 5)*qst(1-2+1-1,j,indvarsst(10))*(d2_dif_nut_dxdx_0_0_1m2p1m1jk))

d1_dif_nut_dx_0_1m2p1p1jk = -(param_float(1 + 5)*(1.0_wp+&
                    (q(1-2+1+1,j,indvars(5))/1.0_wp))*param_float(18 + 5)*qst(1-2+1+1,j,indvarsst(10))*(d2_dif_nut_dxdx_0_0_1m2p1p1jk))
...
d1_dif_nut_dy_0_1m2p1jm1k = -(param_float(1 + 5)*(1.0_wp+&
                    (q(1-2+1,j-1,indvars(5))/1.0_wp))*param_float(18 + 5)*qst(1-2+1,j-1,indvarsst(11))*(d2_dif_nut_dydy_0_0_1m2p1jm1k))

d1_dif_nut_dy_0_1m2p1jp1k = -(param_float(1 + 5)*(1.0_wp+&
                    (q(1-2+1,j+1,indvars(5))/1.0_wp))*param_float(18 + 5)*qst(1-2+1,j+1,indvarsst(11))*(d2_dif_nut_dydy_0_0_1m2p1jp1k))
