...
! LOCAL VARIABLES
 ...
 real(wp) ::  d1_rhs_rho_dx_0_1m2p1m1nyp2p0k,d1_rhs_rho_dx_0_1m2p1p0nyp2p0k,d1_rhs_rho_dx_0_1m2p1p1nyp2p0k &
            ...
            ,d2_rhs_nut_dxdx_0_0_1m2p1m1nyp2p0k_1m2p1m1p0nyp2p0k,d2_rhs_nut_dxdx_0_0_1m2p1m1nyp2p0k_1m2p1m1p1nyp2p0k,d2_rhs_nut_dxdx_0_0_1m2p1m1nyp2p0k_1m2p1m1p2nyp2p0k &
            ,d2_rhs_nut_dxdx_0_0_1m2p1m1nyp2p0k &
            ,d2_rhs_nut_dxdx_0_0_1m2p1p1nyp2p0k_1m2p1p1m1nyp2p0k,d2_rhs_nut_dxdx_0_0_1m2p1p1nyp2p0k_1m2p1p1p0nyp2p0k,d2_rhs_nut_dxdx_0_0_1m2p1p1nyp2p0k_1m2p1p1p1nyp2p0k &
            ,d2_rhs_nut_dxdx_0_0_1m2p1p1nyp2p0k &
            ,d1_rhs_nut_dx_1_1m2p1m1nyp2p0k,d1_rhs_nut_dx_1_1m2p1p0nyp2p0k,d1_rhs_nut_dx_1_1m2p1p1nyp2p0k &
            ,d1_rhs_nut_dx_1_1m2p1nyp2p0k &
            ,d1_rhs_nut_dx_2_1m2p1m1nyp2p0k,d1_rhs_nut_dx_2_1m2p1p0nyp2p0k,d1_rhs_nut_dx_2_1m2p1p1nyp2p0k &
            ,d1_rhs_nut_dx_2_1m2p1nyp2p0k &
            ,d1_rhs_nut_dx_0_1m2p1m1nyp2p0k,d1_rhs_nut_dx_0_1m2p1p0nyp2p0k,d1_rhs_nut_dx_0_1m2p1p1nyp2p0k &
            ,d1_rhs_nut_dx_0_1m2p1nyp2p0k 
...
d1_rhs_rhou_dx_0_1m2p1m1nyp2p0k = -(1.0_wp)*(1.0_wp+&
                    ...
                    param_float(13 + 5)**3.0_wp))*(q(1-2+1-1,ny+2+0,indvars(5))/1.0_wp*q(1-2+1-1,ny+2+0,indvars(1))))*param_float(1 + 5)*(2.0_wp*qst(1-2+1-1,ny+2+0,indvarsst(10))*(d2_rhs_rhou_dxdx_0_0_1m2p1m1nyp2p0k)-&
...
d1_rhs_rhou_dx_0_1m2p1p1nyp2p0k = -(1.0_wp)*(1.0_wp+&
                    ((q(1-2+1+1,ny+2+0,indvars(5))/1.0_wp*q(1-2+1+1,ny+2+0,indvars(1)))**3.0_wp/((q(1-2+1+1,ny+2+0,indvars(5))/1.0_wp*q(1-2+1+1,ny+2+0,indvars(1)))**3.0_wp+&
                    param_float(13 + 5)**3.0_wp))*(q(1-2+1+1,ny+2+0,indvars(5))/1.0_wp*q(1-2+1+1,ny+2+0,indvars(1))))*param_float(1 + 5)*(2.0_wp*qst(1-2+1+1,ny+2+0,indvarsst(10))*(d2_rhs_rhou_dxdx_0_0_1m2p1p1nyp2p0k)-&
...
d1_rhs_rhou_dy_7_1m2p1nyp2p0p0k = -(1.0_wp)*(1.0_wp+&
                    ...
                    param_float(13 + 5)**3.0_wp))*(q(1-2+1,ny+2+0+0,indvars(5))/1.0_wp*q(1-2+1,ny+2+0+0,indvars(1))))*param_float(1 + 5)*(qst(1-2+1,ny+2+0+0,indvarsst(11))*(d2_rhs_rhou_dydy_7_0_1m2p1nyp2p0p0k)+&
...
d1_rhs_rhou_dy_7_1m2p1nyp2p0m1k = -(1.0_wp)*(1.0_wp+&
                    ...
                    param_float(13 + 5)**3.0_wp))*(q(1-2+1,ny+2+0-1,indvars(5))/1.0_wp*q(1-2+1,ny+2+0-1,indvars(1))))*param_float(1 + 5)*(qst(1-2+1,ny+2+0-1,indvarsst(11))*(d2_rhs_rhou_dydy_7_0_1m2p1nyp2p0m1k)+&
...
d1_rhs_rhou_dy_7_1m2p1nyp2p0m2k = -(1.0_wp)*(1.0_wp+&
                    ...
                    param_float(13 + 5)**3.0_wp))*(q(1-2+1,ny+2+0-2,indvars(5))/1.0_wp*q(1-2+1,ny+2+0-2,indvars(1))))*param_float(1 + 5)*(qst(1-2+1,ny+2+0-2,indvarsst(11))*(d2_rhs_rhou_dydy_7_0_1m2p1nyp2p0m2k)+&
...
d1_rhs_rhov_dx_0_1m2p1m1nyp2p0k = -(1.0_wp)*(1.0_wp+&
                    ((q(1-2+1-1,ny+2+0,indvars(5))/1.0_wp*q(1-2+1-1,ny+2+0,indvars(1)))**3.0_wp/((q(1-2+1-1,ny+2+0,indvars(5))/1.0_wp*q(1-2+1-1,ny+2+0,indvars(1)))**3.0_wp+&
                    param_float(13 + 5)**3.0_wp))*(q(1-2+1-1,ny+2+0,indvars(5))/1.0_wp*q(1-2+1-1,ny+2+0,indvars(1))))*param_float(1 + 5)*(qst(1-2+1-1,ny+2+0,indvarsst(11))*(d2_rhs_rhov_dxdy_0_0_1m2p1m1nyp2p0k)+&
                    qst(1-2+1-1,ny+2+0,indvarsst(10))*(d2_rhs_rhov_dxdx_0_0_1m2p1m1nyp2p0k))

d1_rhs_rhov_dx_0_1m2p1p1nyp2p0k = -(1.0_wp)*(1.0_wp+&
                    ((q(1-2+1+1,ny+2+0,indvars(5))/1.0_wp*q(1-2+1+1,ny+2+0,indvars(1)))**3.0_wp/((q(1-2+1+1,ny+2+0,indvars(5))/1.0_wp*q(1-2+1+1,ny+2+0,indvars(1)))**3.0_wp+&
                    param_float(13 + 5)**3.0_wp))*(q(1-2+1+1,ny+2+0,indvars(5))/1.0_wp*q(1-2+1+1,ny+2+0,indvars(1))))*param_float(1 + 5)*(qst(1-2+1+1,ny+2+0,indvarsst(11))*(d2_rhs_rhov_dxdy_0_0_1m2p1p1nyp2p0k)+&
...
d1_rhs_rhov_dy_6_1m2p1nyp2p0p0k = -(1.0_wp)*(1.0_wp+&
                    ((q(1-2+1,ny+2+0+0,indvars(5))/1.0_wp*q(1-2+1,ny+2+0+0,indvars(1)))**3.0_wp/((q(1-2+1,ny+2+0+0,indvars(5))/1.0_wp*q(1-2+1,ny+2+0+0,indvars(1)))**3.0_wp+&
                    param_float(13 + 5)**3.0_wp))*(q(1-2+1,ny+2+0+0,indvars(5))/1.0_wp*q(1-2+1,ny+2+0+0,indvars(1))))*param_float(1 + 5)*(2.0_wp*qst(1-2+1,ny+2+0+0,indvarsst(11))*(d2_rhs_rhov_dydy_6_0_1m2p1nyp2p0p0k)-&
...
d1_rhs_rhov_dy_6_1m2p1nyp2p0m1k = -(1.0_wp)*(1.0_wp+&
                    ((q(1-2+1,ny+2+0-1,indvars(5))/1.0_wp*q(1-2+1,ny+2+0-1,indvars(1)))**3.0_wp/((q(1-2+1,ny+2+0-1,indvars(5))/1.0_wp*q(1-2+1,ny+2+0-1,indvars(1)))**3.0_wp+&
                    param_float(13 + 5)**3.0_wp))*(q(1-2+1,ny+2+0-1,indvars(5))/1.0_wp*q(1-2+1,ny+2+0-1,indvars(1))))*param_float(1 + 5)*(2.0_wp*qst(1-2+1,ny+2+0-1,indvarsst(11))*(d2_rhs_rhov_dydy_6_0_1m2p1nyp2p0m1k)-&
...
d1_rhs_rhov_dy_6_1m2p1nyp2p0m2k = -(1.0_wp)*(1.0_wp+&
                    ((q(1-2+1,ny+2+0-2,indvars(5))/1.0_wp*q(1-2+1,ny+2+0-2,indvars(1)))**3.0_wp/((q(1-2+1,ny+2+0-2,indvars(5))/1.0_wp*q(1-2+1,ny+2+0-2,indvars(1)))**3.0_wp+&
                    param_float(13 + 5)**3.0_wp))*(q(1-2+1,ny+2+0-2,indvars(5))/1.0_wp*q(1-2+1,ny+2+0-2,indvars(1))))*param_float(1 + 5)*(2.0_wp*qst(1-2+1,ny+2+0-2,indvarsst(11))*(d2_rhs_rhov_dydy_6_0_1m2p1nyp2p0m2k)-&
...
d2_rhs_nut_dxdx_0_0_1m2p1m1nyp2p0k_1m2p1m1p0nyp2p0k = q(1-2+1-1+0,ny+2+0,indvars(5))

d2_rhs_nut_dxdx_0_0_1m2p1m1nyp2p0k_1m2p1m1p1nyp2p0k = q(1-2+1-1+1,ny+2+0,indvars(5))

d2_rhs_nut_dxdx_0_0_1m2p1m1nyp2p0k_1m2p1m1p2nyp2p0k = q(1-2+1-1+2,ny+2+0,indvars(5))

d2_rhs_nut_dxdx_0_0_1m2p1m1nyp2p0k = -&
          1.5_wp*d2_rhs_nut_dxdx_0_0_1m2p1m1nyp2p0k_1m2p1m1p0nyp2p0k+&
          2.0_wp*d2_rhs_nut_dxdx_0_0_1m2p1m1nyp2p0k_1m2p1m1p1nyp2p0k-&
          0.5_wp*d2_rhs_nut_dxdx_0_0_1m2p1m1nyp2p0k_1m2p1m1p2nyp2p0k

d2_rhs_nut_dxdx_0_0_1m2p1m1nyp2p0k = d2_rhs_nut_dxdx_0_0_1m2p1m1nyp2p0k*param_float(1)

d2_rhs_nut_dxdx_0_0_1m2p1p1nyp2p0k_1m2p1p1m1nyp2p0k = q(1-2+1+1-1,ny+2+0,indvars(5))

d2_rhs_nut_dxdx_0_0_1m2p1p1nyp2p0k_1m2p1p1p1nyp2p0k = q(1-2+1+1+1,ny+2+0,indvars(5))

d2_rhs_nut_dxdx_0_0_1m2p1p1nyp2p0k = -&
          0.5_wp*d2_rhs_nut_dxdx_0_0_1m2p1p1nyp2p0k_1m2p1p1m1nyp2p0k+&
          0.5_wp*d2_rhs_nut_dxdx_0_0_1m2p1p1nyp2p0k_1m2p1p1p1nyp2p0k

d2_rhs_nut_dxdx_0_0_1m2p1p1nyp2p0k = d2_rhs_nut_dxdx_0_0_1m2p1p1nyp2p0k*param_float(1)

d1_rhs_nut_dx_1_1m2p1m1nyp2p0k = q(1-2+1-1,ny+2+0,indvars(1))*q(1-2+1-1,ny+2+0,indvars(5))

d1_rhs_nut_dx_1_1m2p1p1nyp2p0k = q(1-2+1+1,ny+2+0,indvars(1))*q(1-2+1+1,ny+2+0,indvars(5))

d1_rhs_nut_dx_1_1m2p1nyp2p0k = -&
          0.5_wp*d1_rhs_nut_dx_1_1m2p1m1nyp2p0k+&
          0.5_wp*d1_rhs_nut_dx_1_1m2p1p1nyp2p0k

d1_rhs_nut_dx_1_1m2p1nyp2p0k = d1_rhs_nut_dx_1_1m2p1nyp2p0k*param_float(1)

d1_rhs_nut_dx_2_1m2p1m1nyp2p0k = q(1-2+1-1,ny+2+0,indvars(5))

d1_rhs_nut_dx_2_1m2p1p1nyp2p0k = q(1-2+1+1,ny+2+0,indvars(5))

d1_rhs_nut_dx_2_1m2p1nyp2p0k = -&
          0.5_wp*d1_rhs_nut_dx_2_1m2p1m1nyp2p0k+&
          0.5_wp*d1_rhs_nut_dx_2_1m2p1p1nyp2p0k

d1_rhs_nut_dx_2_1m2p1nyp2p0k = d1_rhs_nut_dx_2_1m2p1nyp2p0k*param_float(1)

d1_rhs_nut_dx_0_1m2p1m1nyp2p0k = (q(1-2+1-1,ny+2+0,indvars(1))*q(1-2+1-1,ny+2+0,indvars(2))*q(1-2+1-1,ny+2+0,indvars(5))-&
                    param_float(1 + 5)*(1.0_wp+&
                    (q(1-2+1-1,ny+2+0,indvars(5))/1.0_wp*q(1-2+1-1,ny+2+0,indvars(1))))*param_float(18 + 5)*qst(1-2+1-1,ny+2+0,indvarsst(10))*(d2_rhs_nut_dxdx_0_0_1m2p1m1nyp2p0k))

d1_rhs_nut_dx_0_1m2p1p1nyp2p0k = (q(1-2+1+1,ny+2+0,indvars(1))*q(1-2+1+1,ny+2+0,indvars(2))*q(1-2+1+1,ny+2+0,indvars(5))-&
                    param_float(1 + 5)*(1.0_wp+&
                    (q(1-2+1+1,ny+2+0,indvars(5))/1.0_wp*q(1-2+1+1,ny+2+0,indvars(1))))*param_float(18 + 5)*qst(1-2+1+1,ny+2+0,indvarsst(10))*(d2_rhs_nut_dxdx_0_0_1m2p1p1nyp2p0k))

d1_rhs_nut_dx_0_1m2p1nyp2p0k = -&
          0.5_wp*d1_rhs_nut_dx_0_1m2p1m1nyp2p0k+&
          0.5_wp*d1_rhs_nut_dx_0_1m2p1p1nyp2p0k

d1_rhs_nut_dx_0_1m2p1nyp2p0k = d1_rhs_nut_dx_0_1m2p1nyp2p0k*param_float(1)
...
rhs(1-2+1,ny+2+0,indvars(5)) =   -  ( qst(1-2+1,ny+2+0,indvarsst(10))*(d1_rhs_nut_dx_0_1m2p1nyp2p0k)+&
                    -&
                    param_float(1 + 5)*param_float(7 + 5)*param_float(18 + 5)*((qst(1-2+1,ny+2+0,indvarsst(10)))**2*(d1_rhs_nut_dx_1_1m2p1nyp2p0k)*(d1_rhs_nut_dx_2_1m2p1nyp2p0k))-&
                    param_float(6 + 5)*(1-&
