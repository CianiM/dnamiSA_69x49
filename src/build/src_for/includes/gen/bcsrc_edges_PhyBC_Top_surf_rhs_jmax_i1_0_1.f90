...
! LOCAL VARIABLES
 ...
 real(wp) ::  d1_rhs_rho_dx_0_1m2p1m1nyp2p0k,d1_rhs_rho_dx_0_1m2p1p0nyp2p0k,d1_rhs_rho_dx_0_1m2p1p1nyp2p0k &
            ...
            ,d2_rhs_nut_dxdx_1_0_1m2p1m1nyp2p0k_1m2p1m1p0nyp2p0k,d2_rhs_nut_dxdx_1_0_1m2p1m1nyp2p0k_1m2p1m1p1nyp2p0k,d2_rhs_nut_dxdx_1_0_1m2p1m1nyp2p0k_1m2p1m1p2nyp2p0k &
            ,d2_rhs_nut_dxdx_1_0_1m2p1m1nyp2p0k &
            ,d2_rhs_nut_dxdx_1_0_1m2p1p1nyp2p0k_1m2p1p1m1nyp2p0k,d2_rhs_nut_dxdx_1_0_1m2p1p1nyp2p0k_1m2p1p1p0nyp2p0k,d2_rhs_nut_dxdx_1_0_1m2p1p1nyp2p0k_1m2p1p1p1nyp2p0k &
            ,d2_rhs_nut_dxdx_1_0_1m2p1p1nyp2p0k &
            ,d1_rhs_nut_dx_2_1m2p1m1nyp2p0k,d1_rhs_nut_dx_2_1m2p1p0nyp2p0k,d1_rhs_nut_dx_2_1m2p1p1nyp2p0k &
            ,d1_rhs_nut_dx_2_1m2p1nyp2p0k &
            ,d1_rhs_nut_dx_3_1m2p1m1nyp2p0k,d1_rhs_nut_dx_3_1m2p1p0nyp2p0k,d1_rhs_nut_dx_3_1m2p1p1nyp2p0k &
            ,d1_rhs_nut_dx_3_1m2p1nyp2p0k &
...
d2_rhs_nut_dxdx_1_0_1m2p1m1nyp2p0k_1m2p1m1p0nyp2p0k = q(1-2+1-1+0,ny+2+0,indvars(5))

d2_rhs_nut_dxdx_1_0_1m2p1m1nyp2p0k_1m2p1m1p1nyp2p0k = q(1-2+1-1+1,ny+2+0,indvars(5))

d2_rhs_nut_dxdx_1_0_1m2p1m1nyp2p0k_1m2p1m1p2nyp2p0k = q(1-2+1-1+2,ny+2+0,indvars(5))

d2_rhs_nut_dxdx_1_0_1m2p1m1nyp2p0k = -&
          1.5_wp*d2_rhs_nut_dxdx_1_0_1m2p1m1nyp2p0k_1m2p1m1p0nyp2p0k+&
          2.0_wp*d2_rhs_nut_dxdx_1_0_1m2p1m1nyp2p0k_1m2p1m1p1nyp2p0k-&
          0.5_wp*d2_rhs_nut_dxdx_1_0_1m2p1m1nyp2p0k_1m2p1m1p2nyp2p0k

d2_rhs_nut_dxdx_1_0_1m2p1m1nyp2p0k = d2_rhs_nut_dxdx_1_0_1m2p1m1nyp2p0k*param_float(1)

d2_rhs_nut_dxdx_1_0_1m2p1p1nyp2p0k_1m2p1p1m1nyp2p0k = q(1-2+1+1-1,ny+2+0,indvars(5))

d2_rhs_nut_dxdx_1_0_1m2p1p1nyp2p0k_1m2p1p1p1nyp2p0k = q(1-2+1+1+1,ny+2+0,indvars(5))

d2_rhs_nut_dxdx_1_0_1m2p1p1nyp2p0k = -&
          0.5_wp*d2_rhs_nut_dxdx_1_0_1m2p1p1nyp2p0k_1m2p1p1m1nyp2p0k+&
          0.5_wp*d2_rhs_nut_dxdx_1_0_1m2p1p1nyp2p0k_1m2p1p1p1nyp2p0k

d2_rhs_nut_dxdx_1_0_1m2p1p1nyp2p0k = d2_rhs_nut_dxdx_1_0_1m2p1p1nyp2p0k*param_float(1)

d1_rhs_nut_dx_2_1m2p1m1nyp2p0k = q(1-2+1-1,ny+2+0,indvars(1))*q(1-2+1-1,ny+2+0,indvars(5))

d1_rhs_nut_dx_2_1m2p1p1nyp2p0k = q(1-2+1+1,ny+2+0,indvars(1))*q(1-2+1+1,ny+2+0,indvars(5))
...
d1_rhs_nut_dx_3_1m2p1m1nyp2p0k = q(1-2+1-1,ny+2+0,indvars(5))

d1_rhs_nut_dx_3_1m2p1p1nyp2p0k = q(1-2+1+1,ny+2+0,indvars(5))

d1_rhs_nut_dx_3_1m2p1nyp2p0k = -&
          0.5_wp*d1_rhs_nut_dx_3_1m2p1m1nyp2p0k+&
          0.5_wp*d1_rhs_nut_dx_3_1m2p1p1nyp2p0k

d1_rhs_nut_dx_3_1m2p1nyp2p0k = d1_rhs_nut_dx_3_1m2p1nyp2p0k*param_float(1)

d1_rhs_nut_dx_1_1m2p1m1nyp2p0k = (param_float(1 + 5)*(1.0_wp+&
                    (q(1-2+1-1,ny+2+0,indvars(5))/1.0_wp))*param_float(18 + 5)*qst(1-2+1-1,ny+2+0,indvarsst(10))*(d2_rhs_nut_dxdx_1_0_1m2p1m1nyp2p0k))

d1_rhs_nut_dx_1_1m2p1p1nyp2p0k = (param_float(1 + 5)*(1.0_wp+&
                    (q(1-2+1+1,ny+2+0,indvars(5))/1.0_wp))*param_float(18 + 5)*qst(1-2+1+1,ny+2+0,indvarsst(10))*(d2_rhs_nut_dxdx_1_0_1m2p1p1nyp2p0k))
...
rhs(1-2+1,ny+2+0,indvars(5)) =   -  ( qst(1-2+1,ny+2+0,indvarsst(10))*(d1_rhs_nut_dx_0_1m2p1nyp2p0k)+&
                    -&
                    qst(1-2+1,ny+2+0,indvarsst(10))*(d1_rhs_nut_dx_1_1m2p1nyp2p0k)-&
                    param_float(1 + 5)*param_float(7 + 5)*param_float(18 + 5)*((qst(1-2+1,ny+2+0,indvarsst(10)))**2*(d1_rhs_nut_dx_2_1m2p1nyp2p0k)*(d1_rhs_nut_dx_3_1m2p1nyp2p0k))-&
                    param_float(6 + 5)*(1-&
