...
subroutine boundarySchemevarbc_faces_imax(param_float,hlo,ind,idarray,neq,neqst,nx,ny,nz,sizeblck,q,qst,rhs,nvar_f,nvar_e,qface_i,qface_j,qface_k,qedge_ij,qedge_jk,qedge_ik)
...
qface_i(j,2) =  (q(nx+2+0,j,indvars(2))/(param_float(23 + 5)*(param_float(3 + 5))*q(nx+2+0,j,indvars(1))*((q(nx+2+0,j,indvars(4))-&
...
!$OMP END DO
 ...
 end subroutine boundarySchemevarbc_faces_imax
