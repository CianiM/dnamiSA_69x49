...
subroutine boundaryScheme_edges_PhyBC_Inlet_surf_q_i1_j1_0_2(param_float,hlo,ind,idarray,neq,neqst,nx,ny,nz,sizeblck,q,qst,rhs,nvar_f,nvar_e,qface_i,qface_j,qface_k,qedge_ij,qedge_jk,qedge_ik)
...
q(1-4+0,1-4+2,indvars(1)) =  param_float(24 + 5)
...
q(1-4+0,1-4+2,indvars(2)) =  param_float(5 + 5)
...
q(1-4+0,1-4+2,indvars(3)) =  0.0_wp
...
q(1-4+0,1-4+2,indvars(4)) =  param_float(25 + 5)*param_float(4 + 5)+&
...
q(1-4+0,1-4+2,indvars(5)) =  param_float(27 + 5)
...
!$OMP END DO
 ...
 end subroutine boundaryScheme_edges_PhyBC_Inlet_surf_q_i1_j1_0_2
