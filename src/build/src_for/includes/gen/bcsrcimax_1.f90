...
d1_dif_rhou_dx_0_nxp2m1m1jk = -(1.0_wp)*(1.0_wp+&
                    ((q(nx+2-1-1,j,indvars(5))/1.0_wp*q(nx+2-1-1,j,indvars(1)))**3.0_wp/((q(nx+2-1-1,j,indvars(5))/1.0_wp*q(nx+2-1-1,j,indvars(1)))**3.0_wp+&
                    param_float(13 + 5)**3.0_wp))*(q(nx+2-1-1,j,indvars(5))/1.0_wp*q(nx+2-1-1,j,indvars(1))))*param_float(1 + 5)*(2.0_wp*qst(nx+2-1-1,j,indvarsst(10))*(d2_dif_rhou_dxdx_0_0_nxp2m1m1jk)-&
...
d1_dif_rhou_dx_0_nxp2m1p1jk = -(1.0_wp)*(1.0_wp+&
                    ((q(nx+2-1+1,j,indvars(5))/1.0_wp*q(nx+2-1+1,j,indvars(1)))**3.0_wp/((q(nx+2-1+1,j,indvars(5))/1.0_wp*q(nx+2-1+1,j,indvars(1)))**3.0_wp+&
                    param_float(13 + 5)**3.0_wp))*(q(nx+2-1+1,j,indvars(5))/1.0_wp*q(nx+2-1+1,j,indvars(1))))*param_float(1 + 5)*(2.0_wp*qst(nx+2-1+1,j,indvarsst(10))*(d2_dif_rhou_dxdx_0_0_nxp2m1p1jk)-&
...
d1_dif_rhou_dy_0_nxp2m1jm1k = -(1.0_wp)*(1.0_wp+&
                    ((q(nx+2-1,j-1,indvars(5))/1.0_wp*q(nx+2-1,j-1,indvars(1)))**3.0_wp/((q(nx+2-1,j-1,indvars(5))/1.0_wp*q(nx+2-1,j-1,indvars(1)))**3.0_wp+&
                    param_float(13 + 5)**3.0_wp))*(q(nx+2-1,j-1,indvars(5))/1.0_wp*q(nx+2-1,j-1,indvars(1))))*param_float(1 + 5)*(qst(nx+2-1,j-1,indvarsst(11))*(d2_dif_rhou_dydy_0_0_nxp2m1jm1k)+&
                    qst(nx+2-1,j-1,indvarsst(10))*(d2_dif_rhou_dydx_0_0_nxp2m1jm1k))

d1_dif_rhou_dy_0_nxp2m1jp1k = -(1.0_wp)*(1.0_wp+&
                    ((q(nx+2-1,j+1,indvars(5))/1.0_wp*q(nx+2-1,j+1,indvars(1)))**3.0_wp/((q(nx+2-1,j+1,indvars(5))/1.0_wp*q(nx+2-1,j+1,indvars(1)))**3.0_wp+&
                    param_float(13 + 5)**3.0_wp))*(q(nx+2-1,j+1,indvars(5))/1.0_wp*q(nx+2-1,j+1,indvars(1))))*param_float(1 + 5)*(qst(nx+2-1,j+1,indvarsst(11))*(d2_dif_rhou_dydy_0_0_nxp2m1jp1k)+&
...
d1_dif_rhov_dx_0_nxp2m1m1jk = -(1.0_wp)*(1.0_wp+&
                    ((q(nx+2-1-1,j,indvars(5))/1.0_wp*q(nx+2-1-1,j,indvars(1)))**3.0_wp/((q(nx+2-1-1,j,indvars(5))/1.0_wp*q(nx+2-1-1,j,indvars(1)))**3.0_wp+&
                    param_float(13 + 5)**3.0_wp))*(q(nx+2-1-1,j,indvars(5))/1.0_wp*q(nx+2-1-1,j,indvars(1))))*param_float(1 + 5)*(qst(nx+2-1-1,j,indvarsst(11))*(d2_dif_rhov_dxdy_0_0_nxp2m1m1jk)+&
                    qst(nx+2-1-1,j,indvarsst(10))*(d2_dif_rhov_dxdx_0_0_nxp2m1m1jk))

d1_dif_rhov_dx_0_nxp2m1p1jk = -(1.0_wp)*(1.0_wp+&
                    ((q(nx+2-1+1,j,indvars(5))/1.0_wp*q(nx+2-1+1,j,indvars(1)))**3.0_wp/((q(nx+2-1+1,j,indvars(5))/1.0_wp*q(nx+2-1+1,j,indvars(1)))**3.0_wp+&
                    param_float(13 + 5)**3.0_wp))*(q(nx+2-1+1,j,indvars(5))/1.0_wp*q(nx+2-1+1,j,indvars(1))))*param_float(1 + 5)*(qst(nx+2-1+1,j,indvarsst(11))*(d2_dif_rhov_dxdy_0_0_nxp2m1p1jk)+&
...
d1_dif_rhov_dy_0_nxp2m1jm1k = -(1.0_wp)*(1.0_wp+&
                    ((q(nx+2-1,j-1,indvars(5))/1.0_wp*q(nx+2-1,j-1,indvars(1)))**3.0_wp/((q(nx+2-1,j-1,indvars(5))/1.0_wp*q(nx+2-1,j-1,indvars(1)))**3.0_wp+&
                    param_float(13 + 5)**3.0_wp))*(q(nx+2-1,j-1,indvars(5))/1.0_wp*q(nx+2-1,j-1,indvars(1))))*param_float(1 + 5)*(2.0_wp*qst(nx+2-1,j-1,indvarsst(11))*(d2_dif_rhov_dydy_0_0_nxp2m1jm1k)-&
...
d1_dif_rhov_dy_0_nxp2m1jp1k = -(1.0_wp)*(1.0_wp+&
                    ((q(nx+2-1,j+1,indvars(5))/1.0_wp*q(nx+2-1,j+1,indvars(1)))**3.0_wp/((q(nx+2-1,j+1,indvars(5))/1.0_wp*q(nx+2-1,j+1,indvars(1)))**3.0_wp+&
                    param_float(13 + 5)**3.0_wp))*(q(nx+2-1,j+1,indvars(5))/1.0_wp*q(nx+2-1,j+1,indvars(1))))*param_float(1 + 5)*(2.0_wp*qst(nx+2-1,j+1,indvarsst(11))*(d2_dif_rhov_dydy_0_0_nxp2m1jp1k)-&
...
d1_dif_nut_dx_0_nxp2m1m1jk = -param_float(1 + 5)*(1.0_wp+&
                    (q(nx+2-1-1,j,indvars(5))/1.0_wp*q(nx+2-1-1,j,indvars(1))))*param_float(18 + 5)*qst(nx+2-1-1,j,indvarsst(10))*(d2_dif_nut_dxdx_0_0_nxp2m1m1jk)

d1_dif_nut_dx_0_nxp2m1p1jk = -param_float(1 + 5)*(1.0_wp+&
                    (q(nx+2-1+1,j,indvars(5))/1.0_wp*q(nx+2-1+1,j,indvars(1))))*param_float(18 + 5)*qst(nx+2-1+1,j,indvarsst(10))*(d2_dif_nut_dxdx_0_0_nxp2m1p1jk)
...
d1_dif_nut_dy_0_nxp2m1jm1k = -param_float(1 + 5)*(1.0_wp+&
                    (q(nx+2-1,j-1,indvars(5))/1.0_wp*q(nx+2-1,j-1,indvars(1))))*param_float(18 + 5)*qst(nx+2-1,j-1,indvarsst(11))*(d2_dif_nut_dydy_0_0_nxp2m1jm1k)

d1_dif_nut_dy_0_nxp2m1jp1k = -param_float(1 + 5)*(1.0_wp+&
                    (q(nx+2-1,j+1,indvars(5))/1.0_wp*q(nx+2-1,j+1,indvars(1))))*param_float(18 + 5)*qst(nx+2-1,j+1,indvarsst(11))*(d2_dif_nut_dydy_0_0_nxp2m1jp1k)
...
rhs(nx+2-1,j,indvars(5)) = rhs(nx+2-1,j,indvars(5))  -  ( qst(nx+2-1,j,indvarsst(10))*(d1_dif_nut_dx_0_nxp2m1jk)+&
                    ...
                    param_float(17 + 5)*(q(nx+2-1,j,indvars(5))/1.0_wp*q(nx+2-1,j,indvars(1)))**2.0_wp)))*qst(nx+2-1,j,indvarsst(12))*q(nx+2-1,j,indvars(1))*q(nx+2-1,j,indvars(5))+&
                    param_float(1 + 5)*(param_float(10 + 5)*(((min(param_float(1 + 5)*(q(nx+2-1,j,indvars(5))/(qst(nx+2-1,j,indvarsst(12))*param_float(9 + 5)**2.0_wp*qst(nx+2-1,j,indvarsst(2))**2.0_wp)),10.0_wp))+&
                    param_float(11 + 5)*((min(param_float(1 + 5)*(q(nx+2-1,j,indvars(5))/(qst(nx+2-1,j,indvarsst(12))*param_float(9 + 5)**2.0_wp*qst(nx+2-1,j,indvarsst(2))**2.0_wp)),10.0_wp))**6.0_wp-&
                    (min(param_float(1 + 5)*(q(nx+2-1,j,indvars(5))/(qst(nx+2-1,j,indvarsst(12))*param_float(9 + 5)**2.0_wp*qst(nx+2-1,j,indvarsst(2))**2.0_wp)),10.0_wp))))*((1.0_wp+&
                    param_float(12 + 5)**6.0_wp)/(((min(param_float(1 + 5)*(q(nx+2-1,j,indvars(5))/(qst(nx+2-1,j,indvarsst(12))*param_float(9 + 5)**2.0_wp*qst(nx+2-1,j,indvarsst(2))**2.0_wp)),10.0_wp))+&
                    param_float(11 + 5)*((min(param_float(1 + 5)*(q(nx+2-1,j,indvars(5))/(qst(nx+2-1,j,indvarsst(12))*param_float(9 + 5)**2.0_wp*qst(nx+2-1,j,indvarsst(2))**2.0_wp)),10.0_wp))**6.0_wp-&
                    (min(param_float(1 + 5)*(q(nx+2-1,j,indvars(5))/(qst(nx+2-1,j,indvarsst(12))*param_float(9 + 5)**2.0_wp*qst(nx+2-1,j,indvarsst(2))**2.0_wp)),10.0_wp))))**6.0_wp+&
                    param_float(12 + 5)**6.0_wp))**(1.0_wp/6.0_wp))-&
                    param_float(6 + 5)/param_float(9 + 5)**2.0_wp*(param_float(16 + 5)*exp(-&
                    param_float(17 + 5)*(q(nx+2-1,j,indvars(5))/1.0_wp*q(nx+2-1,j,indvars(1)))**2.0_wp)))*q(nx+2-1,j,indvars(1))*(q(nx+2-1,j,indvars(5))/qst(nx+2-1,j,indvarsst(2)))**2.0_wp ) 
