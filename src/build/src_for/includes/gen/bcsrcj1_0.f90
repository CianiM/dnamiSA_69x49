...
! LOCAL VARIABLES
 ...
 real(wp) ::  d2_dif_rhou_dxdx_0_0_im11m2p0k_im1m11m2p0k,d2_dif_rhou_dxdx_0_0_im11m2p0k_im1p01m2p0k,d2_dif_rhou_dxdx_0_0_im11m2p0k_im1p11m2p0k &
            ...
            ,d2_dif_nut_dxdx_0_0_im11m2p0k_im1m11m2p0k,d2_dif_nut_dxdx_0_0_im11m2p0k_im1p01m2p0k,d2_dif_nut_dxdx_0_0_im11m2p0k_im1p11m2p0k &
            ,d2_dif_nut_dxdx_0_0_im11m2p0k &
            ,d2_dif_nut_dxdx_0_0_ip11m2p0k_ip1m11m2p0k,d2_dif_nut_dxdx_0_0_ip11m2p0k_ip1p01m2p0k,d2_dif_nut_dxdx_0_0_ip11m2p0k_ip1p11m2p0k &
            ...
            ,d1_dif_nut_dx_2_im11m2p0k,d1_dif_nut_dx_2_ip01m2p0k,d1_dif_nut_dx_2_ip11m2p0k &
            ...
            ,d2_dif_nut_dydy_0_0_i1m2p0p0k_i1m2p0p0p0k,d2_dif_nut_dydy_0_0_i1m2p0p0k_i1m2p0p0p1k,d2_dif_nut_dydy_0_0_i1m2p0p0k_i1m2p0p0p2k &
            ,d2_dif_nut_dydy_0_0_i1m2p0p0k &
            ,d2_dif_nut_dydy_0_0_i1m2p0p1k_i1m2p0p1m1k,d2_dif_nut_dydy_0_0_i1m2p0p1k_i1m2p0p1p0k,d2_dif_nut_dydy_0_0_i1m2p0p1k_i1m2p0p1p1k &
            ,d2_dif_nut_dydy_0_0_i1m2p0p1k &
            ,d2_dif_nut_dydy_0_0_i1m2p0p2k_i1m2p0p2m1k,d2_dif_nut_dydy_0_0_i1m2p0p2k_i1m2p0p2p0k,d2_dif_nut_dydy_0_0_i1m2p0p2k_i1m2p0p2p1k &
            ...
            ,d1_dif_nut_dy_2_i1m2p0p0k,d1_dif_nut_dy_2_i1m2p0p1k,d1_dif_nut_dy_2_i1m2p0p2k &
...
d1_dif_nut_dx_0_im11m2p0k = -(param_float(1 + 5)*(1.0_wp+&
                    (q(i-1,1-2+0,indvars(5))/1.0_wp))*param_float(18 + 5)*qst(i-1,1-2+0,indvarsst(10))*(d2_dif_nut_dxdx_0_0_im11m2p0k))

d1_dif_nut_dx_0_ip11m2p0k = -(param_float(1 + 5)*(1.0_wp+&
                    (q(i+1,1-2+0,indvars(5))/1.0_wp))*param_float(18 + 5)*qst(i+1,1-2+0,indvarsst(10))*(d2_dif_nut_dxdx_0_0_ip11m2p0k))
...
d1_dif_nut_dy_0_i1m2p0p0k = -(param_float(1 + 5)*(1.0_wp+&
                    (q(i,1-2+0+0,indvars(5))/1.0_wp))*param_float(18 + 5)*qst(i,1-2+0+0,indvarsst(11))*(d2_dif_nut_dydy_0_0_i1m2p0p0k))

d1_dif_nut_dy_0_i1m2p0p1k = -(param_float(1 + 5)*(1.0_wp+&
                    (q(i,1-2+0+1,indvars(5))/1.0_wp))*param_float(18 + 5)*qst(i,1-2+0+1,indvarsst(11))*(d2_dif_nut_dydy_0_0_i1m2p0p1k))

d1_dif_nut_dy_0_i1m2p0p2k = -(param_float(1 + 5)*(1.0_wp+&
                    (q(i,1-2+0+2,indvars(5))/1.0_wp))*param_float(18 + 5)*qst(i,1-2+0+2,indvarsst(11))*(d2_dif_nut_dydy_0_0_i1m2p0p2k))
