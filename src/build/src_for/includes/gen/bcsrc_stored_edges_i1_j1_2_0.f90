...
qst(1-4+2,1-4+0,indvarsst(4)) =  (((0.5_wp*(qst(1-4+2,1-4+0,indvarsst(11))*(d1_stemp_dy_0_1m4p21m4p0k)-&
                    qst(1-4+2,1-4+0,indvarsst(10))*(d1_stemp_dx_0_1m4p21m4p0k)))**2+&
                    (0.5_wp*(qst(1-4+2,1-4+0,indvarsst(10))*(d1_stemp_dx_0_1m4p21m4p0k)-&
                    qst(1-4+2,1-4+0,indvarsst(11))*(d1_stemp_dy_0_1m4p21m4p0k)))**2)*2)**0.5
...
qst(1-4+2,1-4+0,indvarsst(12)) =  (qst(1-4+2,1-4+0,indvarsst(4))+&
                    param_float(1 + 5)*q(1-4+2,1-4+0,indvars(5))/(param_float(9 + 5)**2*qst(1-4+2,1-4+0,indvarsst(2))**2))
...
qst(1-4+2,1-4+0,indvarsst(13)) =  (((1+&
                    ...
                    param_float(21 + 5))*((q(1-4+2,1-4+0,indvars(4))-&
                    0.5_wp*(q(1-4+2,1-4+0,indvars(2))*q(1-4+2,1-4+0,indvars(2))+&
                    q(1-4+2,1-4+0,indvars(3))*q(1-4+2,1-4+0,indvars(3)))))/param_float(4 + 5)**1.5*q(1-4+2,1-4+0,indvars(1))))*param_float(1 + 5)*(d1_stemp_dy_0_1m4p21m4p0k)*qst(1-4+2,1-4+0,indvarsst(11)))
