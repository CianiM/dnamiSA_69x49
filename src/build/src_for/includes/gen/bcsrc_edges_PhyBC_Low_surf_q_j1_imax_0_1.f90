...
q(nx+4-1,1-4+0,indvars(2)) =  qst(nx+4-1,1-4+0,indvarsst(5))*q(nx+4-1,1-4+0,indvars(2))
...
q(nx+4-1,1-4+0,indvars(3)) =  0.0_wp
...
q(nx+4-1,1-4+0,indvars(5)) =  qst(nx+4-1,1-4+0,indvarsst(5))*q(nx+4-1,1-4+0,indvars(5))
