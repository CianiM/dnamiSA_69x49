...
rhs(nx+2+0,j,indvars(1)) =   -  ( qst(nx+2+0,j,indvarsst(10))*(d1_rhs_rho_dx_0_nxp2p0jk)+&
                    ...
                    q(nx+2+0,j,indvars(3))*q(nx+2+0,j,indvars(3)))))/q(nx+2+0,j,indvars(1)))**0.5**2*((q(nx+2+0,j,indvars(2))*(-&
                    (param_float(23 + 5)*(param_float(3 + 5))*q(nx+2+0,j,indvars(1))*((q(nx+2+0,j,indvars(4))-&
                    0.5_wp*(q(nx+2+0,j,indvars(2))*q(nx+2+0,j,indvars(2))+&
                    q(nx+2+0,j,indvars(3))*q(nx+2+0,j,indvars(3)))))/q(nx+2+0,j,indvars(1)))**0.5**2*d1_rhs_rho_dx_1_nxp2p0jk+&
                    ...
                    0.5_wp*(q(nx+2+0,j,indvars(2))*q(nx+2+0,j,indvars(2))+&
                    q(nx+2+0,j,indvars(3))*q(nx+2+0,j,indvars(3)))))/q(nx+2+0,j,indvars(1)))**0.5+&
                    q(nx+2+0,j,indvars(2)))*((param_float(23 + 5)*(param_float(3 + 5))*q(nx+2+0,j,indvars(1))*((q(nx+2+0,j,indvars(4))-&
                    0.5_wp*(q(nx+2+0,j,indvars(2))*q(nx+2+0,j,indvars(2))+&
                    q(nx+2+0,j,indvars(3))*q(nx+2+0,j,indvars(3)))))/q(nx+2+0,j,indvars(1)))**0.5*q(nx+2+0,j,indvars(1))*d1_rhs_rho_dx_3_nxp2p0jk+&
                    1.0_wp*d1_rhs_rho_dx_2_nxp2p0jk))*qst(nx+2+0,j,indvarsst(10))+&
                    param_float(19 + 5)*(param_float(23 + 5)*(param_float(3 + 5))*q(nx+2+0,j,indvars(1))*((q(nx+2+0,j,indvars(4))-&
                    0.5_wp*(q(nx+2+0,j,indvars(2))*q(nx+2+0,j,indvars(2))+&
                    q(nx+2+0,j,indvars(3))*q(nx+2+0,j,indvars(3)))))/q(nx+2+0,j,indvars(1)))**0.5*(1-&
                    qface_i(j,2)*qface_i(j,2))/param_float(20 + 5)*((param_float(3 + 5))*q(nx+2+0,j,indvars(1))*((q(nx+2+0,j,indvars(4))-&
                    0.5_wp*(q(nx+2+0,j,indvars(2))*q(nx+2+0,j,indvars(2))+&
...
d2_rhs_u_dxdx_6_0_nxp2p0p0jk_nxp2p0p0p0jk = q(nx+2+0+0+0,j,indvars(2))

d2_rhs_u_dxdx_6_0_nxp2p0p0jk_nxp2p0p0m1jk = q(nx+2+0+0-1,j,indvars(2))

d2_rhs_u_dxdx_6_0_nxp2p0p0jk_nxp2p0p0m2jk = q(nx+2+0+0-2,j,indvars(2))

d2_rhs_u_dxdx_6_0_nxp2p0p0jk = 1.5_wp*d2_rhs_u_dxdx_6_0_nxp2p0p0jk_nxp2p0p0p0jk-&
          2.0_wp*d2_rhs_u_dxdx_6_0_nxp2p0p0jk_nxp2p0p0m1jk+&
          0.5_wp*d2_rhs_u_dxdx_6_0_nxp2p0p0jk_nxp2p0p0m2jk

d2_rhs_u_dxdx_6_0_nxp2p0p0jk = d2_rhs_u_dxdx_6_0_nxp2p0p0jk*param_float(1)

d2_rhs_u_dxdx_6_0_nxp2p0m1jk_nxp2p0m1m1jk = q(nx+2+0-1-1,j,indvars(2))

d2_rhs_u_dxdx_6_0_nxp2p0m1jk_nxp2p0m1p1jk = q(nx+2+0-1+1,j,indvars(2))

d2_rhs_u_dxdx_6_0_nxp2p0m1jk = -&
          0.5_wp*d2_rhs_u_dxdx_6_0_nxp2p0m1jk_nxp2p0m1m1jk+&
          0.5_wp*d2_rhs_u_dxdx_6_0_nxp2p0m1jk_nxp2p0m1p1jk

d2_rhs_u_dxdx_6_0_nxp2p0m1jk = d2_rhs_u_dxdx_6_0_nxp2p0m1jk*param_float(1)

d2_rhs_u_dxdx_6_0_nxp2p0m2jk_nxp2p0m2m1jk = q(nx+2+0-2-1,j,indvars(2))

d2_rhs_u_dxdx_6_0_nxp2p0m2jk_nxp2p0m2p1jk = q(nx+2+0-2+1,j,indvars(2))

d2_rhs_u_dxdx_6_0_nxp2p0m2jk = -&
          0.5_wp*d2_rhs_u_dxdx_6_0_nxp2p0m2jk_nxp2p0m2m1jk+&
          0.5_wp*d2_rhs_u_dxdx_6_0_nxp2p0m2jk_nxp2p0m2p1jk

d2_rhs_u_dxdx_6_0_nxp2p0m2jk = d2_rhs_u_dxdx_6_0_nxp2p0m2jk*param_float(1)

d2_rhs_u_dxdy_6_0_nxp2p0p0jk_nxp2p0p0jm1k = q(nx+2+0+0,j-1,indvars(3))

d2_rhs_u_dxdy_6_0_nxp2p0p0jk_nxp2p0p0jp1k = q(nx+2+0+0,j+1,indvars(3))

d2_rhs_u_dxdy_6_0_nxp2p0p0jk = -&
          0.5_wp*d2_rhs_u_dxdy_6_0_nxp2p0p0jk_nxp2p0p0jm1k+&
          0.5_wp*d2_rhs_u_dxdy_6_0_nxp2p0p0jk_nxp2p0p0jp1k

d2_rhs_u_dxdy_6_0_nxp2p0p0jk = d2_rhs_u_dxdy_6_0_nxp2p0p0jk*param_float(2)

d2_rhs_u_dxdy_6_0_nxp2p0m1jk_nxp2p0m1jm1k = q(nx+2+0-1,j-1,indvars(3))

d2_rhs_u_dxdy_6_0_nxp2p0m1jk_nxp2p0m1jp1k = q(nx+2+0-1,j+1,indvars(3))

d2_rhs_u_dxdy_6_0_nxp2p0m1jk = -&
          0.5_wp*d2_rhs_u_dxdy_6_0_nxp2p0m1jk_nxp2p0m1jm1k+&
          0.5_wp*d2_rhs_u_dxdy_6_0_nxp2p0m1jk_nxp2p0m1jp1k

d2_rhs_u_dxdy_6_0_nxp2p0m1jk = d2_rhs_u_dxdy_6_0_nxp2p0m1jk*param_float(2)

d2_rhs_u_dxdy_6_0_nxp2p0m2jk_nxp2p0m2jm1k = q(nx+2+0-2,j-1,indvars(3))

d2_rhs_u_dxdy_6_0_nxp2p0m2jk_nxp2p0m2jp1k = q(nx+2+0-2,j+1,indvars(3))

d2_rhs_u_dxdy_6_0_nxp2p0m2jk = -&
          0.5_wp*d2_rhs_u_dxdy_6_0_nxp2p0m2jk_nxp2p0m2jm1k+&
          0.5_wp*d2_rhs_u_dxdy_6_0_nxp2p0m2jk_nxp2p0m2jp1k

d2_rhs_u_dxdy_6_0_nxp2p0m2jk = d2_rhs_u_dxdy_6_0_nxp2p0m2jk*param_float(2)

d1_rhs_u_dx_6_nxp2p0p0jk = -(1.0_wp)*(1.0_wp+&
                    ((q(nx+2+0+0,j,indvars(5))/1.0_wp*q(nx+2+0+0,j,indvars(1)))**3.0_wp/((q(nx+2+0+0,j,indvars(5))/1.0_wp*q(nx+2+0+0,j,indvars(1)))**3.0_wp+&
                    param_float(13 + 5)**3.0_wp))*(q(nx+2+0+0,j,indvars(5))/1.0_wp*q(nx+2+0+0,j,indvars(1))))*param_float(1 + 5)*(2.0_wp*qst(nx+2+0+0,j,indvarsst(10))*(d2_rhs_u_dxdx_6_0_nxp2p0p0jk)-&
                    2.0_wp/3.0_wp*(qst(nx+2+0+0,j,indvarsst(10))*(d2_rhs_u_dxdx_6_0_nxp2p0p0jk)+&
                    qst(nx+2+0+0,j,indvarsst(11))*(d2_rhs_u_dxdy_6_0_nxp2p0p0jk)))

d1_rhs_u_dx_6_nxp2p0m1jk = -(1.0_wp)*(1.0_wp+&
                    ((q(nx+2+0-1,j,indvars(5))/1.0_wp*q(nx+2+0-1,j,indvars(1)))**3.0_wp/((q(nx+2+0-1,j,indvars(5))/1.0_wp*q(nx+2+0-1,j,indvars(1)))**3.0_wp+&
                    param_float(13 + 5)**3.0_wp))*(q(nx+2+0-1,j,indvars(5))/1.0_wp*q(nx+2+0-1,j,indvars(1))))*param_float(1 + 5)*(2.0_wp*qst(nx+2+0-1,j,indvarsst(10))*(d2_rhs_u_dxdx_6_0_nxp2p0m1jk)-&
                    2.0_wp/3.0_wp*(qst(nx+2+0-1,j,indvarsst(10))*(d2_rhs_u_dxdx_6_0_nxp2p0m1jk)+&
                    qst(nx+2+0-1,j,indvarsst(11))*(d2_rhs_u_dxdy_6_0_nxp2p0m1jk)))

d1_rhs_u_dx_6_nxp2p0m2jk = -(1.0_wp)*(1.0_wp+&
                    ((q(nx+2+0-2,j,indvars(5))/1.0_wp*q(nx+2+0-2,j,indvars(1)))**3.0_wp/((q(nx+2+0-2,j,indvars(5))/1.0_wp*q(nx+2+0-2,j,indvars(1)))**3.0_wp+&
                    param_float(13 + 5)**3.0_wp))*(q(nx+2+0-2,j,indvars(5))/1.0_wp*q(nx+2+0-2,j,indvars(1))))*param_float(1 + 5)*(2.0_wp*qst(nx+2+0-2,j,indvarsst(10))*(d2_rhs_u_dxdx_6_0_nxp2p0m2jk)-&
                    2.0_wp/3.0_wp*(qst(nx+2+0-2,j,indvarsst(10))*(d2_rhs_u_dxdx_6_0_nxp2p0m2jk)+&
                    qst(nx+2+0-2,j,indvarsst(11))*(d2_rhs_u_dxdy_6_0_nxp2p0m2jk)))

d1_rhs_u_dx_6_nxp2p0jk = 1.5_wp*d1_rhs_u_dx_6_nxp2p0p0jk-&
          2.0_wp*d1_rhs_u_dx_6_nxp2p0m1jk+&
          0.5_wp*d1_rhs_u_dx_6_nxp2p0m2jk

d1_rhs_u_dx_6_nxp2p0jk = d1_rhs_u_dx_6_nxp2p0jk*param_float(1)
...
d1_rhs_u_dy_1_nxp2p0jm1k = -(1.0_wp)*(1.0_wp+&
                    ((q(nx+2+0,j-1,indvars(5))/1.0_wp*q(nx+2+0,j-1,indvars(1)))**3.0_wp/((q(nx+2+0,j-1,indvars(5))/1.0_wp*q(nx+2+0,j-1,indvars(1)))**3.0_wp+&
                    param_float(13 + 5)**3.0_wp))*(q(nx+2+0,j-1,indvars(5))/1.0_wp*q(nx+2+0,j-1,indvars(1))))*param_float(1 + 5)*(qst(nx+2+0,j-1,indvarsst(11))*(d2_rhs_u_dydy_1_0_nxp2p0jm1k)+&
                    qst(nx+2+0,j-1,indvarsst(10))*(d2_rhs_u_dydx_1_0_nxp2p0jm1k))

d1_rhs_u_dy_1_nxp2p0jp1k = -(1.0_wp)*(1.0_wp+&
                    ((q(nx+2+0,j+1,indvars(5))/1.0_wp*q(nx+2+0,j+1,indvars(1)))**3.0_wp/((q(nx+2+0,j+1,indvars(5))/1.0_wp*q(nx+2+0,j+1,indvars(1)))**3.0_wp+&
                    param_float(13 + 5)**3.0_wp))*(q(nx+2+0,j+1,indvars(5))/1.0_wp*q(nx+2+0,j+1,indvars(1))))*param_float(1 + 5)*(qst(nx+2+0,j+1,indvarsst(11))*(d2_rhs_u_dydy_1_0_nxp2p0jp1k)+&
...
rhs(nx+2+0,j,indvars(2)) =   -  ( q(nx+2+0,j,indvars(2))*(1.0_wp/(param_float(23 + 5)*(param_float(3 + 5))*q(nx+2+0,j,indvars(1))*((q(nx+2+0,j,indvars(4))-&
                    ...
                    0.5_wp*(q(nx+2+0,j,indvars(2))*q(nx+2+0,j,indvars(2))+&
                    q(nx+2+0,j,indvars(3))*q(nx+2+0,j,indvars(3)))))/q(nx+2+0,j,indvars(1)))**0.5)*((((param_float(23 + 5)*(param_float(3 + 5))*q(nx+2+0,j,indvars(1))*((q(nx+2+0,j,indvars(4))-&
                    0.5_wp*(q(nx+2+0,j,indvars(2))*q(nx+2+0,j,indvars(2))+&
                    q(nx+2+0,j,indvars(3))*q(nx+2+0,j,indvars(3)))))/q(nx+2+0,j,indvars(1)))**0.5+&
                    q(nx+2+0,j,indvars(2)))*((param_float(23 + 5)*(param_float(3 + 5))*q(nx+2+0,j,indvars(1))*((q(nx+2+0,j,indvars(4))-&
                    0.5_wp*(q(nx+2+0,j,indvars(2))*q(nx+2+0,j,indvars(2))+&
                    ...
                    param_float(26 + 5))))+&
                    d1_rhs_u_dy_0_nxp2p0jk+&
                    qst(nx+2+0,j,indvarsst(10))*(d1_rhs_u_dx_6_nxp2p0jk)+&
...
d1_rhs_v_dx_4_nxp2p0p0jk = q(nx+2+0+0,j,indvars(3))

d1_rhs_v_dx_4_nxp2p0m1jk = q(nx+2+0-1,j,indvars(3))

d1_rhs_v_dx_4_nxp2p0m2jk = q(nx+2+0-2,j,indvars(3))

d1_rhs_v_dx_4_nxp2p0jk = 1.5_wp*d1_rhs_v_dx_4_nxp2p0p0jk-&
          2.0_wp*d1_rhs_v_dx_4_nxp2p0m1jk+&
          0.5_wp*d1_rhs_v_dx_4_nxp2p0m2jk

d1_rhs_v_dx_4_nxp2p0jk = d1_rhs_v_dx_4_nxp2p0jk*param_float(1)

d2_rhs_v_dxdx_5_0_nxp2p0p0jk_nxp2p0p0p0jk = q(nx+2+0+0+0,j,indvars(3))

d2_rhs_v_dxdx_5_0_nxp2p0p0jk_nxp2p0p0m1jk = q(nx+2+0+0-1,j,indvars(3))

d2_rhs_v_dxdx_5_0_nxp2p0p0jk_nxp2p0p0m2jk = q(nx+2+0+0-2,j,indvars(3))

d2_rhs_v_dxdx_5_0_nxp2p0p0jk = 1.5_wp*d2_rhs_v_dxdx_5_0_nxp2p0p0jk_nxp2p0p0p0jk-&
          2.0_wp*d2_rhs_v_dxdx_5_0_nxp2p0p0jk_nxp2p0p0m1jk+&
          0.5_wp*d2_rhs_v_dxdx_5_0_nxp2p0p0jk_nxp2p0p0m2jk

d2_rhs_v_dxdx_5_0_nxp2p0p0jk = d2_rhs_v_dxdx_5_0_nxp2p0p0jk*param_float(1)

d2_rhs_v_dxdx_5_0_nxp2p0m1jk_nxp2p0m1m1jk = q(nx+2+0-1-1,j,indvars(3))

d2_rhs_v_dxdx_5_0_nxp2p0m1jk_nxp2p0m1p1jk = q(nx+2+0-1+1,j,indvars(3))

d2_rhs_v_dxdx_5_0_nxp2p0m1jk = -&
          0.5_wp*d2_rhs_v_dxdx_5_0_nxp2p0m1jk_nxp2p0m1m1jk+&
          0.5_wp*d2_rhs_v_dxdx_5_0_nxp2p0m1jk_nxp2p0m1p1jk

d2_rhs_v_dxdx_5_0_nxp2p0m1jk = d2_rhs_v_dxdx_5_0_nxp2p0m1jk*param_float(1)

d2_rhs_v_dxdx_5_0_nxp2p0m2jk_nxp2p0m2m1jk = q(nx+2+0-2-1,j,indvars(3))

d2_rhs_v_dxdx_5_0_nxp2p0m2jk_nxp2p0m2p1jk = q(nx+2+0-2+1,j,indvars(3))

d2_rhs_v_dxdx_5_0_nxp2p0m2jk = -&
          0.5_wp*d2_rhs_v_dxdx_5_0_nxp2p0m2jk_nxp2p0m2m1jk+&
          0.5_wp*d2_rhs_v_dxdx_5_0_nxp2p0m2jk_nxp2p0m2p1jk

d2_rhs_v_dxdx_5_0_nxp2p0m2jk = d2_rhs_v_dxdx_5_0_nxp2p0m2jk*param_float(1)

d2_rhs_v_dxdy_5_0_nxp2p0p0jk_nxp2p0p0jm1k = q(nx+2+0+0,j-1,indvars(2))

d2_rhs_v_dxdy_5_0_nxp2p0p0jk_nxp2p0p0jp1k = q(nx+2+0+0,j+1,indvars(2))

d2_rhs_v_dxdy_5_0_nxp2p0p0jk = -&
          0.5_wp*d2_rhs_v_dxdy_5_0_nxp2p0p0jk_nxp2p0p0jm1k+&
          0.5_wp*d2_rhs_v_dxdy_5_0_nxp2p0p0jk_nxp2p0p0jp1k

d2_rhs_v_dxdy_5_0_nxp2p0p0jk = d2_rhs_v_dxdy_5_0_nxp2p0p0jk*param_float(2)

d2_rhs_v_dxdy_5_0_nxp2p0m1jk_nxp2p0m1jm1k = q(nx+2+0-1,j-1,indvars(2))

d2_rhs_v_dxdy_5_0_nxp2p0m1jk_nxp2p0m1jp1k = q(nx+2+0-1,j+1,indvars(2))

d2_rhs_v_dxdy_5_0_nxp2p0m1jk = -&
          0.5_wp*d2_rhs_v_dxdy_5_0_nxp2p0m1jk_nxp2p0m1jm1k+&
          0.5_wp*d2_rhs_v_dxdy_5_0_nxp2p0m1jk_nxp2p0m1jp1k

d2_rhs_v_dxdy_5_0_nxp2p0m1jk = d2_rhs_v_dxdy_5_0_nxp2p0m1jk*param_float(2)

d2_rhs_v_dxdy_5_0_nxp2p0m2jk_nxp2p0m2jm1k = q(nx+2+0-2,j-1,indvars(2))

d2_rhs_v_dxdy_5_0_nxp2p0m2jk_nxp2p0m2jp1k = q(nx+2+0-2,j+1,indvars(2))

d2_rhs_v_dxdy_5_0_nxp2p0m2jk = -&
          0.5_wp*d2_rhs_v_dxdy_5_0_nxp2p0m2jk_nxp2p0m2jm1k+&
          0.5_wp*d2_rhs_v_dxdy_5_0_nxp2p0m2jk_nxp2p0m2jp1k

d2_rhs_v_dxdy_5_0_nxp2p0m2jk = d2_rhs_v_dxdy_5_0_nxp2p0m2jk*param_float(2)

d1_rhs_v_dx_5_nxp2p0p0jk = -(1.0_wp)*(1.0_wp+&
                    ((q(nx+2+0+0,j,indvars(5))/1.0_wp*q(nx+2+0+0,j,indvars(1)))**3.0_wp/((q(nx+2+0+0,j,indvars(5))/1.0_wp*q(nx+2+0+0,j,indvars(1)))**3.0_wp+&
                    param_float(13 + 5)**3.0_wp))*(q(nx+2+0+0,j,indvars(5))/1.0_wp*q(nx+2+0+0,j,indvars(1))))*param_float(1 + 5)*(qst(nx+2+0+0,j,indvarsst(11))*(d2_rhs_v_dxdy_5_0_nxp2p0p0jk)+&
                    qst(nx+2+0+0,j,indvarsst(10))*(d2_rhs_v_dxdx_5_0_nxp2p0p0jk))

d1_rhs_v_dx_5_nxp2p0m1jk = -(1.0_wp)*(1.0_wp+&
                    ((q(nx+2+0-1,j,indvars(5))/1.0_wp*q(nx+2+0-1,j,indvars(1)))**3.0_wp/((q(nx+2+0-1,j,indvars(5))/1.0_wp*q(nx+2+0-1,j,indvars(1)))**3.0_wp+&
                    param_float(13 + 5)**3.0_wp))*(q(nx+2+0-1,j,indvars(5))/1.0_wp*q(nx+2+0-1,j,indvars(1))))*param_float(1 + 5)*(qst(nx+2+0-1,j,indvarsst(11))*(d2_rhs_v_dxdy_5_0_nxp2p0m1jk)+&
                    qst(nx+2+0-1,j,indvarsst(10))*(d2_rhs_v_dxdx_5_0_nxp2p0m1jk))

d1_rhs_v_dx_5_nxp2p0m2jk = -(1.0_wp)*(1.0_wp+&
                    ((q(nx+2+0-2,j,indvars(5))/1.0_wp*q(nx+2+0-2,j,indvars(1)))**3.0_wp/((q(nx+2+0-2,j,indvars(5))/1.0_wp*q(nx+2+0-2,j,indvars(1)))**3.0_wp+&
                    param_float(13 + 5)**3.0_wp))*(q(nx+2+0-2,j,indvars(5))/1.0_wp*q(nx+2+0-2,j,indvars(1))))*param_float(1 + 5)*(qst(nx+2+0-2,j,indvarsst(11))*(d2_rhs_v_dxdy_5_0_nxp2p0m2jk)+&
                    qst(nx+2+0-2,j,indvarsst(10))*(d2_rhs_v_dxdx_5_0_nxp2p0m2jk))

d1_rhs_v_dx_5_nxp2p0jk = 1.5_wp*d1_rhs_v_dx_5_nxp2p0p0jk-&
          2.0_wp*d1_rhs_v_dx_5_nxp2p0m1jk+&
          0.5_wp*d1_rhs_v_dx_5_nxp2p0m2jk

d1_rhs_v_dx_5_nxp2p0jk = d1_rhs_v_dx_5_nxp2p0jk*param_float(1)
...
d1_rhs_v_dy_1_nxp2p0jm1k = -(1.0_wp)*(1.0_wp+&
                    ((q(nx+2+0,j-1,indvars(5))/1.0_wp*q(nx+2+0,j-1,indvars(1)))**3.0_wp/((q(nx+2+0,j-1,indvars(5))/1.0_wp*q(nx+2+0,j-1,indvars(1)))**3.0_wp+&
                    param_float(13 + 5)**3.0_wp))*(q(nx+2+0,j-1,indvars(5))/1.0_wp*q(nx+2+0,j-1,indvars(1))))*param_float(1 + 5)*(2.0_wp*qst(nx+2+0,j-1,indvarsst(11))*(d2_rhs_v_dydy_1_0_nxp2p0jm1k)-&
...
d1_rhs_v_dy_1_nxp2p0jp1k = -(1.0_wp)*(1.0_wp+&
                    ((q(nx+2+0,j+1,indvars(5))/1.0_wp*q(nx+2+0,j+1,indvars(1)))**3.0_wp/((q(nx+2+0,j+1,indvars(5))/1.0_wp*q(nx+2+0,j+1,indvars(1)))**3.0_wp+&
                    param_float(13 + 5)**3.0_wp))*(q(nx+2+0,j+1,indvars(5))/1.0_wp*q(nx+2+0,j+1,indvars(1))))*param_float(1 + 5)*(2.0_wp*qst(nx+2+0,j+1,indvarsst(11))*(d2_rhs_v_dydy_1_0_nxp2p0jp1k)-&
...
rhs(nx+2+0,j,indvars(3)) =   -  ( q(nx+2+0,j,indvars(3))*(1.0_wp/(param_float(23 + 5)*(param_float(3 + 5))*q(nx+2+0,j,indvars(1))*((q(nx+2+0,j,indvars(4))-&
                    ...
                    q(nx+2+0,j,indvars(3))*q(nx+2+0,j,indvars(3)))))-&
                    param_float(26 + 5)))))+&
                    q(nx+2+0,j,indvars(1))*((1.0_wp*q(nx+2+0,j,indvars(2))*d1_rhs_v_dx_4_nxp2p0jk)*qst(nx+2+0,j,indvarsst(10)))+&
                    d1_rhs_v_dy_0_nxp2p0jk+&
                    qst(nx+2+0,j,indvarsst(10))*(d1_rhs_v_dx_5_nxp2p0jk)+&
...
d2_rhs_et_dxdx_9_0_nxp2p0p0jk_nxp2p0p0p0jk = ((q(nx+2+0+0+0,j,indvars(4))-&
...
d2_rhs_et_dxdx_9_0_nxp2p0p0jk_nxp2p0p0m1jk = ((q(nx+2+0+0-1,j,indvars(4))-&
...
d2_rhs_et_dxdx_9_0_nxp2p0p0jk_nxp2p0p0m2jk = ((q(nx+2+0+0-2,j,indvars(4))-&
...
d2_rhs_et_dxdx_9_0_nxp2p0p0jk = 1.5_wp*d2_rhs_et_dxdx_9_0_nxp2p0p0jk_nxp2p0p0p0jk-&
          2.0_wp*d2_rhs_et_dxdx_9_0_nxp2p0p0jk_nxp2p0p0m1jk+&
          0.5_wp*d2_rhs_et_dxdx_9_0_nxp2p0p0jk_nxp2p0p0m2jk

d2_rhs_et_dxdx_9_0_nxp2p0p0jk = d2_rhs_et_dxdx_9_0_nxp2p0p0jk*param_float(1)

d2_rhs_et_dxdx_9_0_nxp2p0m1jk_nxp2p0m1m1jk = ((q(nx+2+0-1-1,j,indvars(4))-&
...
d2_rhs_et_dxdx_9_0_nxp2p0m1jk_nxp2p0m1p1jk = ((q(nx+2+0-1+1,j,indvars(4))-&
                    0.5_wp*(q(nx+2+0-1+1,j,indvars(2))*q(nx+2+0-1+1,j,indvars(2))+&
                    q(nx+2+0-1+1,j,indvars(3))*q(nx+2+0-1+1,j,indvars(3)))))/(param_float(4 + 5))

d2_rhs_et_dxdx_9_0_nxp2p0m1jk = -&
          0.5_wp*d2_rhs_et_dxdx_9_0_nxp2p0m1jk_nxp2p0m1m1jk+&
          0.5_wp*d2_rhs_et_dxdx_9_0_nxp2p0m1jk_nxp2p0m1p1jk

d2_rhs_et_dxdx_9_0_nxp2p0m1jk = d2_rhs_et_dxdx_9_0_nxp2p0m1jk*param_float(1)

d2_rhs_et_dxdx_9_0_nxp2p0m2jk_nxp2p0m2m1jk = ((q(nx+2+0-2-1,j,indvars(4))-&
...
d2_rhs_et_dxdx_9_0_nxp2p0m2jk_nxp2p0m2p1jk = ((q(nx+2+0-2+1,j,indvars(4))-&
                    0.5_wp*(q(nx+2+0-2+1,j,indvars(2))*q(nx+2+0-2+1,j,indvars(2))+&
                    q(nx+2+0-2+1,j,indvars(3))*q(nx+2+0-2+1,j,indvars(3)))))/(param_float(4 + 5))

d2_rhs_et_dxdx_9_0_nxp2p0m2jk = -&
          0.5_wp*d2_rhs_et_dxdx_9_0_nxp2p0m2jk_nxp2p0m2m1jk+&
          0.5_wp*d2_rhs_et_dxdx_9_0_nxp2p0m2jk_nxp2p0m2p1jk

d2_rhs_et_dxdx_9_0_nxp2p0m2jk = d2_rhs_et_dxdx_9_0_nxp2p0m2jk*param_float(1)

d1_rhs_et_dx_9_nxp2p0p0jk = -param_float(2 + 5)*qst(nx+2+0+0,j,indvarsst(10))*(d2_rhs_et_dxdx_9_0_nxp2p0p0jk)-&
                    q(nx+2+0+0,j,indvars(2))*((1.0_wp)*(1.0_wp+&
                    ((q(nx+2+0+0,j,indvars(5))/1.0_wp*q(nx+2+0+0,j,indvars(1)))**3.0_wp/((q(nx+2+0+0,j,indvars(5))/1.0_wp*q(nx+2+0+0,j,indvars(1)))**3.0_wp+&
                    param_float(13 + 5)**3.0_wp))*(q(nx+2+0+0,j,indvars(5))/1.0_wp*q(nx+2+0+0,j,indvars(1))))*param_float(1 + 5)*(2.0_wp*qst(nx+2+0+0,j,indvarsst(10))*(d2_rhs_u_dxdx_6_0_nxp2p0p0jk)-&
                    2.0_wp/3.0_wp*(qst(nx+2+0+0,j,indvarsst(10))*(d2_rhs_u_dxdx_6_0_nxp2p0p0jk)+&
                    qst(nx+2+0+0,j,indvarsst(11))*(d2_rhs_u_dxdy_6_0_nxp2p0p0jk))))-&
                    q(nx+2+0+0,j,indvars(3))*((1.0_wp)*(1.0_wp+&
                    ((q(nx+2+0+0,j,indvars(5))/1.0_wp*q(nx+2+0+0,j,indvars(1)))**3.0_wp/((q(nx+2+0+0,j,indvars(5))/1.0_wp*q(nx+2+0+0,j,indvars(1)))**3.0_wp+&
                    param_float(13 + 5)**3.0_wp))*(q(nx+2+0+0,j,indvars(5))/1.0_wp*q(nx+2+0+0,j,indvars(1))))*param_float(1 + 5)*(qst(nx+2+0+0,j,indvarsst(11))*(d2_rhs_v_dxdy_5_0_nxp2p0p0jk)+&
                    qst(nx+2+0+0,j,indvarsst(10))*(d2_rhs_v_dxdx_5_0_nxp2p0p0jk)))

d1_rhs_et_dx_9_nxp2p0m1jk = -param_float(2 + 5)*qst(nx+2+0-1,j,indvarsst(10))*(d2_rhs_et_dxdx_9_0_nxp2p0m1jk)-&
                    q(nx+2+0-1,j,indvars(2))*((1.0_wp)*(1.0_wp+&
                    ((q(nx+2+0-1,j,indvars(5))/1.0_wp*q(nx+2+0-1,j,indvars(1)))**3.0_wp/((q(nx+2+0-1,j,indvars(5))/1.0_wp*q(nx+2+0-1,j,indvars(1)))**3.0_wp+&
                    param_float(13 + 5)**3.0_wp))*(q(nx+2+0-1,j,indvars(5))/1.0_wp*q(nx+2+0-1,j,indvars(1))))*param_float(1 + 5)*(2.0_wp*qst(nx+2+0-1,j,indvarsst(10))*(d2_rhs_u_dxdx_6_0_nxp2p0m1jk)-&
                    2.0_wp/3.0_wp*(qst(nx+2+0-1,j,indvarsst(10))*(d2_rhs_u_dxdx_6_0_nxp2p0m1jk)+&
                    qst(nx+2+0-1,j,indvarsst(11))*(d2_rhs_u_dxdy_6_0_nxp2p0m1jk))))-&
                    q(nx+2+0-1,j,indvars(3))*((1.0_wp)*(1.0_wp+&
                    ((q(nx+2+0-1,j,indvars(5))/1.0_wp*q(nx+2+0-1,j,indvars(1)))**3.0_wp/((q(nx+2+0-1,j,indvars(5))/1.0_wp*q(nx+2+0-1,j,indvars(1)))**3.0_wp+&
                    param_float(13 + 5)**3.0_wp))*(q(nx+2+0-1,j,indvars(5))/1.0_wp*q(nx+2+0-1,j,indvars(1))))*param_float(1 + 5)*(qst(nx+2+0-1,j,indvarsst(11))*(d2_rhs_v_dxdy_5_0_nxp2p0m1jk)+&
                    qst(nx+2+0-1,j,indvarsst(10))*(d2_rhs_v_dxdx_5_0_nxp2p0m1jk)))

d1_rhs_et_dx_9_nxp2p0m2jk = -param_float(2 + 5)*qst(nx+2+0-2,j,indvarsst(10))*(d2_rhs_et_dxdx_9_0_nxp2p0m2jk)-&
                    q(nx+2+0-2,j,indvars(2))*((1.0_wp)*(1.0_wp+&
                    ((q(nx+2+0-2,j,indvars(5))/1.0_wp*q(nx+2+0-2,j,indvars(1)))**3.0_wp/((q(nx+2+0-2,j,indvars(5))/1.0_wp*q(nx+2+0-2,j,indvars(1)))**3.0_wp+&
                    param_float(13 + 5)**3.0_wp))*(q(nx+2+0-2,j,indvars(5))/1.0_wp*q(nx+2+0-2,j,indvars(1))))*param_float(1 + 5)*(2.0_wp*qst(nx+2+0-2,j,indvarsst(10))*(d2_rhs_u_dxdx_6_0_nxp2p0m2jk)-&
                    2.0_wp/3.0_wp*(qst(nx+2+0-2,j,indvarsst(10))*(d2_rhs_u_dxdx_6_0_nxp2p0m2jk)+&
                    qst(nx+2+0-2,j,indvarsst(11))*(d2_rhs_u_dxdy_6_0_nxp2p0m2jk))))-&
                    q(nx+2+0-2,j,indvars(3))*((1.0_wp)*(1.0_wp+&
                    ((q(nx+2+0-2,j,indvars(5))/1.0_wp*q(nx+2+0-2,j,indvars(1)))**3.0_wp/((q(nx+2+0-2,j,indvars(5))/1.0_wp*q(nx+2+0-2,j,indvars(1)))**3.0_wp+&
                    param_float(13 + 5)**3.0_wp))*(q(nx+2+0-2,j,indvars(5))/1.0_wp*q(nx+2+0-2,j,indvars(1))))*param_float(1 + 5)*(qst(nx+2+0-2,j,indvarsst(11))*(d2_rhs_v_dxdy_5_0_nxp2p0m2jk)+&
                    qst(nx+2+0-2,j,indvarsst(10))*(d2_rhs_v_dxdx_5_0_nxp2p0m2jk)))

d1_rhs_et_dx_9_nxp2p0jk = 1.5_wp*d1_rhs_et_dx_9_nxp2p0p0jk-&
          2.0_wp*d1_rhs_et_dx_9_nxp2p0m1jk+&
          0.5_wp*d1_rhs_et_dx_9_nxp2p0m2jk

d1_rhs_et_dx_9_nxp2p0jk = d1_rhs_et_dx_9_nxp2p0jk*param_float(1)
...
d1_rhs_et_dy_1_nxp2p0jm1k = -param_float(2 + 5)*qst(nx+2+0,j-1,indvarsst(11))*(d2_rhs_et_dydy_1_0_nxp2p0jm1k)-&
                    q(nx+2+0,j-1,indvars(2))*((1.0_wp)*(1.0_wp+&
                    ((q(nx+2+0,j-1,indvars(5))/1.0_wp*q(nx+2+0,j-1,indvars(1)))**3.0_wp/((q(nx+2+0,j-1,indvars(5))/1.0_wp*q(nx+2+0,j-1,indvars(1)))**3.0_wp+&
                    param_float(13 + 5)**3.0_wp))*(q(nx+2+0,j-1,indvars(5))/1.0_wp*q(nx+2+0,j-1,indvars(1))))*param_float(1 + 5)*(qst(nx+2+0,j-1,indvarsst(11))*(d2_rhs_u_dydy_1_0_nxp2p0jm1k)+&
                    qst(nx+2+0,j-1,indvarsst(10))*(d2_rhs_u_dydx_1_0_nxp2p0jm1k)))-&
                    q(nx+2+0,j-1,indvars(3))*((1.0_wp)*(1.0_wp+&
                    ((q(nx+2+0,j-1,indvars(5))/1.0_wp*q(nx+2+0,j-1,indvars(1)))**3.0_wp/((q(nx+2+0,j-1,indvars(5))/1.0_wp*q(nx+2+0,j-1,indvars(1)))**3.0_wp+&
                    param_float(13 + 5)**3.0_wp))*(q(nx+2+0,j-1,indvars(5))/1.0_wp*q(nx+2+0,j-1,indvars(1))))*param_float(1 + 5)*(2.0_wp*qst(nx+2+0,j-1,indvarsst(11))*(d2_rhs_v_dydy_1_0_nxp2p0jm1k)-&
                    2.0_wp/3.0_wp*(qst(nx+2+0,j-1,indvarsst(10))*(d2_rhs_v_dydx_1_0_nxp2p0jm1k)+&
                    qst(nx+2+0,j-1,indvarsst(11))*(d2_rhs_v_dydy_1_0_nxp2p0jm1k))))
...
rhs(nx+2+0,j,indvars(4)) =   -  ( 0.5_wp*(q(nx+2+0,j,indvars(2))**2+&
                    ...
                    q(nx+2+0,j,indvars(3))*q(nx+2+0,j,indvars(3)))))-&
                    param_float(26 + 5))))+&
                    q(nx+2+0,j,indvars(1))*q(nx+2+0,j,indvars(3))*((1.0_wp*q(nx+2+0,j,indvars(2))*d1_rhs_v_dx_4_nxp2p0jk)*qst(nx+2+0,j,indvarsst(10)))+&
                    d1_rhs_et_dy_0_nxp2p0jk+&
                    qst(nx+2+0,j,indvarsst(10))*(d1_rhs_et_dx_9_nxp2p0jk)+&
...
d2_rhs_nut_dydy_0_0_nxp2p0jm1k_nxp2p0jm1m1k = q(nx+2+0,j-1-1,indvars(5))

d2_rhs_nut_dydy_0_0_nxp2p0jm1k_nxp2p0jm1p1k = q(nx+2+0,j-1+1,indvars(5))

d2_rhs_nut_dydy_0_0_nxp2p0jm1k = -&
          0.5_wp*d2_rhs_nut_dydy_0_0_nxp2p0jm1k_nxp2p0jm1m1k+&
          0.5_wp*d2_rhs_nut_dydy_0_0_nxp2p0jm1k_nxp2p0jm1p1k

d2_rhs_nut_dydy_0_0_nxp2p0jm1k = d2_rhs_nut_dydy_0_0_nxp2p0jm1k*param_float(2)

d2_rhs_nut_dydy_0_0_nxp2p0jp1k_nxp2p0jp1m1k = q(nx+2+0,j+1-1,indvars(5))

d2_rhs_nut_dydy_0_0_nxp2p0jp1k_nxp2p0jp1p1k = q(nx+2+0,j+1+1,indvars(5))

d2_rhs_nut_dydy_0_0_nxp2p0jp1k = -&
          0.5_wp*d2_rhs_nut_dydy_0_0_nxp2p0jp1k_nxp2p0jp1m1k+&
          0.5_wp*d2_rhs_nut_dydy_0_0_nxp2p0jp1k_nxp2p0jp1p1k

d2_rhs_nut_dydy_0_0_nxp2p0jp1k = d2_rhs_nut_dydy_0_0_nxp2p0jp1k*param_float(2)

d1_rhs_nut_dy_1_nxp2p0jm1k = q(nx+2+0,j-1,indvars(1))*q(nx+2+0,j-1,indvars(5))

d1_rhs_nut_dy_1_nxp2p0jp1k = q(nx+2+0,j+1,indvars(1))*q(nx+2+0,j+1,indvars(5))

d1_rhs_nut_dy_1_nxp2p0jk = -&
          0.5_wp*d1_rhs_nut_dy_1_nxp2p0jm1k+&
          0.5_wp*d1_rhs_nut_dy_1_nxp2p0jp1k

d1_rhs_nut_dy_1_nxp2p0jk = d1_rhs_nut_dy_1_nxp2p0jk*param_float(2)

d1_rhs_nut_dy_2_nxp2p0jm1k = q(nx+2+0,j-1,indvars(5))

d1_rhs_nut_dy_2_nxp2p0jp1k = q(nx+2+0,j+1,indvars(5))

d1_rhs_nut_dy_2_nxp2p0jk = -&
          0.5_wp*d1_rhs_nut_dy_2_nxp2p0jm1k+&
          0.5_wp*d1_rhs_nut_dy_2_nxp2p0jp1k

d1_rhs_nut_dy_2_nxp2p0jk = d1_rhs_nut_dy_2_nxp2p0jk*param_float(2)

d1_rhs_nut_dy_0_nxp2p0jm1k = (q(nx+2+0,j-1,indvars(1))*q(nx+2+0,j-1,indvars(3))*q(nx+2+0,j-1,indvars(5))-&
                    param_float(1 + 5)*(1.0_wp+&
                    (q(nx+2+0,j-1,indvars(5))/1.0_wp*q(nx+2+0,j-1,indvars(1))))*param_float(18 + 5)*qst(nx+2+0,j-1,indvarsst(11))*(d2_rhs_nut_dydy_0_0_nxp2p0jm1k))

d1_rhs_nut_dy_0_nxp2p0jp1k = (q(nx+2+0,j+1,indvars(1))*q(nx+2+0,j+1,indvars(3))*q(nx+2+0,j+1,indvars(5))-&
                    param_float(1 + 5)*(1.0_wp+&
                    (q(nx+2+0,j+1,indvars(5))/1.0_wp*q(nx+2+0,j+1,indvars(1))))*param_float(18 + 5)*qst(nx+2+0,j+1,indvarsst(11))*(d2_rhs_nut_dydy_0_0_nxp2p0jp1k))

d1_rhs_nut_dy_0_nxp2p0jk = -&
          0.5_wp*d1_rhs_nut_dy_0_nxp2p0jm1k+&
          0.5_wp*d1_rhs_nut_dy_0_nxp2p0jp1k

d1_rhs_nut_dy_0_nxp2p0jk = d1_rhs_nut_dy_0_nxp2p0jk*param_float(2)
...
rhs(nx+2+0,j,indvars(5)) =   -  ( (d1_rhs_nut_dy_0_nxp2p0jk)*qst(nx+2+0,j,indvarsst(11))+&
                    -&
                    param_float(1 + 5)*param_float(7 + 5)*param_float(18 + 5)*((qst(nx+2+0,j,indvarsst(11)))**2*(d1_rhs_nut_dy_1_nxp2p0jk)*(d1_rhs_nut_dy_2_nxp2p0jk))-&
                    param_float(6 + 5)*(1-&
                    (param_float(16 + 5)*exp(-&
                    param_float(17 + 5)*(q(nx+2+0,j,indvars(5))/1.0_wp*q(nx+2+0,j,indvars(1)))**2.0_wp)))*qst(nx+2+0,j,indvarsst(12))*q(nx+2+0,j,indvars(1))*q(nx+2+0,j,indvars(5))+&
                    param_float(1 + 5)*(param_float(10 + 5)*(((min(param_float(1 + 5)*(q(nx+2+0,j,indvars(5))/(qst(nx+2+0,j,indvarsst(12))*param_float(9 + 5)**2.0_wp*qst(nx+2+0,j,indvarsst(2))**2.0_wp)),10.0_wp))+&
                    param_float(11 + 5)*((min(param_float(1 + 5)*(q(nx+2+0,j,indvars(5))/(qst(nx+2+0,j,indvarsst(12))*param_float(9 + 5)**2.0_wp*qst(nx+2+0,j,indvarsst(2))**2.0_wp)),10.0_wp))**6.0_wp-&
                    (min(param_float(1 + 5)*(q(nx+2+0,j,indvars(5))/(qst(nx+2+0,j,indvarsst(12))*param_float(9 + 5)**2.0_wp*qst(nx+2+0,j,indvarsst(2))**2.0_wp)),10.0_wp))))*((1.0_wp+&
                    param_float(12 + 5)**6.0_wp)/(((min(param_float(1 + 5)*(q(nx+2+0,j,indvars(5))/(qst(nx+2+0,j,indvarsst(12))*param_float(9 + 5)**2.0_wp*qst(nx+2+0,j,indvarsst(2))**2.0_wp)),10.0_wp))+&
                    param_float(11 + 5)*((min(param_float(1 + 5)*(q(nx+2+0,j,indvars(5))/(qst(nx+2+0,j,indvarsst(12))*param_float(9 + 5)**2.0_wp*qst(nx+2+0,j,indvarsst(2))**2.0_wp)),10.0_wp))**6.0_wp-&
                    (min(param_float(1 + 5)*(q(nx+2+0,j,indvars(5))/(qst(nx+2+0,j,indvarsst(12))*param_float(9 + 5)**2.0_wp*qst(nx+2+0,j,indvarsst(2))**2.0_wp)),10.0_wp))))**6.0_wp+&
                    param_float(12 + 5)**6.0_wp))**(1.0_wp/6.0_wp))-&
                    param_float(6 + 5)/param_float(9 + 5)**2*(param_float(16 + 5)*exp(-&
                    param_float(17 + 5)*(q(nx+2+0,j,indvars(5))/1.0_wp*q(nx+2+0,j,indvars(1)))**2.0_wp)))*q(nx+2+0,j,indvars(1))*(q(nx+2+0,j,indvars(5))/qst(nx+2+0,j,indvarsst(2)))**2.0_wp ) 
