...
subroutine boundaryScheme_edges_PhyBC_Out_surf_rhs_imax_j1_0_3(param_float,hlo,ind,idarray,neq,neqst,nx,ny,nz,sizeblck,q,qst,rhs,nvar_f,nvar_e,qface_i,qface_j,qface_k,qedge_ij,qedge_jk,qedge_ik)
...
! LOCAL VARIABLES
 ...
 real(wp) ::  d1_rhs_rho_dx_0_nxp4p0p01m4p3k,d1_rhs_rho_dx_0_nxp4p0m11m4p3k,d1_rhs_rho_dx_0_nxp4p0m21m4p3k &
            ...
            ,d2_rhs_nut_dydy_0_0_nxp4p01m4p3m3k_nxp4p01m4p3m3p0k,d2_rhs_nut_dydy_0_0_nxp4p01m4p3m3k_nxp4p01m4p3m3p1k,d2_rhs_nut_dydy_0_0_nxp4p01m4p3m3k_nxp4p01m4p3m3p2k &
            ,d2_rhs_nut_dydy_0_0_nxp4p01m4p3m3k &
            ,d2_rhs_nut_dydy_0_0_nxp4p01m4p3m2k_nxp4p01m4p3m2m1k,d2_rhs_nut_dydy_0_0_nxp4p01m4p3m2k_nxp4p01m4p3m2p0k,d2_rhs_nut_dydy_0_0_nxp4p01m4p3m2k_nxp4p01m4p3m2p1k &
            ,d2_rhs_nut_dydy_0_0_nxp4p01m4p3m2k &
            ,d2_rhs_nut_dydy_0_0_nxp4p01m4p3m1k_nxp4p01m4p3m1m1k,d2_rhs_nut_dydy_0_0_nxp4p01m4p3m1k_nxp4p01m4p3m1p0k,d2_rhs_nut_dydy_0_0_nxp4p01m4p3m1k_nxp4p01m4p3m1p1k &
            ,d2_rhs_nut_dydy_0_0_nxp4p01m4p3m1k &
            ,d2_rhs_nut_dydy_0_0_nxp4p01m4p3p1k_nxp4p01m4p3p1m1k,d2_rhs_nut_dydy_0_0_nxp4p01m4p3p1k_nxp4p01m4p3p1p0k,d2_rhs_nut_dydy_0_0_nxp4p01m4p3p1k_nxp4p01m4p3p1p1k &
            ,d2_rhs_nut_dydy_0_0_nxp4p01m4p3p1k &
            ,d2_rhs_nut_dydy_0_0_nxp4p01m4p3p2k_nxp4p01m4p3p2m1k,d2_rhs_nut_dydy_0_0_nxp4p01m4p3p2k_nxp4p01m4p3p2p0k,d2_rhs_nut_dydy_0_0_nxp4p01m4p3p2k_nxp4p01m4p3p2p1k &
            ,d2_rhs_nut_dydy_0_0_nxp4p01m4p3p2k &
            ,d2_rhs_nut_dydy_0_0_nxp4p01m4p3p3k_nxp4p01m4p3p3m1k,d2_rhs_nut_dydy_0_0_nxp4p01m4p3p3k_nxp4p01m4p3p3p0k,d2_rhs_nut_dydy_0_0_nxp4p01m4p3p3k_nxp4p01m4p3p3p1k &
            ,d2_rhs_nut_dydy_0_0_nxp4p01m4p3p3k &
            ,d1_rhs_nut_dy_1_nxp4p01m4p3m1k,d1_rhs_nut_dy_1_nxp4p01m4p3p0k,d1_rhs_nut_dy_1_nxp4p01m4p3p1k &
            ,d1_rhs_nut_dy_1_nxp4p01m4p3k &
            ,d1_rhs_nut_dy_2_nxp4p01m4p3m1k,d1_rhs_nut_dy_2_nxp4p01m4p3p0k,d1_rhs_nut_dy_2_nxp4p01m4p3p1k &
            ,d1_rhs_nut_dy_2_nxp4p01m4p3k &
            ,d1_rhs_nut_dy_0_nxp4p01m4p3m1k,d1_rhs_nut_dy_0_nxp4p01m4p3p0k,d1_rhs_nut_dy_0_nxp4p01m4p3p1k &
            ,d1_rhs_nut_dy_0_nxp4p01m4p3k 
...
rhs(nx+4+0,1-4+3,indvars(1)) =   -  ( qst(nx+4+0,1-4+3,indvarsst(10))*(d1_rhs_rho_dx_0_nxp4p01m4p3k)+&
                    ...
                    q(nx+4+0,1-4+3,indvars(3))*q(nx+4+0,1-4+3,indvars(3)))))/q(nx+4+0,1-4+3,indvars(1)))**0.5**2*((q(nx+4+0,1-4+3,indvars(2))*(-&
                    (param_float(23 + 5)*(param_float(3 + 5))*q(nx+4+0,1-4+3,indvars(1))*((q(nx+4+0,1-4+3,indvars(4))-&
                    0.5_wp*(q(nx+4+0,1-4+3,indvars(2))*q(nx+4+0,1-4+3,indvars(2))+&
                    q(nx+4+0,1-4+3,indvars(3))*q(nx+4+0,1-4+3,indvars(3)))))/q(nx+4+0,1-4+3,indvars(1)))**0.5**2*d1_rhs_rho_dx_1_nxp4p01m4p3k+&
                    ...
                    0.5_wp*(q(nx+4+0,1-4+3,indvars(2))*q(nx+4+0,1-4+3,indvars(2))+&
                    q(nx+4+0,1-4+3,indvars(3))*q(nx+4+0,1-4+3,indvars(3)))))/q(nx+4+0,1-4+3,indvars(1)))**0.5+&
                    q(nx+4+0,1-4+3,indvars(2)))*((param_float(23 + 5)*(param_float(3 + 5))*q(nx+4+0,1-4+3,indvars(1))*((q(nx+4+0,1-4+3,indvars(4))-&
                    0.5_wp*(q(nx+4+0,1-4+3,indvars(2))*q(nx+4+0,1-4+3,indvars(2))+&
                    q(nx+4+0,1-4+3,indvars(3))*q(nx+4+0,1-4+3,indvars(3)))))/q(nx+4+0,1-4+3,indvars(1)))**0.5*q(nx+4+0,1-4+3,indvars(1))*d1_rhs_rho_dx_3_nxp4p01m4p3k+&
                    1.0_wp*d1_rhs_rho_dx_2_nxp4p01m4p3k))*qst(nx+4+0,1-4+3,indvarsst(10))+&
                    param_float(19 + 5)*(param_float(23 + 5)*(param_float(3 + 5))*q(nx+4+0,1-4+3,indvars(1))*((q(nx+4+0,1-4+3,indvars(4))-&
                    0.5_wp*(q(nx+4+0,1-4+3,indvars(2))*q(nx+4+0,1-4+3,indvars(2))+&
                    q(nx+4+0,1-4+3,indvars(3))*q(nx+4+0,1-4+3,indvars(3)))))/q(nx+4+0,1-4+3,indvars(1)))**0.5*(1-&
...
d1_rhs_u_dx_6_nxp4p0p01m4p3k = -(1.0_wp)*(1.0_wp+&
                    ...
                    param_float(13 + 5)**3.0_wp))*(q(nx+4+0+0,1-4+3,indvars(5))/1.0_wp*q(nx+4+0+0,1-4+3,indvars(1))))*param_float(1 + 5)*(2.0_wp*qst(nx+4+0+0,1-4+3,indvarsst(10))*(d2_rhs_u_dxdx_6_0_nxp4p0p01m4p3k)-&
...
d1_rhs_u_dx_6_nxp4p0m11m4p3k = -(1.0_wp)*(1.0_wp+&
                    ...
                    param_float(13 + 5)**3.0_wp))*(q(nx+4+0-1,1-4+3,indvars(5))/1.0_wp*q(nx+4+0-1,1-4+3,indvars(1))))*param_float(1 + 5)*(2.0_wp*qst(nx+4+0-1,1-4+3,indvarsst(10))*(d2_rhs_u_dxdx_6_0_nxp4p0m11m4p3k)-&
...
d1_rhs_u_dx_6_nxp4p0m21m4p3k = -(1.0_wp)*(1.0_wp+&
                    ...
                    param_float(13 + 5)**3.0_wp))*(q(nx+4+0-2,1-4+3,indvars(5))/1.0_wp*q(nx+4+0-2,1-4+3,indvars(1))))*param_float(1 + 5)*(2.0_wp*qst(nx+4+0-2,1-4+3,indvarsst(10))*(d2_rhs_u_dxdx_6_0_nxp4p0m21m4p3k)-&
...
d1_rhs_u_dy_1_nxp4p01m4p3m1k = -(1.0_wp)*(1.0_wp+&
                    ...
                    param_float(13 + 5)**3.0_wp))*(q(nx+4+0,1-4+3-1,indvars(5))/1.0_wp*q(nx+4+0,1-4+3-1,indvars(1))))*param_float(1 + 5)*(qst(nx+4+0,1-4+3-1,indvarsst(11))*(d2_rhs_u_dydy_1_0_nxp4p01m4p3m1k)+&
                    qst(nx+4+0,1-4+3-1,indvarsst(10))*(d2_rhs_u_dydx_1_0_nxp4p01m4p3m1k))

d1_rhs_u_dy_1_nxp4p01m4p3p1k = -(1.0_wp)*(1.0_wp+&
                    ((q(nx+4+0,1-4+3+1,indvars(5))/1.0_wp*q(nx+4+0,1-4+3+1,indvars(1)))**3.0_wp/((q(nx+4+0,1-4+3+1,indvars(5))/1.0_wp*q(nx+4+0,1-4+3+1,indvars(1)))**3.0_wp+&
                    param_float(13 + 5)**3.0_wp))*(q(nx+4+0,1-4+3+1,indvars(5))/1.0_wp*q(nx+4+0,1-4+3+1,indvars(1))))*param_float(1 + 5)*(qst(nx+4+0,1-4+3+1,indvarsst(11))*(d2_rhs_u_dydy_1_0_nxp4p01m4p3p1k)+&
...
rhs(nx+4+0,1-4+3,indvars(2)) =   -  ( q(nx+4+0,1-4+3,indvars(2))*(1.0_wp/(param_float(23 + 5)*(param_float(3 + 5))*q(nx+4+0,1-4+3,indvars(1))*((q(nx+4+0,1-4+3,indvars(4))-&
                    ...
                    0.5_wp*(q(nx+4+0,1-4+3,indvars(2))*q(nx+4+0,1-4+3,indvars(2))+&
                    q(nx+4+0,1-4+3,indvars(3))*q(nx+4+0,1-4+3,indvars(3)))))/q(nx+4+0,1-4+3,indvars(1)))**0.5)*((((param_float(23 + 5)*(param_float(3 + 5))*q(nx+4+0,1-4+3,indvars(1))*((q(nx+4+0,1-4+3,indvars(4))-&
                    0.5_wp*(q(nx+4+0,1-4+3,indvars(2))*q(nx+4+0,1-4+3,indvars(2))+&
                    q(nx+4+0,1-4+3,indvars(3))*q(nx+4+0,1-4+3,indvars(3)))))/q(nx+4+0,1-4+3,indvars(1)))**0.5+&
                    q(nx+4+0,1-4+3,indvars(2)))*((param_float(23 + 5)*(param_float(3 + 5))*q(nx+4+0,1-4+3,indvars(1))*((q(nx+4+0,1-4+3,indvars(4))-&
                    0.5_wp*(q(nx+4+0,1-4+3,indvars(2))*q(nx+4+0,1-4+3,indvars(2))+&
...
d1_rhs_v_dx_5_nxp4p0p01m4p3k = -(1.0_wp)*(1.0_wp+&
                    ((q(nx+4+0+0,1-4+3,indvars(5))/1.0_wp*q(nx+4+0+0,1-4+3,indvars(1)))**3.0_wp/((q(nx+4+0+0,1-4+3,indvars(5))/1.0_wp*q(nx+4+0+0,1-4+3,indvars(1)))**3.0_wp+&
                    param_float(13 + 5)**3.0_wp))*(q(nx+4+0+0,1-4+3,indvars(5))/1.0_wp*q(nx+4+0+0,1-4+3,indvars(1))))*param_float(1 + 5)*(qst(nx+4+0+0,1-4+3,indvarsst(11))*(d2_rhs_v_dxdy_5_0_nxp4p0p01m4p3k)+&
                    qst(nx+4+0+0,1-4+3,indvarsst(10))*(d2_rhs_v_dxdx_5_0_nxp4p0p01m4p3k))

d1_rhs_v_dx_5_nxp4p0m11m4p3k = -(1.0_wp)*(1.0_wp+&
                    ((q(nx+4+0-1,1-4+3,indvars(5))/1.0_wp*q(nx+4+0-1,1-4+3,indvars(1)))**3.0_wp/((q(nx+4+0-1,1-4+3,indvars(5))/1.0_wp*q(nx+4+0-1,1-4+3,indvars(1)))**3.0_wp+&
                    param_float(13 + 5)**3.0_wp))*(q(nx+4+0-1,1-4+3,indvars(5))/1.0_wp*q(nx+4+0-1,1-4+3,indvars(1))))*param_float(1 + 5)*(qst(nx+4+0-1,1-4+3,indvarsst(11))*(d2_rhs_v_dxdy_5_0_nxp4p0m11m4p3k)+&
                    qst(nx+4+0-1,1-4+3,indvarsst(10))*(d2_rhs_v_dxdx_5_0_nxp4p0m11m4p3k))

d1_rhs_v_dx_5_nxp4p0m21m4p3k = -(1.0_wp)*(1.0_wp+&
                    ((q(nx+4+0-2,1-4+3,indvars(5))/1.0_wp*q(nx+4+0-2,1-4+3,indvars(1)))**3.0_wp/((q(nx+4+0-2,1-4+3,indvars(5))/1.0_wp*q(nx+4+0-2,1-4+3,indvars(1)))**3.0_wp+&
                    param_float(13 + 5)**3.0_wp))*(q(nx+4+0-2,1-4+3,indvars(5))/1.0_wp*q(nx+4+0-2,1-4+3,indvars(1))))*param_float(1 + 5)*(qst(nx+4+0-2,1-4+3,indvarsst(11))*(d2_rhs_v_dxdy_5_0_nxp4p0m21m4p3k)+&
...
d1_rhs_v_dy_1_nxp4p01m4p3m1k = -(1.0_wp)*(1.0_wp+&
                    ((q(nx+4+0,1-4+3-1,indvars(5))/1.0_wp*q(nx+4+0,1-4+3-1,indvars(1)))**3.0_wp/((q(nx+4+0,1-4+3-1,indvars(5))/1.0_wp*q(nx+4+0,1-4+3-1,indvars(1)))**3.0_wp+&
                    param_float(13 + 5)**3.0_wp))*(q(nx+4+0,1-4+3-1,indvars(5))/1.0_wp*q(nx+4+0,1-4+3-1,indvars(1))))*param_float(1 + 5)*(2.0_wp*qst(nx+4+0,1-4+3-1,indvarsst(11))*(d2_rhs_v_dydy_1_0_nxp4p01m4p3m1k)-&
...
d1_rhs_v_dy_1_nxp4p01m4p3p1k = -(1.0_wp)*(1.0_wp+&
                    ((q(nx+4+0,1-4+3+1,indvars(5))/1.0_wp*q(nx+4+0,1-4+3+1,indvars(1)))**3.0_wp/((q(nx+4+0,1-4+3+1,indvars(5))/1.0_wp*q(nx+4+0,1-4+3+1,indvars(1)))**3.0_wp+&
                    param_float(13 + 5)**3.0_wp))*(q(nx+4+0,1-4+3+1,indvars(5))/1.0_wp*q(nx+4+0,1-4+3+1,indvars(1))))*param_float(1 + 5)*(2.0_wp*qst(nx+4+0,1-4+3+1,indvarsst(11))*(d2_rhs_v_dydy_1_0_nxp4p01m4p3p1k)-&
...
d2_rhs_nut_dydy_0_0_nxp4p01m4p3m3k_nxp4p01m4p3m3p0k = q(nx+4+0,1-4+3-3+0,indvars(5))

d2_rhs_nut_dydy_0_0_nxp4p01m4p3m3k_nxp4p01m4p3m3p1k = q(nx+4+0,1-4+3-3+1,indvars(5))

d2_rhs_nut_dydy_0_0_nxp4p01m4p3m3k_nxp4p01m4p3m3p2k = q(nx+4+0,1-4+3-3+2,indvars(5))

d2_rhs_nut_dydy_0_0_nxp4p01m4p3m3k = -&
          1.5_wp*d2_rhs_nut_dydy_0_0_nxp4p01m4p3m3k_nxp4p01m4p3m3p0k+&
          2.0_wp*d2_rhs_nut_dydy_0_0_nxp4p01m4p3m3k_nxp4p01m4p3m3p1k-&
          0.5_wp*d2_rhs_nut_dydy_0_0_nxp4p01m4p3m3k_nxp4p01m4p3m3p2k

d2_rhs_nut_dydy_0_0_nxp4p01m4p3m3k = d2_rhs_nut_dydy_0_0_nxp4p01m4p3m3k*param_float(2)

d2_rhs_nut_dydy_0_0_nxp4p01m4p3m2k_nxp4p01m4p3m2m1k = q(nx+4+0,1-4+3-2-1,indvars(5))

d2_rhs_nut_dydy_0_0_nxp4p01m4p3m2k_nxp4p01m4p3m2p1k = q(nx+4+0,1-4+3-2+1,indvars(5))

d2_rhs_nut_dydy_0_0_nxp4p01m4p3m2k = -&
          0.5_wp*d2_rhs_nut_dydy_0_0_nxp4p01m4p3m2k_nxp4p01m4p3m2m1k+&
          0.5_wp*d2_rhs_nut_dydy_0_0_nxp4p01m4p3m2k_nxp4p01m4p3m2p1k

d2_rhs_nut_dydy_0_0_nxp4p01m4p3m2k = d2_rhs_nut_dydy_0_0_nxp4p01m4p3m2k*param_float(2)

d2_rhs_nut_dydy_0_0_nxp4p01m4p3m1k_nxp4p01m4p3m1m1k = q(nx+4+0,1-4+3-1-1,indvars(5))

d2_rhs_nut_dydy_0_0_nxp4p01m4p3m1k_nxp4p01m4p3m1p1k = q(nx+4+0,1-4+3-1+1,indvars(5))

d2_rhs_nut_dydy_0_0_nxp4p01m4p3m1k = -&
          0.5_wp*d2_rhs_nut_dydy_0_0_nxp4p01m4p3m1k_nxp4p01m4p3m1m1k+&
          0.5_wp*d2_rhs_nut_dydy_0_0_nxp4p01m4p3m1k_nxp4p01m4p3m1p1k

d2_rhs_nut_dydy_0_0_nxp4p01m4p3m1k = d2_rhs_nut_dydy_0_0_nxp4p01m4p3m1k*param_float(2)

d2_rhs_nut_dydy_0_0_nxp4p01m4p3p1k_nxp4p01m4p3p1m1k = q(nx+4+0,1-4+3+1-1,indvars(5))

d2_rhs_nut_dydy_0_0_nxp4p01m4p3p1k_nxp4p01m4p3p1p1k = q(nx+4+0,1-4+3+1+1,indvars(5))

d2_rhs_nut_dydy_0_0_nxp4p01m4p3p1k = -&
          0.5_wp*d2_rhs_nut_dydy_0_0_nxp4p01m4p3p1k_nxp4p01m4p3p1m1k+&
          0.5_wp*d2_rhs_nut_dydy_0_0_nxp4p01m4p3p1k_nxp4p01m4p3p1p1k

d2_rhs_nut_dydy_0_0_nxp4p01m4p3p1k = d2_rhs_nut_dydy_0_0_nxp4p01m4p3p1k*param_float(2)

d2_rhs_nut_dydy_0_0_nxp4p01m4p3p2k_nxp4p01m4p3p2m1k = q(nx+4+0,1-4+3+2-1,indvars(5))

d2_rhs_nut_dydy_0_0_nxp4p01m4p3p2k_nxp4p01m4p3p2p1k = q(nx+4+0,1-4+3+2+1,indvars(5))

d2_rhs_nut_dydy_0_0_nxp4p01m4p3p2k = -&
          0.5_wp*d2_rhs_nut_dydy_0_0_nxp4p01m4p3p2k_nxp4p01m4p3p2m1k+&
          0.5_wp*d2_rhs_nut_dydy_0_0_nxp4p01m4p3p2k_nxp4p01m4p3p2p1k

d2_rhs_nut_dydy_0_0_nxp4p01m4p3p2k = d2_rhs_nut_dydy_0_0_nxp4p01m4p3p2k*param_float(2)

d2_rhs_nut_dydy_0_0_nxp4p01m4p3p3k_nxp4p01m4p3p3m1k = q(nx+4+0,1-4+3+3-1,indvars(5))

d2_rhs_nut_dydy_0_0_nxp4p01m4p3p3k_nxp4p01m4p3p3p1k = q(nx+4+0,1-4+3+3+1,indvars(5))

d2_rhs_nut_dydy_0_0_nxp4p01m4p3p3k = -&
          0.5_wp*d2_rhs_nut_dydy_0_0_nxp4p01m4p3p3k_nxp4p01m4p3p3m1k+&
          0.5_wp*d2_rhs_nut_dydy_0_0_nxp4p01m4p3p3k_nxp4p01m4p3p3p1k

d2_rhs_nut_dydy_0_0_nxp4p01m4p3p3k = d2_rhs_nut_dydy_0_0_nxp4p01m4p3p3k*param_float(2)

d1_rhs_nut_dy_1_nxp4p01m4p3m1k = q(nx+4+0,1-4+3-1,indvars(1))*q(nx+4+0,1-4+3-1,indvars(5))

d1_rhs_nut_dy_1_nxp4p01m4p3p1k = q(nx+4+0,1-4+3+1,indvars(1))*q(nx+4+0,1-4+3+1,indvars(5))

d1_rhs_nut_dy_1_nxp4p01m4p3k = -&
          0.5_wp*d1_rhs_nut_dy_1_nxp4p01m4p3m1k+&
          0.5_wp*d1_rhs_nut_dy_1_nxp4p01m4p3p1k

d1_rhs_nut_dy_1_nxp4p01m4p3k = d1_rhs_nut_dy_1_nxp4p01m4p3k*param_float(2)

d1_rhs_nut_dy_2_nxp4p01m4p3m1k = q(nx+4+0,1-4+3-1,indvars(5))

d1_rhs_nut_dy_2_nxp4p01m4p3p1k = q(nx+4+0,1-4+3+1,indvars(5))

d1_rhs_nut_dy_2_nxp4p01m4p3k = -&
          0.5_wp*d1_rhs_nut_dy_2_nxp4p01m4p3m1k+&
          0.5_wp*d1_rhs_nut_dy_2_nxp4p01m4p3p1k

d1_rhs_nut_dy_2_nxp4p01m4p3k = d1_rhs_nut_dy_2_nxp4p01m4p3k*param_float(2)

d1_rhs_nut_dy_0_nxp4p01m4p3m1k = q(nx+4+0,1-4+3-1,indvars(1))*q(nx+4+0,1-4+3-1,indvars(2))*q(nx+4+0,1-4+3-1,indvars(5))-&
                    (1.0_wp)*(1.0_wp+&
                    ((q(nx+4+0,1-4+3-1,indvars(5))/1.0_wp*q(nx+4+0,1-4+3-1,indvars(1)))**3.0_wp/((q(nx+4+0,1-4+3-1,indvars(5))/1.0_wp*q(nx+4+0,1-4+3-1,indvars(1)))**3.0_wp+&
                    param_float(13 + 5)**3.0_wp))*(q(nx+4+0,1-4+3-1,indvars(5))/1.0_wp*q(nx+4+0,1-4+3-1,indvars(1))))*param_float(1 + 5)*param_float(18 + 5)*qst(nx+4+0,1-4+3-1,indvarsst(11))*(d2_rhs_nut_dydy_0_0_nxp4p01m4p3m1k)

d1_rhs_nut_dy_0_nxp4p01m4p3p1k = q(nx+4+0,1-4+3+1,indvars(1))*q(nx+4+0,1-4+3+1,indvars(2))*q(nx+4+0,1-4+3+1,indvars(5))-&
                    (1.0_wp)*(1.0_wp+&
                    ((q(nx+4+0,1-4+3+1,indvars(5))/1.0_wp*q(nx+4+0,1-4+3+1,indvars(1)))**3.0_wp/((q(nx+4+0,1-4+3+1,indvars(5))/1.0_wp*q(nx+4+0,1-4+3+1,indvars(1)))**3.0_wp+&
                    param_float(13 + 5)**3.0_wp))*(q(nx+4+0,1-4+3+1,indvars(5))/1.0_wp*q(nx+4+0,1-4+3+1,indvars(1))))*param_float(1 + 5)*param_float(18 + 5)*qst(nx+4+0,1-4+3+1,indvarsst(11))*(d2_rhs_nut_dydy_0_0_nxp4p01m4p3p1k)

d1_rhs_nut_dy_0_nxp4p01m4p3k = -&
          0.5_wp*d1_rhs_nut_dy_0_nxp4p01m4p3m1k+&
          0.5_wp*d1_rhs_nut_dy_0_nxp4p01m4p3p1k

d1_rhs_nut_dy_0_nxp4p01m4p3k = d1_rhs_nut_dy_0_nxp4p01m4p3k*param_float(2)
...
rhs(nx+4+0,1-4+3,indvars(5)) =   -  ( (d1_rhs_nut_dy_0_nxp4p01m4p3k)*qst(nx+4+0,1-4+3,indvarsst(11))+&
                    -&
                    param_float(1 + 5)*param_float(7 + 5)*param_float(18 + 5)*((qst(nx+4+0,1-4+3,indvarsst(11)))**2*(d1_rhs_nut_dy_1_nxp4p01m4p3k)*(d1_rhs_nut_dy_2_nxp4p01m4p3k))-&
                    param_float(6 + 5)*(1-&
                    ...
                    param_float(17 + 5)*(q(nx+4+0,1-4+3,indvars(5))/1.0_wp*q(nx+4+0,1-4+3,indvars(1)))**2.0_wp)))*q(nx+4+0,1-4+3,indvars(1))*q(nx+4+0,1-4+3,indvars(5))**2/qst(nx+4+0,1-4+3,indvarsst(2))**2 ) 
...
!$OMP END DO
 ...
 end subroutine boundaryScheme_edges_PhyBC_Out_surf_rhs_imax_j1_0_3
