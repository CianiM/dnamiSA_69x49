...
qst(nx+4+0,1-4+0,indvarsst(1)) =  qst(nx+4+0,1-4+0,indvarsst(1))
...
qst(nx+4+0,1-4+0,indvarsst(2)) =  qst(nx+4+0,1-4+0,indvarsst(2))
...
qst(nx+4+0,1-4+0,indvarsst(3)) =  qst(nx+4+0,1-4+0,indvarsst(3))
...
qst(nx+4+0,1-4+0,indvarsst(5)) =  ((sign(1.0_wp,qst(nx+4+0,1-4+0,indvarsst(3)))-&
                    1.0_wp)/(-&
                    2.0_wp))
...
d1_detady_dy_0_nxp4p01m4p0p0k = qst(nx+4+0,1-4+0+0,indvarsst(2))

d1_detady_dy_0_nxp4p01m4p0p1k = qst(nx+4+0,1-4+0+1,indvarsst(2))

d1_detady_dy_0_nxp4p01m4p0p2k = qst(nx+4+0,1-4+0+2,indvarsst(2))

d1_detady_dy_0_nxp4p01m4p0k = -&
          1.5_wp*d1_detady_dy_0_nxp4p01m4p0p0k+&
          2.0_wp*d1_detady_dy_0_nxp4p01m4p0p1k-&
          0.5_wp*d1_detady_dy_0_nxp4p01m4p0p2k

d1_detady_dy_0_nxp4p01m4p0k = d1_detady_dy_0_nxp4p01m4p0k*param_float(2)
...
qst(nx+4+0,1-4+0,indvarsst(6)) =  d1_detady_dy_0_nxp4p01m4p0k
...
d1_dksidy_dy_0_nxp4p01m4p0p0k = qst(nx+4+0,1-4+0+0,indvarsst(3))

d1_dksidy_dy_0_nxp4p01m4p0p1k = qst(nx+4+0,1-4+0+1,indvarsst(3))

d1_dksidy_dy_0_nxp4p01m4p0p2k = qst(nx+4+0,1-4+0+2,indvarsst(3))

d1_dksidy_dy_0_nxp4p01m4p0k = -&
          1.5_wp*d1_dksidy_dy_0_nxp4p01m4p0p0k+&
          2.0_wp*d1_dksidy_dy_0_nxp4p01m4p0p1k-&
          0.5_wp*d1_dksidy_dy_0_nxp4p01m4p0p2k

d1_dksidy_dy_0_nxp4p01m4p0k = d1_dksidy_dy_0_nxp4p01m4p0k*param_float(2)
...
qst(nx+4+0,1-4+0,indvarsst(7)) =  d1_dksidy_dy_0_nxp4p01m4p0k
...
d1_detadx_dx_0_nxp4p0p01m4p0k = qst(nx+4+0+0,1-4+0,indvarsst(2))

d1_detadx_dx_0_nxp4p0m11m4p0k = qst(nx+4+0-1,1-4+0,indvarsst(2))

d1_detadx_dx_0_nxp4p0m21m4p0k = qst(nx+4+0-2,1-4+0,indvarsst(2))

d1_detadx_dx_0_nxp4p01m4p0k = 1.5_wp*d1_detadx_dx_0_nxp4p0p01m4p0k-&
          2.0_wp*d1_detadx_dx_0_nxp4p0m11m4p0k+&
          0.5_wp*d1_detadx_dx_0_nxp4p0m21m4p0k

d1_detadx_dx_0_nxp4p01m4p0k = d1_detadx_dx_0_nxp4p01m4p0k*param_float(1)
...
qst(nx+4+0,1-4+0,indvarsst(8)) =  d1_detadx_dx_0_nxp4p01m4p0k
...
d1_dksidx_dx_0_nxp4p0p01m4p0k = qst(nx+4+0+0,1-4+0,indvarsst(3))

d1_dksidx_dx_0_nxp4p0m11m4p0k = qst(nx+4+0-1,1-4+0,indvarsst(3))

d1_dksidx_dx_0_nxp4p0m21m4p0k = qst(nx+4+0-2,1-4+0,indvarsst(3))

d1_dksidx_dx_0_nxp4p01m4p0k = 1.5_wp*d1_dksidx_dx_0_nxp4p0p01m4p0k-&
          2.0_wp*d1_dksidx_dx_0_nxp4p0m11m4p0k+&
          0.5_wp*d1_dksidx_dx_0_nxp4p0m21m4p0k

d1_dksidx_dx_0_nxp4p01m4p0k = d1_dksidx_dx_0_nxp4p01m4p0k*param_float(1)
...
qst(nx+4+0,1-4+0,indvarsst(9)) =  (d1_dksidx_dx_0_nxp4p01m4p0k)
...
qst(nx+4+0,1-4+0,indvarsst(10)) =  1.0_wp/(qst(nx+4+0,1-4+0,indvarsst(9)))
...
qst(nx+4+0,1-4+0,indvarsst(11)) =  1.0_wp/(qst(nx+4+0,1-4+0,indvarsst(6)))
