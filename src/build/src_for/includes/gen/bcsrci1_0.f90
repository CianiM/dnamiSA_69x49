...
d1_dif_nut_dx_0_1m2p0p0jk = -(param_float(1 + 5)*(1.0_wp+&
                    (q(1-2+0+0,j,indvars(5))/1.0_wp))*param_float(18 + 5)*qst(1-2+0+0,j,indvarsst(10))*(d2_dif_nut_dxdx_0_0_1m2p0p0jk))

d1_dif_nut_dx_0_1m2p0p1jk = -(param_float(1 + 5)*(1.0_wp+&
                    (q(1-2+0+1,j,indvars(5))/1.0_wp))*param_float(18 + 5)*qst(1-2+0+1,j,indvarsst(10))*(d2_dif_nut_dxdx_0_0_1m2p0p1jk))

d1_dif_nut_dx_0_1m2p0p2jk = -(param_float(1 + 5)*(1.0_wp+&
                    (q(1-2+0+2,j,indvars(5))/1.0_wp))*param_float(18 + 5)*qst(1-2+0+2,j,indvarsst(10))*(d2_dif_nut_dxdx_0_0_1m2p0p2jk))
...
d1_dif_nut_dy_0_1m2p0jm1k = -(param_float(1 + 5)*(1.0_wp+&
                    (q(1-2+0,j-1,indvars(5))/1.0_wp))*param_float(18 + 5)*qst(1-2+0,j-1,indvarsst(11))*(d2_dif_nut_dydy_0_0_1m2p0jm1k))

d1_dif_nut_dy_0_1m2p0jp1k = -(param_float(1 + 5)*(1.0_wp+&
                    (q(1-2+0,j+1,indvars(5))/1.0_wp))*param_float(18 + 5)*qst(1-2+0,j+1,indvarsst(11))*(d2_dif_nut_dydy_0_0_1m2p0jp1k))
