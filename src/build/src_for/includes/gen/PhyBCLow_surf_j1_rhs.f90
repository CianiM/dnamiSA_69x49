...
rhs(i,1-4+0,indvars(1)) =   -  ( (qst(i,1-4+0,indvarsst(10))*(d1_rhs_rho_dx_0_i1m4p0k))*qst(i,1-4+0,indvarsst(5))+&
                    (q(i,1-4+0,indvars(1))*(d1_rhs_rho_dy_0_i1m4p0k)*qst(i,1-4+0,indvarsst(11)))*dabs(1-&
...
d1_rhs_u_dx_0_im11m4p0k = -4.0_wp/3.0_wp*((1+&
                    ...
                    param_float(21 + 5))*((q(i-1,1-4+0,indvars(4))-&
                    0.5_wp*(q(i-1,1-4+0,indvars(2))*q(i-1,1-4+0,indvars(2))+&
                    q(i-1,1-4+0,indvars(3))*q(i-1,1-4+0,indvars(3)))))/param_float(4 + 5)**1.5*q(i-1,1-4+0,indvars(1))))*param_float(1 + 5)*(d2_rhs_u_dxdx_0_0_im11m4p0k)*qst(i-1,1-4+0,indvarsst(10))

d1_rhs_u_dx_0_ip11m4p0k = -4.0_wp/3.0_wp*((1+&
                    param_float(21 + 5))/(((q(i+1,1-4+0,indvars(4))-&
                    0.5_wp*(q(i+1,1-4+0,indvars(2))*q(i+1,1-4+0,indvars(2))+&
                    q(i+1,1-4+0,indvars(3))*q(i+1,1-4+0,indvars(3)))))/param_float(4 + 5)+&
                    param_float(21 + 5))*((q(i+1,1-4+0,indvars(4))-&
                    ...
                    param_float(21 + 5))*((q(i+1,1-4+0,indvars(4))-&
                    0.5_wp*(q(i+1,1-4+0,indvars(2))*q(i+1,1-4+0,indvars(2))+&
                    q(i+1,1-4+0,indvars(3))*q(i+1,1-4+0,indvars(3)))))/param_float(4 + 5)**1.5*q(i+1,1-4+0,indvars(1))))*param_float(1 + 5)*(d2_rhs_u_dxdx_0_0_ip11m4p0k)*qst(i+1,1-4+0,indvarsst(10))
...
d1_rhs_v_dx_0_im11m4p0k = -((1+&
                    ...
                    param_float(21 + 5))*((q(i-1,1-4+0,indvars(4))-&
                    0.5_wp*(q(i-1,1-4+0,indvars(2))*q(i-1,1-4+0,indvars(2))+&
                    q(i-1,1-4+0,indvars(3))*q(i-1,1-4+0,indvars(3)))))/param_float(4 + 5)**1.5*q(i-1,1-4+0,indvars(1))))*param_float(1 + 5)*(d2_rhs_v_dxdx_0_0_im11m4p0k)*qst(i-1,1-4+0,indvarsst(10))

d1_rhs_v_dx_0_ip11m4p0k = -((1+&
                    param_float(21 + 5))/(((q(i+1,1-4+0,indvars(4))-&
                    0.5_wp*(q(i+1,1-4+0,indvars(2))*q(i+1,1-4+0,indvars(2))+&
                    q(i+1,1-4+0,indvars(3))*q(i+1,1-4+0,indvars(3)))))/param_float(4 + 5)+&
                    param_float(21 + 5))*((q(i+1,1-4+0,indvars(4))-&
                    ...
                    param_float(21 + 5))*((q(i+1,1-4+0,indvars(4))-&
                    0.5_wp*(q(i+1,1-4+0,indvars(2))*q(i+1,1-4+0,indvars(2))+&
                    q(i+1,1-4+0,indvars(3))*q(i+1,1-4+0,indvars(3)))))/param_float(4 + 5)**1.5*q(i+1,1-4+0,indvars(1))))*param_float(1 + 5)*(d2_rhs_v_dxdx_0_0_ip11m4p0k)*qst(i+1,1-4+0,indvarsst(10))
...
d1_rhs_et_dx_0_im11m4p0k = -4.0_wp/3.0_wp*((1+&
                    param_float(21 + 5))/(((q(i-1,1-4+0,indvars(4))-&
                    0.5_wp*(q(i-1,1-4+0,indvars(2))*q(i-1,1-4+0,indvars(2))+&
                    q(i-1,1-4+0,indvars(3))*q(i-1,1-4+0,indvars(3)))))/param_float(4 + 5)+&
                    param_float(21 + 5))*((q(i-1,1-4+0,indvars(4))-&
                    ...
                    param_float(21 + 5))*((q(i-1,1-4+0,indvars(4))-&
                    0.5_wp*(q(i-1,1-4+0,indvars(2))*q(i-1,1-4+0,indvars(2))+&
                    q(i-1,1-4+0,indvars(3))*q(i-1,1-4+0,indvars(3)))))/param_float(4 + 5)**1.5*q(i-1,1-4+0,indvars(1))))*param_float(1 + 5)*(d2_rhs_u_dxdx_0_0_im11m4p0k)*qst(i-1,1-4+0,indvarsst(10))*q(i-1,1-4+0,indvars(2))-&
                    ((1+&
                    param_float(21 + 5))/(((q(i-1,1-4+0,indvars(4))-&
                    0.5_wp*(q(i-1,1-4+0,indvars(2))*q(i-1,1-4+0,indvars(2))+&
                    q(i-1,1-4+0,indvars(3))*q(i-1,1-4+0,indvars(3)))))/param_float(4 + 5)+&
                    ...
                    param_float(21 + 5))*((q(i-1,1-4+0,indvars(4))-&
                    0.5_wp*(q(i-1,1-4+0,indvars(2))*q(i-1,1-4+0,indvars(2))+&
                    q(i-1,1-4+0,indvars(3))*q(i-1,1-4+0,indvars(3)))))/param_float(4 + 5)**1.5*q(i-1,1-4+0,indvars(1))))*param_float(1 + 5)*(d2_rhs_v_dxdx_0_0_im11m4p0k)*qst(i-1,1-4+0,indvarsst(10))*q(i-1,1-4+0,indvars(3))-&
                    param_float(2 + 5)*(d2_rhs_et_dxdx_0_2_im11m4p0k)*qst(i-1,1-4+0,indvarsst(10))

d1_rhs_et_dx_0_ip11m4p0k = -4.0_wp/3.0_wp*((1+&
                    param_float(21 + 5))/(((q(i+1,1-4+0,indvars(4))-&
                    0.5_wp*(q(i+1,1-4+0,indvars(2))*q(i+1,1-4+0,indvars(2))+&
                    q(i+1,1-4+0,indvars(3))*q(i+1,1-4+0,indvars(3)))))/param_float(4 + 5)+&
                    param_float(21 + 5))*((q(i+1,1-4+0,indvars(4))-&
                    ...
                    param_float(21 + 5))*((q(i+1,1-4+0,indvars(4))-&
                    0.5_wp*(q(i+1,1-4+0,indvars(2))*q(i+1,1-4+0,indvars(2))+&
                    q(i+1,1-4+0,indvars(3))*q(i+1,1-4+0,indvars(3)))))/param_float(4 + 5)**1.5*q(i+1,1-4+0,indvars(1))))*param_float(1 + 5)*(d2_rhs_u_dxdx_0_0_ip11m4p0k)*qst(i+1,1-4+0,indvarsst(10))*q(i+1,1-4+0,indvars(2))-&
                    ((1+&
                    param_float(21 + 5))/(((q(i+1,1-4+0,indvars(4))-&
                    0.5_wp*(q(i+1,1-4+0,indvars(2))*q(i+1,1-4+0,indvars(2))+&
                    q(i+1,1-4+0,indvars(3))*q(i+1,1-4+0,indvars(3)))))/param_float(4 + 5)+&
                    ...
                    param_float(21 + 5))*((q(i+1,1-4+0,indvars(4))-&
                    0.5_wp*(q(i+1,1-4+0,indvars(2))*q(i+1,1-4+0,indvars(2))+&
                    q(i+1,1-4+0,indvars(3))*q(i+1,1-4+0,indvars(3)))))/param_float(4 + 5)**1.5*q(i+1,1-4+0,indvars(1))))*param_float(1 + 5)*(d2_rhs_v_dxdx_0_0_ip11m4p0k)*qst(i+1,1-4+0,indvarsst(10))*q(i+1,1-4+0,indvars(3))-&
...
rhs(i,1-4+0,indvars(4)) =   -  ( (qst(i,1-4+0,indvarsst(10))*(d1_rhs_et_dx_0_i1m4p0k)+&
                    ...
                    param_float(21 + 5))*((q(i,1-4+0,indvars(4))-&
                    0.5_wp*(q(i,1-4+0,indvars(2))*q(i,1-4+0,indvars(2))+&
                    q(i,1-4+0,indvars(3))*q(i,1-4+0,indvars(3)))))/param_float(4 + 5)**1.5*q(i,1-4+0,indvars(1))))*param_float(1 + 5)*(d1_rhs_et_dy_0_i1m4p0k)*(d1_rhs_et_dy_0_i1m4p0k)*qst(i,1-4+0,indvarsst(11))**2-&
                    4.0_wp/3.0_wp*((1+&
                    param_float(21 + 5))/(((q(i,1-4+0,indvars(4))-&
                    0.5_wp*(q(i,1-4+0,indvars(2))*q(i,1-4+0,indvars(2))+&
                    q(i,1-4+0,indvars(3))*q(i,1-4+0,indvars(3)))))/param_float(4 + 5)+&
                    ...
                    param_float(21 + 5))*((q(i,1-4+0,indvars(4))-&
                    0.5_wp*(q(i,1-4+0,indvars(2))*q(i,1-4+0,indvars(2))+&
                    q(i,1-4+0,indvars(3))*q(i,1-4+0,indvars(3)))))/param_float(4 + 5)**1.5*q(i,1-4+0,indvars(1))))*param_float(1 + 5)*(d1_rhs_rho_dy_0_i1m4p0k)*(d1_rhs_rho_dy_0_i1m4p0k)*qst(i,1-4+0,indvarsst(11))**2-&
                    ...
                    0.5_wp*(q(i,1-4+0,indvars(2))*q(i,1-4+0,indvars(2))+&
                    q(i,1-4+0,indvars(3))*q(i,1-4+0,indvars(3))))))*(d1_rhs_rho_dy_0_i1m4p0k)*qst(i,1-4+0,indvarsst(11)))*dabs(1-&
                    qst(i,1-4+0,indvarsst(5))) ) 
...
d1_rhs_nut_dx_2_im11m4p0k = q(i-1,1-4+0,indvars(1))*q(i-1,1-4+0,indvars(2))*q(i-1,1-4+0,indvars(5))-&
                    ...
                    param_float(21 + 5))*((q(i-1,1-4+0,indvars(4))-&
                    0.5_wp*(q(i-1,1-4+0,indvars(2))*q(i-1,1-4+0,indvars(2))+&
                    q(i-1,1-4+0,indvars(3))*q(i-1,1-4+0,indvars(3)))))/param_float(4 + 5)**1.5+&
