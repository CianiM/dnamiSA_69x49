...
d1_conv_nut_dx_0_nxp4m3m1jk = q(nx+4-3-1,j,indvars(1))*q(nx+4-3-1,j,indvars(2))*q(nx+4-3-1,j,indvars(5))-&
                    (1.0_wp)*(1.0_wp+&
                    ((q(nx+4-3-1,j,indvars(5))/1.0_wp*q(nx+4-3-1,j,indvars(1)))**3.0_wp/((q(nx+4-3-1,j,indvars(5))/1.0_wp*q(nx+4-3-1,j,indvars(1)))**3.0_wp+&
                    param_float(13 + 5)**3.0_wp))*(q(nx+4-3-1,j,indvars(5))/1.0_wp*q(nx+4-3-1,j,indvars(1))))*param_float(1 + 5)*param_float(18 + 5)*qst(nx+4-3-1,j,indvarsst(10))*(d2_conv_nut_dxdx_0_0_nxp4m3m1jk)

d1_conv_nut_dx_0_nxp4m3p1jk = q(nx+4-3+1,j,indvars(1))*q(nx+4-3+1,j,indvars(2))*q(nx+4-3+1,j,indvars(5))-&
                    (1.0_wp)*(1.0_wp+&
                    ((q(nx+4-3+1,j,indvars(5))/1.0_wp*q(nx+4-3+1,j,indvars(1)))**3.0_wp/((q(nx+4-3+1,j,indvars(5))/1.0_wp*q(nx+4-3+1,j,indvars(1)))**3.0_wp+&
                    param_float(13 + 5)**3.0_wp))*(q(nx+4-3+1,j,indvars(5))/1.0_wp*q(nx+4-3+1,j,indvars(1))))*param_float(1 + 5)*param_float(18 + 5)*qst(nx+4-3+1,j,indvarsst(10))*(d2_conv_nut_dxdx_0_0_nxp4m3p1jk)
...
d1_conv_nut_dy_0_nxp4m3jm1k = q(nx+4-3,j-1,indvars(1))*q(nx+4-3,j-1,indvars(3))*q(nx+4-3,j-1,indvars(5))-&
                    (1.0_wp)*(1.0_wp+&
                    ((q(nx+4-3,j-1,indvars(5))/1.0_wp*q(nx+4-3,j-1,indvars(1)))**3.0_wp/((q(nx+4-3,j-1,indvars(5))/1.0_wp*q(nx+4-3,j-1,indvars(1)))**3.0_wp+&
                    param_float(13 + 5)**3.0_wp))*(q(nx+4-3,j-1,indvars(5))/1.0_wp*q(nx+4-3,j-1,indvars(1))))*param_float(1 + 5)*param_float(18 + 5)*qst(nx+4-3,j-1,indvarsst(11))*(d2_conv_nut_dydy_0_0_nxp4m3jm1k)

d1_conv_nut_dy_0_nxp4m3jp1k = q(nx+4-3,j+1,indvars(1))*q(nx+4-3,j+1,indvars(3))*q(nx+4-3,j+1,indvars(5))-&
                    (1.0_wp)*(1.0_wp+&
                    ((q(nx+4-3,j+1,indvars(5))/1.0_wp*q(nx+4-3,j+1,indvars(1)))**3.0_wp/((q(nx+4-3,j+1,indvars(5))/1.0_wp*q(nx+4-3,j+1,indvars(1)))**3.0_wp+&
                    param_float(13 + 5)**3.0_wp))*(q(nx+4-3,j+1,indvars(5))/1.0_wp*q(nx+4-3,j+1,indvars(1))))*param_float(1 + 5)*param_float(18 + 5)*qst(nx+4-3,j+1,indvarsst(11))*(d2_conv_nut_dydy_0_0_nxp4m3jp1k)
...
d1_dif_rhou_dx_0_nxp4m3m1jk = -(1.0_wp)*(1.0_wp+&
                    ((q(nx+4-3-1,j,indvars(5))/1.0_wp*q(nx+4-3-1,j,indvars(1)))**3.0_wp/((q(nx+4-3-1,j,indvars(5))/1.0_wp*q(nx+4-3-1,j,indvars(1)))**3.0_wp+&
                    param_float(13 + 5)**3.0_wp))*(q(nx+4-3-1,j,indvars(5))/1.0_wp*q(nx+4-3-1,j,indvars(1))))*param_float(1 + 5)*(2.0_wp*qst(nx+4-3-1,j,indvarsst(10))*(d2_dif_rhou_dxdx_0_0_nxp4m3m1jk)-&
...
d1_dif_rhou_dx_0_nxp4m3p1jk = -(1.0_wp)*(1.0_wp+&
                    ((q(nx+4-3+1,j,indvars(5))/1.0_wp*q(nx+4-3+1,j,indvars(1)))**3.0_wp/((q(nx+4-3+1,j,indvars(5))/1.0_wp*q(nx+4-3+1,j,indvars(1)))**3.0_wp+&
                    param_float(13 + 5)**3.0_wp))*(q(nx+4-3+1,j,indvars(5))/1.0_wp*q(nx+4-3+1,j,indvars(1))))*param_float(1 + 5)*(2.0_wp*qst(nx+4-3+1,j,indvarsst(10))*(d2_dif_rhou_dxdx_0_0_nxp4m3p1jk)-&
...
d1_dif_rhou_dy_0_nxp4m3jm1k = -(1.0_wp)*(1.0_wp+&
                    ((q(nx+4-3,j-1,indvars(5))/1.0_wp*q(nx+4-3,j-1,indvars(1)))**3.0_wp/((q(nx+4-3,j-1,indvars(5))/1.0_wp*q(nx+4-3,j-1,indvars(1)))**3.0_wp+&
                    param_float(13 + 5)**3.0_wp))*(q(nx+4-3,j-1,indvars(5))/1.0_wp*q(nx+4-3,j-1,indvars(1))))*param_float(1 + 5)*(qst(nx+4-3,j-1,indvarsst(11))*(d2_dif_rhou_dydy_0_0_nxp4m3jm1k)+&
                    qst(nx+4-3,j-1,indvarsst(10))*(d2_dif_rhou_dydx_0_0_nxp4m3jm1k))

d1_dif_rhou_dy_0_nxp4m3jp1k = -(1.0_wp)*(1.0_wp+&
                    ((q(nx+4-3,j+1,indvars(5))/1.0_wp*q(nx+4-3,j+1,indvars(1)))**3.0_wp/((q(nx+4-3,j+1,indvars(5))/1.0_wp*q(nx+4-3,j+1,indvars(1)))**3.0_wp+&
                    param_float(13 + 5)**3.0_wp))*(q(nx+4-3,j+1,indvars(5))/1.0_wp*q(nx+4-3,j+1,indvars(1))))*param_float(1 + 5)*(qst(nx+4-3,j+1,indvarsst(11))*(d2_dif_rhou_dydy_0_0_nxp4m3jp1k)+&
...
d1_dif_rhov_dx_0_nxp4m3m1jk = -(1.0_wp)*(1.0_wp+&
                    ((q(nx+4-3-1,j,indvars(5))/1.0_wp*q(nx+4-3-1,j,indvars(1)))**3.0_wp/((q(nx+4-3-1,j,indvars(5))/1.0_wp*q(nx+4-3-1,j,indvars(1)))**3.0_wp+&
                    param_float(13 + 5)**3.0_wp))*(q(nx+4-3-1,j,indvars(5))/1.0_wp*q(nx+4-3-1,j,indvars(1))))*param_float(1 + 5)*(qst(nx+4-3-1,j,indvarsst(11))*(d2_dif_rhov_dxdy_0_0_nxp4m3m1jk)+&
                    qst(nx+4-3-1,j,indvarsst(10))*(d2_dif_rhov_dxdx_0_0_nxp4m3m1jk))

d1_dif_rhov_dx_0_nxp4m3p1jk = -(1.0_wp)*(1.0_wp+&
                    ((q(nx+4-3+1,j,indvars(5))/1.0_wp*q(nx+4-3+1,j,indvars(1)))**3.0_wp/((q(nx+4-3+1,j,indvars(5))/1.0_wp*q(nx+4-3+1,j,indvars(1)))**3.0_wp+&
                    param_float(13 + 5)**3.0_wp))*(q(nx+4-3+1,j,indvars(5))/1.0_wp*q(nx+4-3+1,j,indvars(1))))*param_float(1 + 5)*(qst(nx+4-3+1,j,indvarsst(11))*(d2_dif_rhov_dxdy_0_0_nxp4m3p1jk)+&
...
d1_dif_rhov_dy_0_nxp4m3jm1k = -(1.0_wp)*(1.0_wp+&
                    ((q(nx+4-3,j-1,indvars(5))/1.0_wp*q(nx+4-3,j-1,indvars(1)))**3.0_wp/((q(nx+4-3,j-1,indvars(5))/1.0_wp*q(nx+4-3,j-1,indvars(1)))**3.0_wp+&
                    param_float(13 + 5)**3.0_wp))*(q(nx+4-3,j-1,indvars(5))/1.0_wp*q(nx+4-3,j-1,indvars(1))))*param_float(1 + 5)*(2.0_wp*qst(nx+4-3,j-1,indvarsst(11))*(d2_dif_rhov_dydy_0_0_nxp4m3jm1k)-&
...
d1_dif_rhov_dy_0_nxp4m3jp1k = -(1.0_wp)*(1.0_wp+&
                    ((q(nx+4-3,j+1,indvars(5))/1.0_wp*q(nx+4-3,j+1,indvars(1)))**3.0_wp/((q(nx+4-3,j+1,indvars(5))/1.0_wp*q(nx+4-3,j+1,indvars(1)))**3.0_wp+&
                    param_float(13 + 5)**3.0_wp))*(q(nx+4-3,j+1,indvars(5))/1.0_wp*q(nx+4-3,j+1,indvars(1))))*param_float(1 + 5)*(2.0_wp*qst(nx+4-3,j+1,indvarsst(11))*(d2_dif_rhov_dydy_0_0_nxp4m3jp1k)-&
...
d1_dif_et_dx_0_nxp4m3m1jk = -param_float(2 + 5)*qst(nx+4-3-1,j,indvarsst(10))*(d2_dif_et_dxdx_0_0_nxp4m3m1jk)-&
                    q(nx+4-3-1,j,indvars(2))*((1.0_wp)*(1.0_wp+&
                    ((q(nx+4-3-1,j,indvars(5))/1.0_wp*q(nx+4-3-1,j,indvars(1)))**3.0_wp/((q(nx+4-3-1,j,indvars(5))/1.0_wp*q(nx+4-3-1,j,indvars(1)))**3.0_wp+&
                    param_float(13 + 5)**3.0_wp))*(q(nx+4-3-1,j,indvars(5))/1.0_wp*q(nx+4-3-1,j,indvars(1))))*param_float(1 + 5)*(2.0_wp*qst(nx+4-3-1,j,indvarsst(10))*(d2_dif_rhou_dxdx_0_0_nxp4m3m1jk)-&
                    2.0_wp/3.0_wp*(qst(nx+4-3-1,j,indvarsst(10))*(d2_dif_rhou_dxdx_0_0_nxp4m3m1jk)+&
                    qst(nx+4-3-1,j,indvarsst(11))*(d2_dif_rhou_dxdy_0_0_nxp4m3m1jk))))-&
                    q(nx+4-3-1,j,indvars(3))*((1.0_wp)*(1.0_wp+&
                    ((q(nx+4-3-1,j,indvars(5))/1.0_wp*q(nx+4-3-1,j,indvars(1)))**3.0_wp/((q(nx+4-3-1,j,indvars(5))/1.0_wp*q(nx+4-3-1,j,indvars(1)))**3.0_wp+&
                    param_float(13 + 5)**3.0_wp))*(q(nx+4-3-1,j,indvars(5))/1.0_wp*q(nx+4-3-1,j,indvars(1))))*param_float(1 + 5)*(qst(nx+4-3-1,j,indvarsst(11))*(d2_dif_rhov_dxdy_0_0_nxp4m3m1jk)+&
                    qst(nx+4-3-1,j,indvarsst(10))*(d2_dif_rhov_dxdx_0_0_nxp4m3m1jk)))
...
d1_dif_et_dy_0_nxp4m3jm1k = -param_float(2 + 5)*qst(nx+4-3,j-1,indvarsst(11))*(d2_dif_et_dydy_0_0_nxp4m3jm1k)-&
                    q(nx+4-3,j-1,indvars(2))*((1.0_wp)*(1.0_wp+&
                    ((q(nx+4-3,j-1,indvars(5))/1.0_wp*q(nx+4-3,j-1,indvars(1)))**3.0_wp/((q(nx+4-3,j-1,indvars(5))/1.0_wp*q(nx+4-3,j-1,indvars(1)))**3.0_wp+&
                    param_float(13 + 5)**3.0_wp))*(q(nx+4-3,j-1,indvars(5))/1.0_wp*q(nx+4-3,j-1,indvars(1))))*param_float(1 + 5)*(qst(nx+4-3,j-1,indvarsst(11))*(d2_dif_rhou_dydy_0_0_nxp4m3jm1k)+&
                    qst(nx+4-3,j-1,indvarsst(10))*(d2_dif_rhou_dydx_0_0_nxp4m3jm1k)))-&
                    q(nx+4-3,j-1,indvars(3))*((1.0_wp)*(1.0_wp+&
                    ((q(nx+4-3,j-1,indvars(5))/1.0_wp*q(nx+4-3,j-1,indvars(1)))**3.0_wp/((q(nx+4-3,j-1,indvars(5))/1.0_wp*q(nx+4-3,j-1,indvars(1)))**3.0_wp+&
                    param_float(13 + 5)**3.0_wp))*(q(nx+4-3,j-1,indvars(5))/1.0_wp*q(nx+4-3,j-1,indvars(1))))*param_float(1 + 5)*(2.0_wp*qst(nx+4-3,j-1,indvarsst(11))*(d2_dif_rhov_dydy_0_0_nxp4m3jm1k)-&
                    2.0_wp/3.0_wp*(qst(nx+4-3,j-1,indvarsst(10))*(d2_dif_rhov_dydx_0_0_nxp4m3jm1k)+&
                    qst(nx+4-3,j-1,indvarsst(11))*(d2_dif_rhov_dydy_0_0_nxp4m3jm1k))))
...
rhs(nx+4-3,j,indvars(5)) = rhs(nx+4-3,j,indvars(5))  -  ( -param_float(1 + 5)*param_float(7 + 5)*param_float(18 + 5)*((qst(nx+4-3,j,indvarsst(10)))**2*(d1_dif_nut_dx_0_nxp4m3jk)*(d1_dif_nut_dx_1_nxp4m3jk)+&
                    ...
                    param_float(17 + 5)*(q(nx+4-3,j,indvars(5))/1.0_wp*q(nx+4-3,j,indvars(1)))**2.0_wp)))*qst(nx+4-3,j,indvarsst(12))*q(nx+4-3,j,indvars(1))*q(nx+4-3,j,indvars(5))+&
                    param_float(1 + 5)*(param_float(10 + 5)*(((min(param_float(1 + 5)*(q(nx+4-3,j,indvars(5))/(qst(nx+4-3,j,indvarsst(12))*param_float(9 + 5)**2.0_wp*qst(nx+4-3,j,indvarsst(2))**2.0_wp)),10.0_wp))+&
                    param_float(11 + 5)*((min(param_float(1 + 5)*(q(nx+4-3,j,indvars(5))/(qst(nx+4-3,j,indvarsst(12))*param_float(9 + 5)**2.0_wp*qst(nx+4-3,j,indvarsst(2))**2.0_wp)),10.0_wp))**6.0_wp-&
                    (min(param_float(1 + 5)*(q(nx+4-3,j,indvars(5))/(qst(nx+4-3,j,indvarsst(12))*param_float(9 + 5)**2.0_wp*qst(nx+4-3,j,indvarsst(2))**2.0_wp)),10.0_wp))))*((1.0_wp+&
                    param_float(12 + 5)**6.0_wp)/(((min(param_float(1 + 5)*(q(nx+4-3,j,indvars(5))/(qst(nx+4-3,j,indvarsst(12))*param_float(9 + 5)**2.0_wp*qst(nx+4-3,j,indvarsst(2))**2.0_wp)),10.0_wp))+&
                    param_float(11 + 5)*((min(param_float(1 + 5)*(q(nx+4-3,j,indvars(5))/(qst(nx+4-3,j,indvarsst(12))*param_float(9 + 5)**2.0_wp*qst(nx+4-3,j,indvarsst(2))**2.0_wp)),10.0_wp))**6.0_wp-&
                    (min(param_float(1 + 5)*(q(nx+4-3,j,indvars(5))/(qst(nx+4-3,j,indvarsst(12))*param_float(9 + 5)**2.0_wp*qst(nx+4-3,j,indvarsst(2))**2.0_wp)),10.0_wp))))**6.0_wp+&
                    param_float(12 + 5)**6.0_wp))**(1.0_wp/6.0_wp))-&
                    param_float(6 + 5)/param_float(9 + 5)**2.0_wp*(param_float(16 + 5)*exp(-&
                    param_float(17 + 5)*(q(nx+4-3,j,indvars(5))/1.0_wp*q(nx+4-3,j,indvars(1)))**2.0_wp)))*q(nx+4-3,j,indvars(1))*q(nx+4-3,j,indvars(5))**2.0_wp/qst(nx+4-3,j,indvarsst(2))**2.0_wp ) 
