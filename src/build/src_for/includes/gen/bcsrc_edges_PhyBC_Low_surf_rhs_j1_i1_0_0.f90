...
d1_rhs_nut_dx_3_1m2p0p01m2p0k = (q(1-2+0+0,1-2+0,indvars(1))*q(1-2+0+0,1-2+0,indvars(5)))*q(1-2+0+0,1-2+0,indvars(2))

d1_rhs_nut_dx_3_1m2p0p11m2p0k = (q(1-2+0+1,1-2+0,indvars(1))*q(1-2+0+1,1-2+0,indvars(5)))*q(1-2+0+1,1-2+0,indvars(2))

d1_rhs_nut_dx_3_1m2p0p21m2p0k = (q(1-2+0+2,1-2+0,indvars(1))*q(1-2+0+2,1-2+0,indvars(5)))*q(1-2+0+2,1-2+0,indvars(2))
