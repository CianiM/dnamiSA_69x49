...
qst(i,ny+4+0,indvarsst(4)) =  (2.0_wp*(dabs(0.5_wp*(qst(i,ny+4+0,indvarsst(11))*(d1_stemp_dy_0_inyp4p0k)-&
                    qst(i,ny+4+0,indvarsst(10))*(d1_stemp_dx_0_inyp4p0k)))))
...
qst(i,ny+4+0,indvarsst(12)) =  (qst(i,ny+4+0,indvarsst(4))+&
                    (1.0_wp-&
                    (q(i,ny+4+0,indvars(5))/1.0_wp*q(i,ny+4+0,indvars(1)))/(1.0_wp+&
                    (q(i,ny+4+0,indvars(5))/1.0_wp*q(i,ny+4+0,indvars(1)))*((q(i,ny+4+0,indvars(5))/1.0_wp*q(i,ny+4+0,indvars(1)))**3.0_wp/((q(i,ny+4+0,indvars(5))/1.0_wp*q(i,ny+4+0,indvars(1)))**3.0_wp+&
                    param_float(13 + 5)**3.0_wp))))*param_float(1 + 5)*q(i,ny+4+0,indvars(5))/(param_float(9 + 5)**2.0_wp*qst(i,ny+4+0,indvarsst(2))**2.0_wp))
...
qst(i,ny+4+0,indvarsst(13)) =  ((1.0_wp)*(1.0_wp+&
                    ((q(i,ny+4+0,indvars(5))/1.0_wp*q(i,ny+4+0,indvars(1)))**3.0_wp/((q(i,ny+4+0,indvars(5))/1.0_wp*q(i,ny+4+0,indvars(1)))**3.0_wp+&
                    param_float(13 + 5)**3.0_wp))*(q(i,ny+4+0,indvars(5))/1.0_wp*q(i,ny+4+0,indvars(1))))*param_float(1 + 5)*(d1_stemp_dy_0_inyp4p0k)*qst(i,ny+4+0,indvarsst(11)))
...
qst(i,ny+4+0,indvarsst(14)) =  q(i,ny+4+0,indvars(5))*q(i,ny+4+0,indvars(1))
...
qst(i,ny+4+0,indvarsst(15)) =  q(i,ny+4+0,indvars(5))*q(i,ny+4+0,indvars(1))*((q(i,ny+4+0,indvars(5))/1.0_wp*q(i,ny+4+0,indvars(1)))**3.0_wp/((q(i,ny+4+0,indvars(5))/1.0_wp*q(i,ny+4+0,indvars(1)))**3.0_wp+&
...
qst(i,ny+4+0,indvarsst(16)) =  (param_float(3 + 5))*q(i,ny+4+0,indvars(1))*((q(i,ny+4+0,indvars(4))-&
...
qst(i,ny+4-1,indvarsst(4)) =  (2.0_wp*(dabs(0.5_wp*(qst(i,ny+4-1,indvarsst(11))*(d1_stemp_dy_0_inyp4m1k)-&
                    qst(i,ny+4-1,indvarsst(10))*(d1_stemp_dx_0_inyp4m1k)))))
...
qst(i,ny+4-1,indvarsst(12)) =  (qst(i,ny+4-1,indvarsst(4))+&
                    (1.0_wp-&
                    (q(i,ny+4-1,indvars(5))/1.0_wp*q(i,ny+4-1,indvars(1)))/(1.0_wp+&
                    (q(i,ny+4-1,indvars(5))/1.0_wp*q(i,ny+4-1,indvars(1)))*((q(i,ny+4-1,indvars(5))/1.0_wp*q(i,ny+4-1,indvars(1)))**3.0_wp/((q(i,ny+4-1,indvars(5))/1.0_wp*q(i,ny+4-1,indvars(1)))**3.0_wp+&
                    param_float(13 + 5)**3.0_wp))))*param_float(1 + 5)*q(i,ny+4-1,indvars(5))/(param_float(9 + 5)**2.0_wp*qst(i,ny+4-1,indvarsst(2))**2.0_wp))
...
qst(i,ny+4-1,indvarsst(13)) =  ((1.0_wp)*(1.0_wp+&
                    ((q(i,ny+4-1,indvars(5))/1.0_wp*q(i,ny+4-1,indvars(1)))**3.0_wp/((q(i,ny+4-1,indvars(5))/1.0_wp*q(i,ny+4-1,indvars(1)))**3.0_wp+&
                    param_float(13 + 5)**3.0_wp))*(q(i,ny+4-1,indvars(5))/1.0_wp*q(i,ny+4-1,indvars(1))))*param_float(1 + 5)*(d1_stemp_dy_0_inyp4m1k)*qst(i,ny+4-1,indvarsst(11)))
...
qst(i,ny+4-1,indvarsst(14)) =  q(i,ny+4-1,indvars(5))*q(i,ny+4-1,indvars(1))
...
qst(i,ny+4-1,indvarsst(15)) =  q(i,ny+4-1,indvars(5))*q(i,ny+4-1,indvars(1))*((q(i,ny+4-1,indvars(5))/1.0_wp*q(i,ny+4-1,indvars(1)))**3.0_wp/((q(i,ny+4-1,indvars(5))/1.0_wp*q(i,ny+4-1,indvars(1)))**3.0_wp+&
                    param_float(13 + 5)**3.0_wp))
...
qst(i,ny+4-1,indvarsst(16)) =  (param_float(3 + 5))*q(i,ny+4-1,indvars(1))*((q(i,ny+4-1,indvars(4))-&
                    0.5_wp*(q(i,ny+4-1,indvars(2))*q(i,ny+4-1,indvars(2))+&
                    q(i,ny+4-1,indvars(3))*q(i,ny+4-1,indvars(3)))))
...
qst(i,ny+4-2,indvarsst(4)) =  (2.0_wp*(dabs(0.5_wp*(qst(i,ny+4-2,indvarsst(11))*(d1_stemp_dy_0_inyp4m2k)-&
                    qst(i,ny+4-2,indvarsst(10))*(d1_stemp_dx_0_inyp4m2k)))))
...
qst(i,ny+4-2,indvarsst(12)) =  (qst(i,ny+4-2,indvarsst(4))+&
                    (1.0_wp-&
                    (q(i,ny+4-2,indvars(5))/1.0_wp*q(i,ny+4-2,indvars(1)))/(1.0_wp+&
                    (q(i,ny+4-2,indvars(5))/1.0_wp*q(i,ny+4-2,indvars(1)))*((q(i,ny+4-2,indvars(5))/1.0_wp*q(i,ny+4-2,indvars(1)))**3.0_wp/((q(i,ny+4-2,indvars(5))/1.0_wp*q(i,ny+4-2,indvars(1)))**3.0_wp+&
                    param_float(13 + 5)**3.0_wp))))*param_float(1 + 5)*q(i,ny+4-2,indvars(5))/(param_float(9 + 5)**2.0_wp*qst(i,ny+4-2,indvarsst(2))**2.0_wp))
...
qst(i,ny+4-2,indvarsst(13)) =  ((1.0_wp)*(1.0_wp+&
                    ((q(i,ny+4-2,indvars(5))/1.0_wp*q(i,ny+4-2,indvars(1)))**3.0_wp/((q(i,ny+4-2,indvars(5))/1.0_wp*q(i,ny+4-2,indvars(1)))**3.0_wp+&
                    param_float(13 + 5)**3.0_wp))*(q(i,ny+4-2,indvars(5))/1.0_wp*q(i,ny+4-2,indvars(1))))*param_float(1 + 5)*(d1_stemp_dy_0_inyp4m2k)*qst(i,ny+4-2,indvarsst(11)))
...
qst(i,ny+4-2,indvarsst(14)) =  q(i,ny+4-2,indvars(5))*q(i,ny+4-2,indvars(1))
...
qst(i,ny+4-2,indvarsst(15)) =  q(i,ny+4-2,indvars(5))*q(i,ny+4-2,indvars(1))*((q(i,ny+4-2,indvars(5))/1.0_wp*q(i,ny+4-2,indvars(1)))**3.0_wp/((q(i,ny+4-2,indvars(5))/1.0_wp*q(i,ny+4-2,indvars(1)))**3.0_wp+&
                    param_float(13 + 5)**3.0_wp))
...
qst(i,ny+4-2,indvarsst(16)) =  (param_float(3 + 5))*q(i,ny+4-2,indvars(1))*((q(i,ny+4-2,indvars(4))-&
                    0.5_wp*(q(i,ny+4-2,indvars(2))*q(i,ny+4-2,indvars(2))+&
                    q(i,ny+4-2,indvars(3))*q(i,ny+4-2,indvars(3)))))
...
qst(i,ny+4-3,indvarsst(4)) =  (2.0_wp*(dabs(0.5_wp*(qst(i,ny+4-3,indvarsst(11))*(d1_stemp_dy_0_inyp4m3k)-&
                    qst(i,ny+4-3,indvarsst(10))*(d1_stemp_dx_0_inyp4m3k)))))
...
qst(i,ny+4-3,indvarsst(12)) =  (qst(i,ny+4-3,indvarsst(4))+&
                    (1.0_wp-&
                    (q(i,ny+4-3,indvars(5))/1.0_wp*q(i,ny+4-3,indvars(1)))/(1.0_wp+&
                    (q(i,ny+4-3,indvars(5))/1.0_wp*q(i,ny+4-3,indvars(1)))*((q(i,ny+4-3,indvars(5))/1.0_wp*q(i,ny+4-3,indvars(1)))**3.0_wp/((q(i,ny+4-3,indvars(5))/1.0_wp*q(i,ny+4-3,indvars(1)))**3.0_wp+&
                    param_float(13 + 5)**3.0_wp))))*param_float(1 + 5)*q(i,ny+4-3,indvars(5))/(param_float(9 + 5)**2.0_wp*qst(i,ny+4-3,indvarsst(2))**2.0_wp))
...
qst(i,ny+4-3,indvarsst(13)) =  ((1.0_wp)*(1.0_wp+&
                    ((q(i,ny+4-3,indvars(5))/1.0_wp*q(i,ny+4-3,indvars(1)))**3.0_wp/((q(i,ny+4-3,indvars(5))/1.0_wp*q(i,ny+4-3,indvars(1)))**3.0_wp+&
                    param_float(13 + 5)**3.0_wp))*(q(i,ny+4-3,indvars(5))/1.0_wp*q(i,ny+4-3,indvars(1))))*param_float(1 + 5)*(d1_stemp_dy_0_inyp4m3k)*qst(i,ny+4-3,indvarsst(11)))
...
qst(i,ny+4-3,indvarsst(14)) =  q(i,ny+4-3,indvars(5))*q(i,ny+4-3,indvars(1))
...
qst(i,ny+4-3,indvarsst(15)) =  q(i,ny+4-3,indvars(5))*q(i,ny+4-3,indvars(1))*((q(i,ny+4-3,indvars(5))/1.0_wp*q(i,ny+4-3,indvars(1)))**3.0_wp/((q(i,ny+4-3,indvars(5))/1.0_wp*q(i,ny+4-3,indvars(1)))**3.0_wp+&
                    param_float(13 + 5)**3.0_wp))
...
qst(i,ny+4-3,indvarsst(16)) =  (param_float(3 + 5))*q(i,ny+4-3,indvars(1))*((q(i,ny+4-3,indvars(4))-&
                    0.5_wp*(q(i,ny+4-3,indvars(2))*q(i,ny+4-3,indvars(2))+&
                    q(i,ny+4-3,indvars(3))*q(i,ny+4-3,indvars(3)))))
