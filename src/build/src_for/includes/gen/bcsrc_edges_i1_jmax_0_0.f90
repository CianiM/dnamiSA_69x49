...
d1_dif_nut_dx_0_1m2p0p0nyp2p0k = -(param_float(1 + 5)*(1.0_wp+&
                    (q(1-2+0+0,ny+2+0,indvars(5))/1.0_wp))*param_float(18 + 5)*qst(1-2+0+0,ny+2+0,indvarsst(10))*(d2_dif_nut_dxdx_0_0_1m2p0p0nyp2p0k))

d1_dif_nut_dx_0_1m2p0p1nyp2p0k = -(param_float(1 + 5)*(1.0_wp+&
                    (q(1-2+0+1,ny+2+0,indvars(5))/1.0_wp))*param_float(18 + 5)*qst(1-2+0+1,ny+2+0,indvarsst(10))*(d2_dif_nut_dxdx_0_0_1m2p0p1nyp2p0k))

d1_dif_nut_dx_0_1m2p0p2nyp2p0k = -(param_float(1 + 5)*(1.0_wp+&
                    (q(1-2+0+2,ny+2+0,indvars(5))/1.0_wp))*param_float(18 + 5)*qst(1-2+0+2,ny+2+0,indvarsst(10))*(d2_dif_nut_dxdx_0_0_1m2p0p2nyp2p0k))
...
d1_dif_nut_dy_0_1m2p0nyp2p0p0k = -(param_float(1 + 5)*(1.0_wp+&
                    (q(1-2+0,ny+2+0+0,indvars(5))/1.0_wp))*param_float(18 + 5)*qst(1-2+0,ny+2+0+0,indvarsst(11))*(d2_dif_nut_dydy_0_0_1m2p0nyp2p0p0k))

d1_dif_nut_dy_0_1m2p0nyp2p0m1k = -(param_float(1 + 5)*(1.0_wp+&
                    (q(1-2+0,ny+2+0-1,indvars(5))/1.0_wp))*param_float(18 + 5)*qst(1-2+0,ny+2+0-1,indvarsst(11))*(d2_dif_nut_dydy_0_0_1m2p0nyp2p0m1k))

d1_dif_nut_dy_0_1m2p0nyp2p0m2k = -(param_float(1 + 5)*(1.0_wp+&
                    (q(1-2+0,ny+2+0-2,indvars(5))/1.0_wp))*param_float(18 + 5)*qst(1-2+0,ny+2+0-2,indvarsst(11))*(d2_dif_nut_dydy_0_0_1m2p0nyp2p0m2k))
