...
velchar_BC_i1sym = Char['xi'][1].copy()
velchar_BC_i1sym = sym.Matrix(velchar_BC_i1sym).applyfunc(lambda x:sym.simplify(x).subs(betaswp['x'][0],betaswp['x'][1]))

velchar_BC_i1 = []
for i in velchar_BC_i1sym:
    velchar_BC_i1.append(sympy2dNami(i))  
...
# Li_BC_i1[3] = '( max('+velchar_BC_i1[3]+',0.0_wp)/('+velchar_BC_i1[3]+')*eta_1*rho*c*c*( 1.0_wp - M_i1*M_i1)/L_x*( u - u_0) + min('+velchar_BC_i1[3]+',0.0_wp)/('+velchar_BC_i1[3]+')*('+Li_BC_i1[3]+'))'
# Li_BC_i1[1] = '( max('+velchar_BC_i1[1]+',0.0_wp)/('+velchar_BC_i1[1]+')*eta_2*rho*c*Rgas*(T - T_0)/L_x                     + min('+velchar_BC_i1[1]+',0.0_wp)/('+velchar_BC_i1[1]+')*('+Li_BC_i1[1]+'))'            
# Li_BC_i1[0] = '( max('+velchar_BC_i1[0]+',0.0_wp)/('+velchar_BC_i1[0]+')*eta_3*c*(v - v_0)/L_x                              + min('+velchar_BC_i1[0]+',0.0_wp)/('+velchar_BC_i1[0]+')*('+Li_BC_i1[0]+'))'                        
...
velchar_BC_imaxsym = Char['xi'][1].copy()
velchar_BC_imaxsym = sym.Matrix(velchar_BC_imaxsym).applyfunc(lambda x:sym.simplify(x).subs(betaswp['x'][0],betaswp['x'][1]))

velchar_BC_imax = []
for i in velchar_BC_imaxsym:
    velchar_BC_imax.append(sympy2dNami(i))

# Li_BC_imax[2] = '( min('+velchar_BC_imax[2]+',0.0_wp)/('+velchar_BC_imax[2]+')*sigma*c*(1-M_imax*M_imax)/L_x*( p - p_0) + max('+velchar_BC_imax[2]+',0.0_wp)/('+velchar_BC_imax[2]+')*'+Li_BC_imax[2]+')'
...
velchar_BC_j1sym = Char['eta'][1].copy()
velchar_BC_j1sym = sym.Matrix(velchar_BC_j1sym).applyfunc(lambda x:sym.simplify(x).subs(betaswp['y'][0],betaswp['y'][1]))

velchar_BC_j1 = []
for i in velchar_BC_j1sym:
    velchar_BC_j1.append(sympy2dNami(i))  

# Mi_BC_j1[3] = 'sigma*c*(1-M_j1*M_j1)/L_y*( p - p_0)'

#j1 inflow:

# Mi_BC_j1[3] = '( max('+velchar_BC_j1[3]+',0.0_wp)/('+velchar_BC_j1[3]+')*eta_1*rho*c*c*( 1.0_wp - M_j1*M_j1)/L_y*( v - v_0) + min('+velchar_BC_j1[3]+',0.0_wp)/('+velchar_BC_j1[3]+')*('+Mi_BC_j1[3]+'))'
# Mi_BC_j1[1] = '( max('+velchar_BC_j1[1]+',0.0_wp)/('+velchar_BC_j1[1]+')*eta_2*rho*c*Rgas*(T - T_0)/L_y                     + min('+velchar_BC_j1[1]+',0.0_wp)/('+velchar_BC_j1[1]+')*('+Mi_BC_j1[1]+'))'           
# Mi_BC_j1[0] = '( max('+velchar_BC_j1[0]+',0.0_wp)/('+velchar_BC_j1[0]+')*eta_3*c*(u - u_0)/L_y                              + min('+velchar_BC_j1[0]+',0.0_wp)/('+velchar_BC_j1[0]+')*('+Mi_BC_j1[0]+'))'                       
...
velchar_BC_jmaxsym = sym.Matrix(velchar_BC_jmaxsym).applyfunc(lambda x:sym.simplify(x).subs(betaswp['y'][0],betaswp['y'][1]))

velchar_BC_jmax = []
for i in velchar_BC_jmaxsym:
    velchar_BC_jmax.append(sympy2dNami(i))  

# Mi_BC_jmax[2] = '( min('+velchar_BC_jmax[2]+',0.0_wp)/('+velchar_BC_jmax[2]+')*sigma*c*(1-M_jmax*M_jmax)/L_y*( p - p_0) + max('+velchar_BC_jmax[2]+',0.0_wp)/('+velchar_BC_jmax[2]+')*'+Mi_BC_jmax[2]+')'
